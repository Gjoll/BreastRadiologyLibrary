...
namespace BreastRadLib
{
	...
	public class AbnormalityMass : ObservationBase, IAbnormalityMass
	{
		...
		/// Access MassType
		/// </summary>
		public TItemComponentSingle<CodeableConcept> MassType { get ; protected set; }                                                            // BuildElementItemComponent.cs:72
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.MassType = new TItemComponentSingle<CodeableConcept>("Observation.component:massType", 0, 1, FixedValue_ObservationComponentMassTypeCode());// BuildElementItemComponent.cs:57
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			if (this.MassType.Validate(sb) == false) retVal = false;                                                                                 // BuildElementItemComponent.cs:81
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.MassType.Write(this.Doc, this.Resource);                                                                                            // BuildElementItemComponent.cs:75
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.MassType.Read(this.Doc, this.Resource);                                                                                             // BuildElementItemComponent.cs:78
			//- ReadCode
		}
