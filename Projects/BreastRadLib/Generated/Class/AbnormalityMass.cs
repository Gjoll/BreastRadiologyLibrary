...
namespace BreastRadLib
{
	...
	public class AbnormalityMass : ObservationBase, IAbnormalityMass
	{
		...
		/// </summary>
		public MassTypeContainer MassType { get ; protected set; }                                                                                // BuildMemberBase.cs:336
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.MassType = new MassTypeContainer(0, 0);                                                                                             // BuildMemberBase.cs:320
			//- Constructor
		}
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:117
			    ...
			    this.MassType.Read(this.Doc, items);                                                                                                 // BuildMemberComponents.cs:67
			    //- ReadComponents
			...
			{                                                                                                                                        // BuildMemberComponents.cs:127
			    ...
			    items.AddRange(this.MassType.Write(this.Doc));                                                                                       // BuildMemberComponents.cs:89
			    //- WriteComponents
