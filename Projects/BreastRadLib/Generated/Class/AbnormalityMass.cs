...
namespace BreastRadLib
{
	...
	public class AbnormalityMass : ObservationBase, IAbnormalityMass
	{
		...
		/// </summary>
		public MassType_Accessor MassType { get ; protected set; }                                                                                // BuildMemberListBase.cs:69
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			/// Constructor
			/// </summary>
			this.MassType = new MassType_Accessor(doc);                                                                                              // BuildMemberListBase.cs:75
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			if (this.MassType.Validate(sb) == false) retVal = false;                                                                                 // BuildMemberListBase.cs:84
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.WriteComponent(this.MassType);                                                                                                      // BuildMemberListBase.cs:78
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.ReadComponent(this.MassType);                                                                                                       // BuildMemberListBase.cs:81
			//- ReadCode
		}
