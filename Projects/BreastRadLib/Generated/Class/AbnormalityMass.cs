...
namespace BreastRadLib
{
	...
	public class AbnormalityMass : ObservationBase, IAbnormalityMass
	{
		...
		/// </summary>
		public MassTypeContainer MassType { get ; protected set; }                                                                                // BuildMemberBase.cs:380
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			// Called from BuildMemberComponents.cs, Line 204
			this.MassType = new MassTypeContainer(0, 0);                                                                                             // BuildMemberBase.cs:359
			//- Constructor
		}
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:138
			    ...
			    this.MassType.Read(this.Doc, items);                                                                                                 // BuildMemberComponents.cs:88
			    //- ReadComponents
			...
			{                                                                                                                                        // BuildMemberComponents.cs:148
			    ...
			    items.AddRange(this.MassType.Write(this.Doc));                                                                                       // BuildMemberComponents.cs:110
			    //- WriteComponents
