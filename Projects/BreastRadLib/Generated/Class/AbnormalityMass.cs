...
namespace BreastRadLib
{
	...
	public class AbnormalityMass : ObservationBase, IAbnormalityMass
	{
		...
		/// Access MassType
		/// </summary>
		public ElementItemComponentSingle<CodeableConcept> MassType { get ; protected set; }                                                      // BuildElementItemComponent.cs:74
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.MassType = new ElementItemComponentSingle<CodeableConcept>("MassType", 0, 1, FixedValue_ObservationComponentMassTypeCode());        // BuildElementItemComponent.cs:59
			//- Constructor
		}
