...
namespace BreastRadLib
{
	...
	public class AbnormalityMass : ObservationBase, IAbnormalityMass
	{
		...
		/// </summary>
		public MassTypeContainer MassType { get ; protected set; }                                                                                // BuildMemberBase.cs:355
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			// Called from BuildMemberComponents.cs, Line 179
			this.MassType = new MassTypeContainer(0, 0);                                                                                             // BuildMemberBase.cs:334
			//- Constructor
		}
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:113
			    ...
			    this.MassType.Read(this.Doc, items);                                                                                                 // BuildMemberComponents.cs:63
			    //- ReadComponents
			...
			{                                                                                                                                        // BuildMemberComponents.cs:123
			    ...
			    items.AddRange(this.MassType.Write(this.Doc));                                                                                       // BuildMemberComponents.cs:85
			    //- WriteComponents
