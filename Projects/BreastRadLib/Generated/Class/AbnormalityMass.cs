...
namespace BreastRadLib
{
	public class AbnormalityMass : ObservationBase, IObservationLeafFragment, ITumorSatelliteFragment, IBreastRadObservationNoDeviceFragment, IBreastRadObservationNoValueFragment, IBreastRadObservationNoComponentFragment, ICommonComponentsFragment, IShapeComponentsFragment, IObservedCountFragment, IObservedSizeFragment, IObservedDistributionFragment, INotPreviouslySeenComponentFragment, ICorrespondsWithFragment, IPreviouslyDemonstratedByFragment, IAssociatedFeaturesHasMemberFragment, IConsistentWithHasMemberFragment
	{
		...
		/// </summary>
		public class MassType_Accessor : ComponentBase<CodeableConcept>                                                                           // CSDefineObservation.cs:215
		{                                                                                                                                         // CSDefineObservation.cs:216
		    ...
		    /// </summary>
		    public MassType_Accessor(BreastRadiologyDocument doc) : base()                                                                        // CSDefineObservation.cs:231
		    {                                                                                                                                     // CSDefineObservation.cs:232
		        this.Create(doc, 1, 1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "abnormalityMassType"));// CSDefineObservation.cs:233
		    }                                                                                                                                     // CSDefineObservation.cs:235
		}                                                                                                                                         // CSDefineObservation.cs:236
		//- LocalClassDefs

		//+ Fields
		public MassType_Accessor MassType { get ; protected set; }                                                                                // CSDefineObservation.cs:380
		//- Fields
		...
		public void Create(BreastRadiologyDocument doc, Observation resource)
		{
			...
			//+ Constructor
			this.MassType = new MassType_Accessor(doc);                                                                                              // CSDefineObservation.cs:383
			//- Constructor
		}
		...
		this.WriteComponent(this.MassType);                                                                                                       // CSDefineObservation.cs:386
		//- WriteCode
		}
		...
		{
		//+ ReadCode
		this.ReadComponent(this.MassType);                                                                                                        // CSDefineObservation.cs:389
		//- ReadCode
		}
