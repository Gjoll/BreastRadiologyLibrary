...
namespace BreastRadLib
{
	...
	{
		//+ Fields
		public TumorSatellite_Accessor TumorSatellite { get ; protected set; }                                                                    // CSBuildCodedReferenceList.cs:120
		...
		public MassType_Accessor MassType { get ; protected set; }                                                                                // CSDefineObservation.cs:211
		//- Fields
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			SetProfileUrl("http://hl7.org/fhir/us/breast-radiology/StructureDefinition/AbnormalityMass");                                            // CSDefineBase.cs:217
			this.TumorSatellite = new TumorSatellite_Accessor(doc);                                                                                  // CSBuildCodedReferenceList.cs:123
			...
			this.MassType = new MassType_Accessor(doc);                                                                                              // CSDefineObservation.cs:214
			//- Constructor
		}
		...
		public override void Write()
		{
			...
			//- WriteCodeStart
			//+ WriteCode
			this.WriteHasMember(this.TumorSatellite);                                                                                                // CSBuildCodedReferenceList.cs:126
			...
			this.WriteComponent(this.MassType);                                                                                                      // CSDefineObservation.cs:217
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			//- ReadCodeStart
			//+ ReadCode
			this.ReadHasMember(this.TumorSatellite);                                                                                                 // CSBuildCodedReferenceList.cs:129
			...
			this.ReadComponent(this.MassType);                                                                                                       // CSDefineObservation.cs:220
			//- ReadCode
		}
