...
namespace BreastRadLib
{
	...
	public class AbnormalityCyst : ObservationBase, IAbnormalityCyst
	{
		...
		/// Access CystType
		/// </summary>
		public TElementItemComponentSingle<CodeableConcept> CystType { get ; protected set; }                                                      // BuildElementItemComponent.cs:74
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.CystType = new TElementItemComponentSingle<CodeableConcept>("CystType", 0, 1, FixedValue_ObservationComponentCystTypeCode());        // BuildElementItemComponent.cs:59
			//- Constructor
		}
