...
namespace BreastRadLib
{
	...
	public class AbnormalityCyst : ObservationBase, IAbnormalityCyst
	{
		...
		/// </summary>
		public TumorSatelliteContainer TumorSatellite { get ; protected set; }                                                                    // BuildMemberBase.cs:336
		...
		/// </summary>
		public CystTypeContainer CystType { get ; protected set; }                                                                                // BuildMemberBase.cs:336
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.TumorSatellite = new TumorSatelliteContainer(0, 0);                                                                                 // BuildMemberBase.cs:320
			...
			this.CystType = new CystTypeContainer(0, 0);                                                                                             // BuildMemberBase.cs:320
			//- Constructor
		}
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:117
			    ...
			    this.CystType.Read(this.Doc, items);                                                                                                 // BuildMemberComponents.cs:67
			    //- ReadComponents
			...
			{                                                                                                                                        // BuildMemberComponents.cs:127
			    ...
			    items.AddRange(this.CystType.Write(this.Doc));                                                                                       // BuildMemberComponents.cs:89
			    //- WriteComponents
