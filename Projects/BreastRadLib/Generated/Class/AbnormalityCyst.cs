...
namespace BreastRadLib
{
	...
	public class AbnormalityCyst : ObservationBase, IAbnormalityCyst
	{
		...
		/// Access CystType
		/// </summary>
		public TItemComponentSingle<CodeableConcept> CystType { get ; protected set; }                                                      // BuildItemComponent.cs:74
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.CystType = new TItemComponentSingle<CodeableConcept>("CystType", 0, 1, FixedValue_ObservationComponentCystTypeCode());        // BuildItemComponent.cs:59
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			if (this.CystType.Validate(sb) == false) retVal = false;                                                                                 // BuildItemComponent.cs:83
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.WriteComponent(this.CystType);                                                                                                      // BuildItemComponent.cs:77
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.ReadComponent(this.CystType);                                                                                                       // BuildItemComponent.cs:80
			//- ReadCode
		}
