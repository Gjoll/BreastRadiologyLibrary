...
namespace BreastRadLib
{
	...
	public class AbnormalityCyst : ObservationBase, IAbnormalityCyst
	{
		...
		/// </summary>
		public MCystType CystType { get ; protected set; }                                                                                        // BuildMemberBase.cs:396
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			// Called from BuildMemberComponents.cs, Line 202
			this.CystType = new MCystType(0, 1);                                                                                                     // BuildMemberBase.cs:375
			//- Constructor
		}
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:146
			    ...
			    items.AddRange(this.CystType.Write(this.Doc));                                                                                       // BuildMemberComponents.cs:108
			    //- WriteComponents
