...
namespace BreastRadLib
{
	...
	public class AbnormalityCyst : ObservationBase, IAbnormalityCyst
	{
		...
		public override void Write()
		{
			...
			this.CystType.WriteItemComponent(this.Doc, this.Resource);                                                                               // BuildElementItemComponent.cs:77
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.CystType.ReadItemComponent(this.Doc, this.Resource);                                                                                // BuildElementItemComponent.cs:80
			//- ReadCode
		}
