...
namespace BreastRadLib
{
	...
	public class AbnormalityCyst : ObservationBase, IAbnormalityCyst
	{
		...
		/// </summary>
		public CystType_Accessor CystType { get ; protected set; }                                                                                // BuildMemberListBase.cs:71
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.CystType = new CystType_Accessor(doc);                                                                                              // BuildMemberListBase.cs:74
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			if (this.CystType.Validate(sb) == false) retVal = false;                                                                                 // BuildMemberListBase.cs:83
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.WriteComponent(this.CystType);                                                                                                      // BuildMemberListBase.cs:77
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.ReadComponent(this.CystType);                                                                                                       // BuildMemberListBase.cs:80
			//- ReadCode
		}
