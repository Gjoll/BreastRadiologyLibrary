...
namespace BreastRadLib
{
	...
	public class AbnormalityCyst : ObservationBase, IAbnormalityCyst
	{
		...
		/// </summary>
		public ElementItemReferenceMultiple<TumorSatellite> TumorSatellite { get ; protected set; }                                               // BuildElementItemReference.cs:63
		...
		/// Access CystType
		/// </summary>
		public ElementItemComponentSingle<CodeableConcept> CystType { get ; protected set; }                                                      // BuildElementItemComponent.cs:74
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.TumorSatellite = new ElementItemReferenceMultiple<TumorSatellite>("TumorSatellite", 0, -1, doc, "http://hl7.org/fhir/us/breast-radiology/StructureDefinition/TumorSatellite");// BuildElementItemReference.cs:48
			...
			this.CystType = new ElementItemComponentSingle<CodeableConcept>("CystType", 0, 1, FixedValue_ObservationComponentCystTypeCode());        // BuildElementItemComponent.cs:59
			//- Constructor
		}
