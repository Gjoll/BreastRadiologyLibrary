...
namespace BreastRadLib
{
	...
	public class SectionFindingsRightBreast : ObservationBase, ISectionFindingsRightBreast
	{
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			SetProfileUrl("http://hl7.org/fhir/us/breast-radiology/StructureDefinition/SectionFindingsRightBreast");                                 // DefineBase.cs:225
			/// <summary>
			/// Constructor
			/// </summary>
		...
		{                                                                                                                                         // FhirConstruct.cs:754
			...
			/// </summary>
			public void SetValueX(BiRadsAssessmentCategoriesVS.TCoding code)                                                                         // DefineBase.cs:189
			{                                                                                                                                        // DefineBase.cs:190
			    //If: C:\Development\HL7\BreastRadiologyLibrary\Projects\FireFragger\FireFragger\CS\DefineBase.cs 191                                // CodeBlockNested.cs:588
			    this.Resource.Value = (CodeableConcept) code;                                                                                        // DefineBase.cs:192
			}                                                                                                                                        // DefineBase.cs:195
		//- Methods
	}
}
