...
{
	//+ LocalClassDefs
	#region Observation.hasMember:tumorSatellite Container Class                                                                               // BuildMemberBase.cs:157
	...
	/// </summary>
	public class TumorSatelliteContainer : MContainer, ITMItem<ResourceReference>                                                              // BuildMemberBase.cs:162
	{                                                                                                                                          // BuildMemberBase.cs:163
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:81
	        ...
	        /// Value
	        /// </summary>
	        public TumorSatellite Value { get; set; }                                                                                          // BuildMemberBase.cs:86
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:139
	        "http://hl7.org/fhir/us/breast-radiology/StructureDefinition/TumorSatellite"                                                       // BuildMemberBase.cs:146
	    ...
	    /// Return all items
	    /// </summary>
	    public IEnumerable<TumorSatellite> All()                                                                                               // BuildMemberBase.cs:285
	    ...
	    /// </summary>
	    public TumorSatellite GetAt(Int32 i) => this.items[i].Value;                                                                           // BuildMemberBase.cs:295
	    ...
	    /// Constructor
	    /// </summary>
	    public TumorSatelliteContainer(Int32 min, Int32 max) : base("Observation.hasMember:tumorSatellite", min, max)                          // BuildMemberBase.cs:174
	    ...
	    /// </summary>
	    public TumorSatellite Append(TumorSatellite value)                                                                                     // BuildMemberBase.cs:317
	    ...
	    {                                                                                                                                      // BuildMemberReferences.cs:70
	        ...
	        {                                                                                                                                  // BuildMemberReferences.cs:76
	            ...
	            item.Value = (TumorSatellite) resource;                                                                                        // BuildMemberReferences.cs:78
