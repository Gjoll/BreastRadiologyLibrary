...
{
	//+ LocalClassDefs
	#region Observation.hasMember:tumorSatellite Container Class                                                                               // BuildMemberBase.cs:173
	...
	/// </summary>
	public class MTumorSatellite : MContainer, ITMItem<ResourceReference>                                                                      // BuildMemberBase.cs:178
	{                                                                                                                                          // BuildMemberBase.cs:179
	    ...
	    /// Return all items
	    /// </summary>
	    public IEnumerable<TumorSatellite> All()                                                                                               // BuildMemberBase.cs:301
	    ...
	    /// </summary>
	    public TumorSatellite GetAt(Int32 i) => this.items[i].Value;                                                                           // BuildMemberBase.cs:311
	    ...
	    /// Constructor
	    /// </summary>
	    public MTumorSatellite(Int32 min, Int32 max) : base("Observation.hasMember:tumorSatellite", min, max)                                  // BuildMemberBase.cs:190
	    ...
	    /// </summary>
	    public TumorSatellite Append(TumorSatellite value)                                                                                     // BuildMemberBase.cs:333
