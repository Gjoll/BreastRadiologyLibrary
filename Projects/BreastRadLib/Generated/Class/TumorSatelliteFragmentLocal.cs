...
{
	//+ LocalClassDefs
	#region Observation.hasMember:tumorSatellite Container Class                                                                               // BuildMemberBase.cs:137
	/// <summary>
	/// Container class for Observation.hasMember:tumorSatellite.
	/// </summary>
	public class TumorSatelliteContainer : MContainer, ITMItem<ResourceReference>                                                              // BuildMemberBase.cs:141
	{                                                                                                                                          // BuildMemberBase.cs:142
	    #region Observation.hasMember:tumorSatellite Item Class                                                                                // BuildMemberBase.cs:73
	    /// <summary>
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:78
	        ...
	        /// Value
	        /// </summary>
	        public TumorSatellite Value { get; set; }                                                                                          // BuildMemberBase.cs:83
	                                                                                                                                           // BuildMemberBase.cs:85
	        /// <summary>
	        /// Constructor
	        /// </summary>
	        public Item(TumorSatellite value)                                                                                                  // BuildMemberBase.cs:89
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:119
	        "http://hl7.org/fhir/us/breast-radiology/StructureDefinition/TumorSatellite"                                                       // BuildMemberBase.cs:126
	    ...
	    /// Return all items
	    /// </summary>
	    public IEnumerable<TumorSatellite> All()                                                                                               // BuildMemberBase.cs:256
	    ...
	    /// </summary>
	    public TumorSatellite GetAt(Int32 i) => this.items[i].Value;                                                                           // BuildMemberBase.cs:266
	    ...
	    /// Constructor
	    /// </summary>
	    public TumorSatelliteContainer(Int32 min, Int32 max) : base("Observation.hasMember:tumorSatellite", min, max)                          // BuildMemberBase.cs:151
	    ...
	    /// </summary>
	    public TumorSatellite Append(TumorSatellite value)                                                                                     // BuildMemberBase.cs:288
