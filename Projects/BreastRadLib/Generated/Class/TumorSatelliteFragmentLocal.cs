...
namespace BreastRadLib.TumorSatelliteFragmentLocal
{
	...
	/// </summary>
	public class TumorSatelliteContainer : MContainer, ITMItem<ResourceReference>                                                              // BuildMemberBase.cs:110
	{                                                                                                                                          // BuildMemberBase.cs:111
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:63
	        ...
	        /// Value
	        /// </summary>
	        public TumorSatellite Value { get; set; }                                                                                          // BuildMemberBase.cs:68
	                                                                                                                                           // BuildMemberBase.cs:70
	        /// <summary>
	        /// Constructor
	        /// </summary>
	        public Item(TumorSatellite value)                                                                                                  // BuildMemberBase.cs:74
	    ...
	    {                                                                                                                                      // BuildMemberReferences.cs:47
	        "http://hl7.org/fhir/us/breast-radiology/StructureDefinition/TumorSatellite"                                                       // BuildMemberReferences.cs:54
	    ...
	    /// Return all items
	    /// </summary>
	    public IEnumerable<TumorSatellite> All()                                                                                               // BuildMemberBase.cs:226
	    ...
	    /// </summary>
	    public TumorSatellite GetAt(Int32 i) => this.items[i].Value;                                                                           // BuildMemberBase.cs:236
	    ...
	    /// Constructor
	    /// </summary>
	    public TumorSatelliteContainer(Int32 min, Int32 max) : base("Observation.hasMember:tumorSatellite", min, max)                          // BuildMemberBase.cs:120
	    ...
	    /// </summary>
	    public TumorSatellite Append(TumorSatellite value)                                                                                     // BuildMemberBase.cs:258
	    ...
	    {                                                                                                                                      // BuildMemberReferences.cs:65
	        ...
	        {                                                                                                                                  // BuildMemberReferences.cs:71
	            Item item = new Item((TumorSatellite) resource);                                                                               // BuildMemberReferences.cs:72
