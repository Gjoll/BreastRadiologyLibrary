...
namespace BreastRadLib
{
	...
	public class MGAbnormalityAsymmetry : ObservationBase, IMGAbnormalityAsymmetry
	{
		...
		/// </summary>
		public MAsymmetryType AsymmetryType { get ; protected set; }                                                                              // BuildMemberBase.cs:396
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			SetProfileUrl("http://hl7.org/fhir/us/breast-radiology/StructureDefinition/MGAbnormalityAsymmetry");                                     // DefineBase.cs:238
			// Called from BuildMemberElement.cs, Line 123
			...
			// Called from BuildMemberComponents.cs, Line 202
			this.AsymmetryType = new MAsymmetryType(0, 1);                                                                                           // BuildMemberBase.cs:375
			//- Constructor
		}
		...
		{                                                                                                                                         // FhirConstruct.cs:760
		    ...
		    {                                                                                                                                     // FhirConstruct.cs:770
		        ...
		        temp4.CodeElement.Value = "mgAbnormalityAsymmetryObservation";                                                                    // FhirConstruct.cs:792
		        temp4.DisplayElement = new FhirString();                                                                                          // FhirConstruct.cs:798
		        temp4.DisplayElement.Value = "MG Abnormality Asymmetry observation";                                                              // FhirConstruct.cs:800
		        retVal.Coding.Add(temp4);                                                                                                         // FhirConstruct.cs:819
		    }                                                                                                                                     // FhirConstruct.cs:820
		    retVal.TextElement = new FhirString();                                                                                                // FhirConstruct.cs:825
		    retVal.TextElement.Value = "MG Abnormality Asymmetry observation";                                                                    // FhirConstruct.cs:827
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:146
			    ...
			    items.AddRange(this.AsymmetryType.Write(this.Doc));                                                                                  // BuildMemberComponents.cs:108
			    //- WriteComponents
