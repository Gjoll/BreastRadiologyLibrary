...
namespace BreastRadLib
{
	...
	public class MGAbnormalityAsymmetry : ObservationBase, IMGAbnormalityAsymmetry
	{
		...
		/// </summary>
		public AsymmetryTypeContainer AsymmetryType { get ; protected set; }                                                                      // BuildMemberBase.cs:336
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.AsymmetryType = new AsymmetryTypeContainer(0, 0);                                                                                   // BuildMemberBase.cs:320
			//- Constructor
		}
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:117
			    ...
			    this.AsymmetryType.Read(this.Doc, items);                                                                                            // BuildMemberComponents.cs:67
			    //- ReadComponents
			...
			{                                                                                                                                        // BuildMemberComponents.cs:127
			    ...
			    items.AddRange(this.AsymmetryType.Write(this.Doc));                                                                                  // BuildMemberComponents.cs:89
			    //- WriteComponents
