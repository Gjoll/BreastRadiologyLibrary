...
namespace BreastRadLib
{
	...
	public class MGAbnormalityAsymmetry : ObservationBase, IMGAbnormalityAsymmetry
	{
		...
		/// </summary>
		public AsymmetryType_Accessor AsymmetryType { get ; protected set; }                                                                      // BuildMemberListBase.cs:47
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			/// Constructor
			/// </summary>
			this.AsymmetryType = new AsymmetryType_Accessor(doc);                                                                                    // BuildMemberListBase.cs:53
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			if (this.AsymmetryType.Validate(sb) == false) retVal = false;                                                                            // BuildMemberListBase.cs:62
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.WriteComponent(this.AsymmetryType);                                                                                                 // BuildMemberListBase.cs:56
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.ReadComponent(this.AsymmetryType);                                                                                                  // BuildMemberListBase.cs:59
			//- ReadCode
		}
