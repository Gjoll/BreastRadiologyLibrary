...
namespace BreastRadLib
{
	public class MGAbnormalityAsymmetry : ObservationBase, IMGAbnormalityAsymmetry
	{
		...
		public AsymmetryType_Accessor AsymmetryType { get ; protected set; }                                                                      // BuildMemberListBase.cs:33
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			SetProfileUrl("http://hl7.org/fhir/us/breast-radiology/StructureDefinition/MGAbnormalityAsymmetry");                                     // DefineBase.cs:189
			...
			this.AsymmetryType = new AsymmetryType_Accessor(doc);                                                                                    // BuildMemberListBase.cs:36
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			if (this.AsymmetryType.Validate(sb) == false) retVal = false;                                                                            // BuildMemberListBase.cs:45
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.WriteComponent(this.AsymmetryType);                                                                                                 // BuildMemberListBase.cs:39
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.ReadComponent(this.AsymmetryType);                                                                                                  // BuildMemberListBase.cs:42
			//- ReadCode
		}
