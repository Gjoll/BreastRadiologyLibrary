...
namespace BreastRadLib
{
	...
	public class MGAbnormalityAsymmetry : ObservationBase, IMGAbnormalityAsymmetry
	{
		...
		/// </summary>
		public AsymmetryTypeContainer AsymmetryType { get ; protected set; }                                                                      // BuildMemberBase.cs:311
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.AsymmetryType = new AsymmetryTypeContainer(0, 0);                                                                                   // BuildMemberBase.cs:295
			//- Constructor
		}
