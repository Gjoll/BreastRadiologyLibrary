...
namespace BreastRadLib
{
	...
	public class MGAbnormalityAsymmetry : ObservationBase, IMGAbnormalityAsymmetry
	{
		...
		/// </summary>
		public AsymmetryTypeContainer AsymmetryType { get ; protected set; }                                                                      // BuildMemberBase.cs:381
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			// Called from BuildMemberComponents.cs, Line 208
			this.AsymmetryType = new AsymmetryTypeContainer(0, 0);                                                                                   // BuildMemberBase.cs:360
			//- Constructor
		}
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:142
			    ...
			    this.AsymmetryType.Read(this.Doc, items);                                                                                            // BuildMemberComponents.cs:96
			    //- ReadComponents
			...
			{                                                                                                                                        // BuildMemberComponents.cs:152
			    ...
			    items.AddRange(this.AsymmetryType.Write(this.Doc));                                                                                  // BuildMemberComponents.cs:114
			    //- WriteComponents
