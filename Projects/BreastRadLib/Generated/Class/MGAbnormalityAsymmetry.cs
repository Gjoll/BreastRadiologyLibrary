...
namespace BreastRadLib
{
	...
	public class MGAbnormalityAsymmetry : ObservationBase, IMGAbnormalityAsymmetry
	{
		...
		/// </summary>
		public AsymmetryTypeContainer AsymmetryType { get ; protected set; }                                                                      // BuildMemberBase.cs:303
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.AsymmetryType = new AsymmetryTypeContainer(0, 0);                                                                                   // BuildMemberBase.cs:287
			//- Constructor
		}
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:118
			    ...
			    this.AsymmetryType.Read(this.Doc, items);                                                                                            // BuildMemberComponents.cs:68
			    //- ReadComponents
			...
			{                                                                                                                                        // BuildMemberComponents.cs:128
			    ...
			    items.AddRange(this.AsymmetryType.Write(this.Doc));                                                                                  // BuildMemberComponents.cs:90
			    //- WriteComponents
