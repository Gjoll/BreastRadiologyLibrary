...
namespace BreastRadLib
{
	...
	public class MGAbnormalityAsymmetry : ObservationBase, IMGAbnormalityAsymmetry
	{
		...
		/// </summary>
		public TItemComponentSingle<CodeableConcept> AsymmetryType { get ; protected set; }                                                 // BuildItemComponent.cs:74
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.AsymmetryType = new TItemComponentSingle<CodeableConcept>("AsymmetryType", 0, 1, FixedValue_ObservationComponentAsymmetryTypeCode());// BuildItemComponent.cs:59
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			if (this.AsymmetryType.Validate(sb) == false) retVal = false;                                                                            // BuildItemComponent.cs:83
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.WriteComponent(this.AsymmetryType);                                                                                                 // BuildItemComponent.cs:77
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.ReadComponent(this.AsymmetryType);                                                                                                  // BuildItemComponent.cs:80
			//- ReadCode
		}
