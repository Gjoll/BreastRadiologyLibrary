...
namespace BreastRadLib
{
	...
	public class MGAbnormalityAsymmetry : ObservationBase, IMGAbnormalityAsymmetry
	{
		...
		/// </summary>
		public TItemComponentSingle<CodeableConcept> AsymmetryType { get ; protected set; }                                                       // BuildElementItemComponent.cs:74
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.AsymmetryType = new TItemComponentSingle<CodeableConcept>("Observation.component:asymmetryType", 0, 1, FixedValue_ObservationComponentAsymmetryTypeCode());// BuildElementItemComponent.cs:59
			//- Constructor
		}
