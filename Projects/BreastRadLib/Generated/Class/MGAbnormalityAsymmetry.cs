...
namespace BreastRadLib
{
	public class MGAbnormalityAsymmetry : ObservationBase, IObservationLeafFragment, IBreastRadObservationNoDeviceFragment, IBreastRadObservationNoComponentFragment, IBreastRadObservationNoValueFragment, ICommonComponentsFragment, IShapeComponentsFragment, INotPreviouslySeenComponentFragment, IObservedCountFragment, ICorrespondsWithFragment, IPreviouslyDemonstratedByFragment, IAssociatedFeaturesHasMemberFragment, IConsistentWithHasMemberFragment
	{
		...
		/// </summary>
		public class AsymmetryType_Accessor : ComponentBase<CodeableConcept>                                                                      // CSDefineObservation.cs:215
		{                                                                                                                                         // CSDefineObservation.cs:216
		    ...
		    /// </summary>
		    public AsymmetryType_Accessor(BreastRadiologyDocument doc) : base()                                                                   // CSDefineObservation.cs:231
		    {                                                                                                                                     // CSDefineObservation.cs:232
		        this.Create(doc, 1, 1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "mgAbnormalityAsymmetryType"));// CSDefineObservation.cs:233
		    }                                                                                                                                     // CSDefineObservation.cs:235
		}                                                                                                                                         // CSDefineObservation.cs:236
		//- LocalClassDefs

		//+ Fields
		public AsymmetryType_Accessor AsymmetryType { get ; protected set; }                                                                      // CSDefineObservation.cs:380
		//- Fields
		...
		public void Create(BreastRadiologyDocument doc, Observation resource)
		{
			...
			//+ Constructor
			this.AsymmetryType = new AsymmetryType_Accessor(doc);                                                                                    // CSDefineObservation.cs:383
			//- Constructor
		}
		...
		this.WriteComponent(this.AsymmetryType);                                                                                                  // CSDefineObservation.cs:386
		//- WriteCode
		}
		...
		{
		//+ ReadCode
		this.ReadComponent(this.AsymmetryType);                                                                                                   // CSDefineObservation.cs:389
		//- ReadCode
		}
