...
namespace BreastRadLib.ObservedDistributionFragmentLocal
{
	...
	{                                                                                                                                          // BuildMemberBase.cs:180
	    ...
	    /// Constructor
	    /// </summary>
	    public MObsDistribution(Int32 min = 0, Int32 max = -1) : base("Observation.component:obsDistribution", min, max)                       // BuildMemberBase.cs:191
	...
	{                                                                                                                                          // BuildMemberBase.cs:180
	    ...
	    /// Constructor
	    /// </summary>
	    public MObsDistRegionSize(Int32 min = 0, Int32 max = 3) : base("Observation.component:obsDistRegionSize", min, max)                    // BuildMemberBase.cs:191
	    {                                                                                                                                      // BuildMemberBase.cs:192
	    }                                                                                                                                      // BuildMemberBase.cs:194
	                                                                                                                                           // BuildMemberBase.cs:196
	    // Methods                                                                                                                             // BuildMemberBase.cs:197
