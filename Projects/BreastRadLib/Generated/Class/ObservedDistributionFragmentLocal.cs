...
{
	//+ LocalClassDefs
	#region Observation.component:obsDistribution Container Class                                                                              // BuildMemberBase.cs:140
	...
	/// </summary>
	public class ObsDistributionContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                // BuildMemberBase.cs:145
	{                                                                                                                                          // BuildMemberBase.cs:146
	    ...
	    /// Constructor
	    /// </summary>
	    public ObsDistributionContainer(Int32 min, Int32 max) : base("Observation.component:obsDistribution", min, max)                        // BuildMemberBase.cs:155
	...
	#region Observation.component:obsDistRegionSize Container Class                                                                            // BuildMemberBase.cs:140
	// Called from BuildMemberComponents.cs, Line 179
	// BuildMemberBase.cs:142
	/// <summary>
	/// Container class for Observation.component:obsDistRegionSize.
	/// </summary>
	public class ObsDistRegionSizeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                              // BuildMemberBase.cs:145
	{                                                                                                                                          // BuildMemberBase.cs:146
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:81
	        ...
	        /// Constructor
	        /// </summary>
	        public Item(Element value)                                                                                                         // BuildMemberBase.cs:92
	        {                                                                                                                                  // BuildMemberBase.cs:93
	            this.Value = value;                                                                                                            // BuildMemberBase.cs:94
	        }                                                                                                                                  // BuildMemberBase.cs:96
	                                                                                                                                           // BuildMemberBase.cs:98
	    ...
	    /// Return all items
	    /// </summary>
	    public IEnumerable<Element> All()                                                                                                      // BuildMemberBase.cs:262
	    {                                                                                                                                      // BuildMemberBase.cs:263
	        foreach (Item item in items)                                                                                                       // BuildMemberBase.cs:264
	           yield return item.Value;                                                                                                        // BuildMemberBase.cs:265
	    }                                                                                                                                      // BuildMemberBase.cs:266
	    ...
	    /// Get Item's Value at indicated index
	    /// </summary>
	    public Element GetAt(Int32 i) => this.items[i].Value;                                                                                  // BuildMemberBase.cs:272
	                                                                                                                                           // BuildMemberBase.cs:274
	    // BuildMemberBase.cs:275
	    /// <summary>
	    /// Remove Item at indicated index
	    ...
	    /// Constructor
	    /// </summary>
	    public ObsDistRegionSizeContainer(Int32 min, Int32 max) : base("Observation.component:obsDistRegionSize", min, max)                    // BuildMemberBase.cs:155
	    {                                                                                                                                      // BuildMemberBase.cs:156
	    }                                                                                                                                      // BuildMemberBase.cs:158
	                                                                                                                                           // BuildMemberBase.cs:159
	    // Methods                                                                                                                             // BuildMemberBase.cs:160
	    ...
	    /// Append value to collection
	    /// </summary>
	    public Quantity Append(Quantity value)                                                                                                 // BuildMemberBase.cs:294
	    {                                                                                                                                      // BuildMemberBase.cs:295
	        this.items.Add(new Item(value));                                                                                                   // BuildMemberBase.cs:296
	        return value;                                                                                                                      // BuildMemberBase.cs:297
	    }                                                                                                                                      // BuildMemberBase.cs:298
	    ...
	    /// Append value to collection
	    /// </summary>
	    public Range Append(Range value)                                                                                                       // BuildMemberBase.cs:294
	    {                                                                                                                                      // BuildMemberBase.cs:295
	        this.items.Add(new Item(value));                                                                                                   // BuildMemberBase.cs:296
	        return value;                                                                                                                      // BuildMemberBase.cs:297
	    }                                                                                                                                      // BuildMemberBase.cs:298
