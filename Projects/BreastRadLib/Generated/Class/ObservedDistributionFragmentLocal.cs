...
namespace BreastRadLib.ObservedDistributionFragmentLocal
{
	...
	{                                                                                                                                          // BuildMemberBase.cs:111
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:56
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:57
	            ...
	            this.ObsDistribution_ComponentCode());                                                                                         // BuildMemberComponents.cs:59
	...
	{                                                                                                                                          // BuildMemberBase.cs:111
	    ...
	    /// Return all items
	    /// </summary>
	    public IEnumerable<Element> All()                                                                                                      // BuildMemberBase.cs:226
	    {                                                                                                                                      // BuildMemberBase.cs:227
	        foreach (Item item in items)                                                                                                       // BuildMemberBase.cs:228
	           yield return item.Value;                                                                                                        // BuildMemberBase.cs:229
	    }                                                                                                                                      // BuildMemberBase.cs:230
	    ...
	    /// Get Item's Value at indicated index
	    /// </summary>
	    public Element GetAt(Int32 i) => this.items[i].Value;                                                                                  // BuildMemberBase.cs:236
	                                                                                                                                           // BuildMemberBase.cs:238
	    /// <summary>
	    /// Remove Item at indicated index
	    /// </summary>
	    ...
	    /// Append value to collection
	    /// </summary>
	    public Quantity Append(Quantity value)                                                                                                 // BuildMemberBase.cs:258
	    {                                                                                                                                      // BuildMemberBase.cs:259
	        this.items.Add(new Item(value));                                                                                                   // BuildMemberBase.cs:260
	        return value;                                                                                                                      // BuildMemberBase.cs:261
	    }                                                                                                                                      // BuildMemberBase.cs:262
	    ...
	    /// Append value to collection
	    /// </summary>
	    public Range Append(Range value)                                                                                                       // BuildMemberBase.cs:258
	    {                                                                                                                                      // BuildMemberBase.cs:259
	        this.items.Add(new Item(value));                                                                                                   // BuildMemberBase.cs:260
	        return value;                                                                                                                      // BuildMemberBase.cs:261
	    }                                                                                                                                      // BuildMemberBase.cs:262
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:56
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:57
	            components,                                                                                                                    // BuildMemberComponents.cs:58
	            this.ObsDistRegionSize_ComponentCode());                                                                                       // BuildMemberComponents.cs:59
	        List<Item> items = new List<Item>();                                                                                               // BuildMemberComponents.cs:60
	        foreach (Element element in elements)                                                                                              // BuildMemberComponents.cs:61
