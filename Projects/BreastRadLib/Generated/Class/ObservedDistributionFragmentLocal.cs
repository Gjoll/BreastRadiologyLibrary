...
{
	//+ LocalClassDefs
	#region Observation.component:obsDistribution Container Class                                                                              // BuildMemberBase.cs:157
	...
	/// </summary>
	public class ObsDistributionContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                // BuildMemberBase.cs:162
	{                                                                                                                                          // BuildMemberBase.cs:163
	    #region Observation.component:obsDistribution Item Class                                                                               // BuildMemberBase.cs:75
	    // Called from BuildMemberComponents.cs, Line 206
	    ...
	    /// Constructor
	    /// </summary>
	    public ObsDistributionContainer(Int32 min, Int32 max) : base("Observation.component:obsDistribution", min, max)                        // BuildMemberBase.cs:174
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:98
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:100
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:102
	                ...
	                Code = ObsDistribution_ComponentCode()                                                                                     // BuildMemberComponents.cs:104
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:74
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:75
	            ...
	            this.ObsDistribution_ComponentCode());                                                                                         // BuildMemberComponents.cs:77
	...
	#region Observation.component:obsDistRegionSize Container Class                                                                            // BuildMemberBase.cs:157
	// Called from BuildMemberComponents.cs, Line 206
	// BuildMemberBase.cs:159
	/// <summary>
	/// Container class for Observation.component:obsDistRegionSize.
	/// </summary>
	public class ObsDistRegionSizeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                              // BuildMemberBase.cs:162
	{                                                                                                                                          // BuildMemberBase.cs:163
	    #region Observation.component:obsDistRegionSize Item Class                                                                             // BuildMemberBase.cs:75
	    // Called from BuildMemberComponents.cs, Line 206
	    // BuildMemberBase.cs:77
	    /// <summary>
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:81
	        ...
	        /// Value
	        /// </summary>
	        public Element Value { get; set; }                                                                                                 // BuildMemberBase.cs:86
	                                                                                                                                           // BuildMemberBase.cs:89
	        // BuildMemberBase.cs:90
	        /// <summary>
	        /// Constructor
	        ...
	        public void Read(BreastRadiologyDocument doc, Observation.ComponentComponent component)                                            // BuildMemberComponents.cs:50
	        {                                                                                                                                  // BuildMemberComponents.cs:51
	            this.Value = (Element) component.Value;                                                                                        // BuildMemberComponents.cs:52
	        }                                                                                                                                  // BuildMemberComponents.cs:53
	    }                                                                                                                                      // BuildMemberBase.cs:114
	    #endregion                                                                                                                             // BuildMemberBase.cs:115
	                                                                                                                                           // BuildMemberBase.cs:166
	    ...
	    /// Return all items
	    /// </summary>
	    public IEnumerable<Element> All()                                                                                                      // BuildMemberBase.cs:285
	    {                                                                                                                                      // BuildMemberBase.cs:286
	        foreach (Item item in items)                                                                                                       // BuildMemberBase.cs:287
	           yield return item.Value;                                                                                                        // BuildMemberBase.cs:288
	    }                                                                                                                                      // BuildMemberBase.cs:289
	    ...
	    /// Get Item's Value at indicated index
	    /// </summary>
	    public Element GetAt(Int32 i) => this.items[i].Value;                                                                                  // BuildMemberBase.cs:295
	                                                                                                                                           // BuildMemberBase.cs:297
	    // BuildMemberBase.cs:298
	    /// <summary>
	    /// Remove Item at indicated index
	    ...
	    /// Constructor
	    /// </summary>
	    public ObsDistRegionSizeContainer(Int32 min, Int32 max) : base("Observation.component:obsDistRegionSize", min, max)                    // BuildMemberBase.cs:174
	    {                                                                                                                                      // BuildMemberBase.cs:175
	    }                                                                                                                                      // BuildMemberBase.cs:177
	                                                                                                                                           // BuildMemberBase.cs:179
	    // Methods                                                                                                                             // BuildMemberBase.cs:180
	    ...
	    /// Append value to collection
	    /// </summary>
	    public Quantity Append(Quantity value)                                                                                                 // BuildMemberBase.cs:317
	    {                                                                                                                                      // BuildMemberBase.cs:318
	        Item item = new Item();                                                                                                            // BuildMemberBase.cs:319
	        item.Value = value;                                                                                                                // BuildMemberBase.cs:320
	        this.items.Add(item);                                                                                                              // BuildMemberBase.cs:321
	    ...
	    /// Append value to collection
	    /// </summary>
	    public Range Append(Range value)                                                                                                       // BuildMemberBase.cs:317
	    {                                                                                                                                      // BuildMemberBase.cs:318
	        Item item = new Item();                                                                                                            // BuildMemberBase.cs:319
	        item.Value = value;                                                                                                                // BuildMemberBase.cs:320
	        this.items.Add(item);                                                                                                              // BuildMemberBase.cs:321
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:98
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:100
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:102
	                Value = item.Value,                                                                                                        // BuildMemberComponents.cs:103
	                Code = ObsDistRegionSize_ComponentCode()                                                                                   // BuildMemberComponents.cs:104
	            };                                                                                                                             // BuildMemberComponents.cs:105
	            yield return component;                                                                                                        // BuildMemberComponents.cs:106
	        }                                                                                                                                  // BuildMemberComponents.cs:107
	    }                                                                                                                                      // BuildMemberComponents.cs:108
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:74
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:75
	            components,                                                                                                                    // BuildMemberComponents.cs:76
	            this.ObsDistRegionSize_ComponentCode());                                                                                       // BuildMemberComponents.cs:77
	        List<Item> items = new List<Item>();                                                                                               // BuildMemberComponents.cs:78
	        foreach (Element element in elements)                                                                                              // BuildMemberComponents.cs:79
	        {                                                                                                                                  // BuildMemberComponents.cs:80
	            Item item = new Item();                                                                                                        // BuildMemberComponents.cs:81
	            item.Value = (Element) element;                                                                                                // BuildMemberComponents.cs:82
	            items.Add(item);                                                                                                               // BuildMemberComponents.cs:83
	        }                                                                                                                                  // BuildMemberComponents.cs:84
	        this.SetAllItems(items);                                                                                                           // BuildMemberComponents.cs:85
	    }                                                                                                                                      // BuildMemberComponents.cs:86
