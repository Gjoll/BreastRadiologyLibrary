...
namespace BreastRadLib.ObservedDistributionFragmentLocal
{
	...
	/// </summary>
	public class ObsDistributionContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                // BuildMemberBase.cs:131
	{                                                                                                                                          // BuildMemberBase.cs:132
	    ...
	    /// Constructor
	    /// </summary>
	    public ObsDistributionContainer(Int32 min, Int32 max) : base("Observation.component:obsDistribution", min, max)                        // BuildMemberBase.cs:141
	...
	/// </summary>
	public class ObsDistRegionSizeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                              // BuildMemberBase.cs:131
	{                                                                                                                                          // BuildMemberBase.cs:132
	    /// <summary>
	    ...
	    /// Return all items
	    /// </summary>
	    public IEnumerable<Element> All()                                                                                                      // BuildMemberBase.cs:247
	    {                                                                                                                                      // BuildMemberBase.cs:248
	        foreach (Item item in items)                                                                                                       // BuildMemberBase.cs:249
	           yield return item.Value;                                                                                                        // BuildMemberBase.cs:250
	    }                                                                                                                                      // BuildMemberBase.cs:251
	    ...
	    /// Get Item's Value at indicated index
	    /// </summary>
	    public Element GetAt(Int32 i) => this.items[i].Value;                                                                                  // BuildMemberBase.cs:257
	                                                                                                                                           // BuildMemberBase.cs:259
	    /// <summary>
	    /// Remove Item at indicated index
	    /// </summary>
	    ...
	    /// Constructor
	    /// </summary>
	    public ObsDistRegionSizeContainer(Int32 min, Int32 max) : base("Observation.component:obsDistRegionSize", min, max)                    // BuildMemberBase.cs:141
	    {                                                                                                                                      // BuildMemberBase.cs:142
	    }                                                                                                                                      // BuildMemberBase.cs:144
	                                                                                                                                           // BuildMemberBase.cs:145
	    // Methods                                                                                                                             // BuildMemberBase.cs:146
	    ...
	    /// Append value to collection
	    /// </summary>
	    public Quantity Append(Quantity value)                                                                                                 // BuildMemberBase.cs:279
	    {                                                                                                                                      // BuildMemberBase.cs:280
	        this.items.Add(new Item(value));                                                                                                   // BuildMemberBase.cs:281
	        return value;                                                                                                                      // BuildMemberBase.cs:282
	    }                                                                                                                                      // BuildMemberBase.cs:283
	    ...
	    /// Append value to collection
	    /// </summary>
	    public Range Append(Range value)                                                                                                       // BuildMemberBase.cs:279
	    {                                                                                                                                      // BuildMemberBase.cs:280
	        this.items.Add(new Item(value));                                                                                                   // BuildMemberBase.cs:281
	        return value;                                                                                                                      // BuildMemberBase.cs:282
	    }                                                                                                                                      // BuildMemberBase.cs:283
