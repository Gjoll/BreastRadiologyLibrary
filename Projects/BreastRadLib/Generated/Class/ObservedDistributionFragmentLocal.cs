...
namespace BreastRadLib.ObservedDistributionFragmentLocal
{
	...
	/// </summary>
	public class ObsDistribution_Accessor : ObservationLocal.ComponentBase<CodeableConcept>                                                    // CSDefineObservation.cs:64
	{                                                                                                                                          // CSDefineObservation.cs:65
	    ...
	    /// </summary>
	    public ObsDistribution_Accessor(BreastRadiologyDocument doc) : base()                                                                  // CSDefineObservation.cs:75
	    {                                                                                                                                      // CSDefineObservation.cs:76
	        this.Init(doc, 0, -1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "obsDistribution"));// CSDefineObservation.cs:77
	...
	/// </summary>
	public class ObsDistRegionSize_Accessor : ObservationLocal.ComponentBase<Base>                                                             // CSDefineObservation.cs:64
	{                                                                                                                                          // CSDefineObservation.cs:65
	    // Properties                                                                                                                          // CSDefineObservation.cs:66
	    /// <summary>
	    /// Access propertyName
	    ...
	    /// Accessor class constructor
	    /// </summary>
	    public ObsDistRegionSize_Accessor(BreastRadiologyDocument doc) : base()                                                                // CSDefineObservation.cs:75
	    {                                                                                                                                      // CSDefineObservation.cs:76
