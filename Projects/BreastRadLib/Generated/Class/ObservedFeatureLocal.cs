...
namespace BreastRadLib.ObservedFeatureLocal
{
	...
	/// </summary>
	public class FeatureType_Accessor : MemberListCodedValueBase<CodeableConcept>                                                              // CSBuildMemberListCodedValue.cs:69
	{                                                                                                                                          // CSBuildMemberListCodedValue.cs:70
	    ...
	    /// </summary>
	    public void Set(ObservedFeatureVS.TCoding value) => this.SetFirst(value);                                                              // CSBuildMemberListCodedValue.cs:99
	                                                                                                                                           // CSBuildMemberListCodedValue.cs:76
	    /// <summary>
	    /// Accessor class constructor
	    /// </summary>
	    public FeatureType_Accessor(BreastRadiologyDocument doc) : base("FeatureType_Accessor")                                                // CSBuildMemberListCodedValue.cs:80
	    {                                                                                                                                      // CSBuildMemberListCodedValue.cs:81
	        this.Init(doc, 1, 1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "featureType"));// CSBuildMemberListCodedValue.cs:82
