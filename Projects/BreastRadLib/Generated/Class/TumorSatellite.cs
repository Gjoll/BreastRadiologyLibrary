...
namespace BreastRadLib
{
	...
	public class TumorSatellite : ObservationBase, ITumorSatellite
	{
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			SetProfileUrl("http://hl7.org/fhir/us/breast-radiology/StructureDefinition/TumorSatellite");                                             // DefineBase.cs:238
			//- Constructor
		}
		...
		{                                                                                                                                         // FhirConstruct.cs:760
		    ...
		    {                                                                                                                                     // FhirConstruct.cs:770
		        ...
		        temp4.CodeElement.Value = "tumorSatelliteObservation";                                                                            // FhirConstruct.cs:792
		        temp4.DisplayElement = new FhirString();                                                                                          // FhirConstruct.cs:798
		        temp4.DisplayElement.Value = "Tumor Satellite observation";                                                                       // FhirConstruct.cs:800
		        retVal.Coding.Add(temp4);                                                                                                         // FhirConstruct.cs:819
		    }                                                                                                                                     // FhirConstruct.cs:820
		    retVal.TextElement = new FhirString();                                                                                                // FhirConstruct.cs:825
		    retVal.TextElement.Value = "Tumor Satellite observation";                                                                             // FhirConstruct.cs:827
