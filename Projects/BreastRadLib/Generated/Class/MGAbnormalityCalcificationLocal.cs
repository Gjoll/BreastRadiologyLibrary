...
namespace BreastRadLib.MGAbnormalityCalcificationLocal
{
	...
	/// </summary>
	public class CalcificationTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                              // BuildMemberBase.cs:131
	{                                                                                                                                          // BuildMemberBase.cs:132
	    ...
	    /// Constructor
	    /// </summary>
	    public CalcificationTypeContainer(Int32 min, Int32 max) : base("Observation.component:calcificationType", min, max)                    // BuildMemberBase.cs:141
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:75
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:77
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:79
	                ...
	                Code = CalcificationType_ComponentCode()                                                                                   // BuildMemberComponents.cs:81
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:55
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:56
	            ...
	            this.CalcificationType_ComponentCode());                                                                                       // BuildMemberComponents.cs:58
	...
	/// </summary>
	public class CalcificationDistributionContainer : MContainer, ITMItem<Observation.ComponentComponent>                                      // BuildMemberBase.cs:131
	{                                                                                                                                          // BuildMemberBase.cs:132
	    /// <summary>
	    ...
	    /// Constructor
	    /// </summary>
	    public CalcificationDistributionContainer(Int32 min, Int32 max) : base("Observation.component:calcificationDistribution", min, max)    // BuildMemberBase.cs:141
	    {                                                                                                                                      // BuildMemberBase.cs:142
	    }                                                                                                                                      // BuildMemberBase.cs:144
	                                                                                                                                           // BuildMemberBase.cs:145
	    // Methods                                                                                                                             // BuildMemberBase.cs:146
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:75
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:77
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:79
	                Value = item.Value,                                                                                                        // BuildMemberComponents.cs:80
	                Code = CalcificationDistribution_ComponentCode()                                                                           // BuildMemberComponents.cs:81
	            };                                                                                                                             // BuildMemberComponents.cs:82
	            yield return component;                                                                                                        // BuildMemberComponents.cs:83
	        }                                                                                                                                  // BuildMemberComponents.cs:84
	    }                                                                                                                                      // BuildMemberComponents.cs:85
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:55
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:56
	            components,                                                                                                                    // BuildMemberComponents.cs:57
	            this.CalcificationDistribution_ComponentCode());                                                                               // BuildMemberComponents.cs:58
	        List<Item> items = new List<Item>();                                                                                               // BuildMemberComponents.cs:59
	        foreach (Element element in elements)                                                                                              // BuildMemberComponents.cs:60
	            items.Add(new Item((CodeableConcept) element));                                                                                // BuildMemberComponents.cs:61
	        this.SetAllItems(items);                                                                                                           // BuildMemberComponents.cs:62
