...
{
	//+ LocalClassDefs
	#region Observation.component:calcificationType Container Class                                                                            // BuildMemberBase.cs:173
	...
	/// </summary>
	public class MCalcificationType : MContainer, ITMItem<Observation.ComponentComponent>                                                      // BuildMemberBase.cs:178
	{                                                                                                                                          // BuildMemberBase.cs:179
	    ...
	    /// Constructor
	    /// </summary>
	    public MCalcificationType(Int32 min, Int32 max) : base("Observation.component:calcificationType", min, max)                            // BuildMemberBase.cs:190
	...
	#region Observation.component:calcificationDistribution Container Class                                                                    // BuildMemberBase.cs:173
	// Called from BuildMemberComponents.cs, Line 202
	// BuildMemberBase.cs:175
	/// <summary>
	/// Container class for Observation.component:calcificationDistribution.
	/// </summary>
	public class MCalcificationDistribution : MContainer, ITMItem<Observation.ComponentComponent>                                              // BuildMemberBase.cs:178
	{                                                                                                                                          // BuildMemberBase.cs:179
	    ...
	    /// Constructor
	    /// </summary>
	    public MCalcificationDistribution(Int32 min, Int32 max) : base("Observation.component:calcificationDistribution", min, max)            // BuildMemberBase.cs:190
	    {                                                                                                                                      // BuildMemberBase.cs:191
	    }                                                                                                                                      // BuildMemberBase.cs:193
	                                                                                                                                           // BuildMemberBase.cs:195
	    // Methods                                                                                                                             // BuildMemberBase.cs:196
