...
{
	//+ LocalClassDefs
	#region Observation.component:calcificationType Container Class                                                                            // BuildMemberBase.cs:174
	...
	/// </summary>
	public class MCalcificationType : MContainer, ITMItem<Observation.ComponentComponent>                                                      // BuildMemberBase.cs:179
	{                                                                                                                                          // BuildMemberBase.cs:180
	    #region Observation.component:calcificationType Item Class                                                                             // BuildMemberBase.cs:81
	    // Called from BuildMemberComponents.cs, Line 202
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:87
	        ...
	        {                                                                                                                                  // BuildMemberBase.cs:113
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:61
	                ...
	                Code = CalcificationType_ComponentCode()                                                                                   // BuildMemberComponents.cs:63
	    ...
	    /// Constructor
	    /// </summary>
	    public MCalcificationType(Int32 min = 0, Int32 max = 1) : base("Observation.component:calcificationType", min, max)                    // BuildMemberBase.cs:191
	    {                                                                                                                                      // BuildMemberBase.cs:192
	    }                                                                                                                                      // BuildMemberBase.cs:194
	                                                                                                                                           // BuildMemberBase.cs:196
	    // Methods                                                                                                                             // BuildMemberBase.cs:197
	    private static CodeableConcept CalcificationType_ComponentCode()                                                                       // FhirConstruct.cs:759
	    {                                                                                                                                      // FhirConstruct.cs:760
	        ...
	        {                                                                                                                                  // FhirConstruct.cs:770
	            ...
	            temp4.CodeElement.Value = "mgCalcificationType";                                                                               // FhirConstruct.cs:792
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:74
	        IEnumerable<Observation.ComponentComponent> memberComponents = base.IsMember(doc,                                                  // BuildMemberComponents.cs:75
	            ...
	            CalcificationType_ComponentCode());                                                                                            // BuildMemberComponents.cs:77
	...
	#region Observation.component:calcificationDistribution Container Class                                                                    // BuildMemberBase.cs:174
	// Called from BuildMemberComponents.cs, Line 202
	// BuildMemberBase.cs:176
	/// <summary>
	/// Container class for Observation.component:calcificationDistribution.
	/// </summary>
	public class MCalcificationDistribution : MContainer, ITMItem<Observation.ComponentComponent>                                              // BuildMemberBase.cs:179
	{                                                                                                                                          // BuildMemberBase.cs:180
	    #region Observation.component:calcificationDistribution Item Class                                                                     // BuildMemberBase.cs:81
	    // Called from BuildMemberComponents.cs, Line 202
	    // BuildMemberBase.cs:83
	    /// <summary>
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:87
	        ...
	        {                                                                                                                                  // BuildMemberBase.cs:113
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:61
	                Value = this.Value,                                                                                                        // BuildMemberComponents.cs:62
	                Code = CalcificationDistribution_ComponentCode()                                                                           // BuildMemberComponents.cs:63
	            };                                                                                                                             // BuildMemberComponents.cs:64
	            return retVal;                                                                                                                 // BuildMemberBase.cs:116
	        }                                                                                                                                  // BuildMemberBase.cs:117
	                                                                                                                                           // BuildMemberBase.cs:119
	    ...
	    /// Constructor
	    /// </summary>
	    public MCalcificationDistribution(Int32 min = 0, Int32 max = 1) : base("Observation.component:calcificationDistribution", min, max)    // BuildMemberBase.cs:191
	    {                                                                                                                                      // BuildMemberBase.cs:192
	    }                                                                                                                                      // BuildMemberBase.cs:194
	                                                                                                                                           // BuildMemberBase.cs:196
	    // Methods                                                                                                                             // BuildMemberBase.cs:197
	    private static CodeableConcept CalcificationDistribution_ComponentCode()                                                               // FhirConstruct.cs:759
	    {                                                                                                                                      // FhirConstruct.cs:760
	        CodeableConcept retVal = new CodeableConcept();                                                                                    // FhirConstruct.cs:761
	        retVal.Coding = new List<Coding>();                                                                                                // FhirConstruct.cs:767
	        {                                                                                                                                  // FhirConstruct.cs:770
	            ...
	            temp4.SystemElement.Value = "http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes";               // FhirConstruct.cs:776
	            temp4.CodeElement = new Code();                                                                                                // FhirConstruct.cs:790
	            temp4.CodeElement.Value = "mgCalcificationDistribution";                                                                       // FhirConstruct.cs:792
	            retVal.Coding.Add(temp4);                                                                                                      // FhirConstruct.cs:819
	        }                                                                                                                                  // FhirConstruct.cs:820
	        return retVal;                                                                                                                     // FhirConstruct.cs:835
	    }                                                                                                                                      // FhirConstruct.cs:836
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:74
	        IEnumerable<Observation.ComponentComponent> memberComponents = base.IsMember(doc,                                                  // BuildMemberComponents.cs:75
	            components,                                                                                                                    // BuildMemberComponents.cs:76
	            CalcificationDistribution_ComponentCode());                                                                                    // BuildMemberComponents.cs:77
	        List<Item> items = new List<Item>();                                                                                               // BuildMemberComponents.cs:78
	        foreach (Observation.ComponentComponent memberComponent in memberComponents)                                                       // BuildMemberComponents.cs:79
	        {                                                                                                                                  // BuildMemberComponents.cs:80
	            Item item = new Item();                                                                                                        // BuildMemberComponents.cs:81
