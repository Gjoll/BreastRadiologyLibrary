...
namespace BreastRadLib.MGAbnormalityCalcificationLocal
{
	...
	/// </summary>
	public class CalcificationTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                              // BuildMemberBase.cs:137
	{                                                                                                                                          // BuildMemberBase.cs:138
	    ...
	    /// Constructor
	    /// </summary>
	    public CalcificationTypeContainer(Int32 min, Int32 max) : base("Observation.component:calcificationType", min, max)                    // BuildMemberBase.cs:147
	...
	/// </summary>
	public class CalcificationDistributionContainer : MContainer, ITMItem<Observation.ComponentComponent>                                      // BuildMemberBase.cs:137
	{                                                                                                                                          // BuildMemberBase.cs:138
	    /// <summary>
	    ...
	    /// Constructor
	    /// </summary>
	    public CalcificationDistributionContainer(Int32 min, Int32 max) : base("Observation.component:calcificationDistribution", min, max)    // BuildMemberBase.cs:147
	    {                                                                                                                                      // BuildMemberBase.cs:148
	    }                                                                                                                                      // BuildMemberBase.cs:150
	                                                                                                                                           // BuildMemberBase.cs:151
	    // Methods                                                                                                                             // BuildMemberBase.cs:152
