...
namespace BreastRadLib.MGAbnormalityCalcificationLocal
{
	...
	/// </summary>
	public class CalcificationTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                              // BuildMemberBase.cs:111
	{                                                                                                                                          // BuildMemberBase.cs:112
	    ...
	    /// Constructor
	    /// </summary>
	    public CalcificationTypeContainer(Int32 min, Int32 max) : base("Observation.component", min, max)                                      // BuildMemberBase.cs:121
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:246
	        ...
	        {                                                                                                                                  // BuildMemberBase.cs:248
	            ...
	            Code = CalcificationType_ComponentCode()                                                                                       // BuildMemberComponents.cs:62
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:268
	        ...
	        if (element.Code.IsCode(this.CalcificationType_ComponentCode()))                                                                   // BuildMemberComponents.cs:52
	...
	/// Container class for Observation.component.
	/// </summary>
	public class CalcificationDistributionContainer : MContainer, ITMItem<Observation.ComponentComponent>                                      // BuildMemberBase.cs:111
	{                                                                                                                                          // BuildMemberBase.cs:112
	    /// <summary>
	    /// Item class for Observation.component.
	    /// </summary>
	    ...
	    /// Constructor
	    /// </summary>
	    public CalcificationDistributionContainer(Int32 min, Int32 max) : base("Observation.component", min, max)                              // BuildMemberBase.cs:121
	    {                                                                                                                                      // BuildMemberBase.cs:122
	    }                                                                                                                                      // BuildMemberBase.cs:124
	                                                                                                                                           // BuildMemberBase.cs:125
	    // Methods                                                                                                                             // BuildMemberBase.cs:126
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:246
	        ...
	        {                                                                                                                                  // BuildMemberBase.cs:248
	            Value = item.Value,                                                                                                            // BuildMemberComponents.cs:61
	            Code = CalcificationDistribution_ComponentCode()                                                                               // BuildMemberComponents.cs:62
	        };                                                                                                                                 // BuildMemberBase.cs:250
	    }                                                                                                                                      // BuildMemberBase.cs:251
	                                                                                                                                           // BuildMemberBase.cs:253
	    /// <summary>
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:268
	        Item item = null;                                                                                                                  // BuildMemberComponents.cs:51
	        if (element.Code.IsCode(this.CalcificationDistribution_ComponentCode()))                                                           // BuildMemberComponents.cs:52
	            item = new Item((CodeableConcept) element.Value);                                                                              // BuildMemberComponents.cs:53
	        return item;                                                                                                                       // BuildMemberComponents.cs:54
	    }                                                                                                                                      // BuildMemberBase.cs:270
	                                                                                                                                           // BuildMemberBase.cs:272
