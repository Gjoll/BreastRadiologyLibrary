...
namespace BreastRadLib.MGAbnormalityCalcificationLocal
{
	...
	/// </summary>
	public class CalcificationTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                              // BuildMemberBase.cs:110
	{                                                                                                                                          // BuildMemberBase.cs:111
	    ...
	    /// Constructor
	    /// </summary>
	    public CalcificationTypeContainer(Int32 min, Int32 max) : base("Observation.component:calcificationType", min, max)                    // BuildMemberBase.cs:120
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:76
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:78
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:80
	                ...
	                Code = CalcificationType_ComponentCode()                                                                                   // BuildMemberComponents.cs:82
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:56
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:59
	            if (component.Code.IsCode(this.CalcificationType_ComponentCode()))                                                             // BuildMemberComponents.cs:60
	...
	/// </summary>
	public class CalcificationDistributionContainer : MContainer, ITMItem<Observation.ComponentComponent>                                      // BuildMemberBase.cs:110
	{                                                                                                                                          // BuildMemberBase.cs:111
	    /// <summary>
	    ...
	    /// Constructor
	    /// </summary>
	    public CalcificationDistributionContainer(Int32 min, Int32 max) : base("Observation.component:calcificationDistribution", min, max)    // BuildMemberBase.cs:120
	    {                                                                                                                                      // BuildMemberBase.cs:121
	    }                                                                                                                                      // BuildMemberBase.cs:123
	                                                                                                                                           // BuildMemberBase.cs:124
	    // Methods                                                                                                                             // BuildMemberBase.cs:125
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:76
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:78
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:80
	                Value = item.Value,                                                                                                        // BuildMemberComponents.cs:81
	                Code = CalcificationDistribution_ComponentCode()                                                                           // BuildMemberComponents.cs:82
	            };                                                                                                                             // BuildMemberComponents.cs:83
	            yield return component;                                                                                                        // BuildMemberComponents.cs:84
	        }                                                                                                                                  // BuildMemberComponents.cs:85
	    }                                                                                                                                      // BuildMemberComponents.cs:86
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:56
	        ...
	        foreach (Observation.ComponentComponent component in components)                                                                   // BuildMemberComponents.cs:58
	        {                                                                                                                                  // BuildMemberComponents.cs:59
	            if (component.Code.IsCode(this.CalcificationDistribution_ComponentCode()))                                                     // BuildMemberComponents.cs:60
	                items.Add(new Item((CodeableConcept) component.Value));                                                                    // BuildMemberComponents.cs:61
	        }                                                                                                                                  // BuildMemberComponents.cs:62
	        this.SetAllItems(items);                                                                                                           // BuildMemberComponents.cs:63
	    }                                                                                                                                      // BuildMemberComponents.cs:64
