...
namespace BreastRadLib.AbnormalityCystLocal
{
	...
	/// </summary>
	public class CystTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                       // BuildMemberBase.cs:111
	{                                                                                                                                          // BuildMemberBase.cs:112
	    ...
	    /// Constructor
	    /// </summary>
	    public CystTypeContainer(Int32 min, Int32 max) : base("Observation.component", min, max)                                               // BuildMemberBase.cs:121
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:246
	        ...
	        {                                                                                                                                  // BuildMemberBase.cs:248
	            ...
	            Code = CystType_ComponentCode()                                                                                                // BuildMemberComponents.cs:62
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:268
	        ...
	        if (element.Code.IsCode(this.CystType_ComponentCode()))                                                                            // BuildMemberComponents.cs:52
