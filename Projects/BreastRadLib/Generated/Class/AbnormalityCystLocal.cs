...
namespace BreastRadLib.AbnormalityCystLocal
{
	...
	/// </summary>
	public class CystType_Accessor : ObservationLocal.ComponentBase<CodeableConcept>                                                           // CSDefineObservation.cs:64
	{                                                                                                                                          // CSDefineObservation.cs:65
	    ...
	    /// </summary>
	    public CystType_Accessor(BreastRadiologyDocument doc) : base()                                                                         // CSDefineObservation.cs:75
	    {                                                                                                                                      // CSDefineObservation.cs:76
	        this.Init(doc, 0, 1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "abnormalityCystType"));// CSDefineObservation.cs:77
