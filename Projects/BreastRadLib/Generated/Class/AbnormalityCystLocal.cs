...
namespace BreastRadLib.AbnormalityCystLocal
{
	...
	/// </summary>
	public class CystTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                       // BuildMemberBase.cs:137
	{                                                                                                                                          // BuildMemberBase.cs:138
	    ...
	    /// Constructor
	    /// </summary>
	    public CystTypeContainer(Int32 min, Int32 max) : base("Observation.component:cystType", min, max)                                      // BuildMemberBase.cs:147
