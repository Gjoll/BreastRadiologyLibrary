...
namespace BreastRadLib.AbnormalityCystLocal
{
	...
	/// </summary>
	public class CystType_Accessor : MemberListCodedValueBase<CodeableConcept>                                                                 // BuildMemberListCodedValue.cs:72
	{                                                                                                                                          // BuildMemberListCodedValue.cs:73
	    ...
	    /// Set CystType value
	    /// </summary>
	    public void Set(AbnormalityCystTypeVS.TCoding value) => this.SetFirst(value);                                                          // BuildMemberListCodedValue.cs:102
	                                                                                                                                           // BuildMemberListCodedValue.cs:79
	    /// <summary>
	    /// Accessor class constructor
	    /// </summary>
	    public CystType_Accessor(BreastRadiologyDocument doc) : base("CystType_Accessor")                                                      // BuildMemberListCodedValue.cs:83
	    {                                                                                                                                      // BuildMemberListCodedValue.cs:84
	        this.Init(doc, 0, 1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "abnormalityCystType"));// BuildMemberListCodedValue.cs:85
