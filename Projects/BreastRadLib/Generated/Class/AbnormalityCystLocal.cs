...
{
	//+ LocalClassDefs
	#region Observation.component:cystType Container Class                                                                                     // BuildMemberBase.cs:174
	// Called from BuildMemberComponents.cs, Line 202
	// BuildMemberBase.cs:176
	/// <summary>
	/// Container class for Observation.component:cystType.
	/// </summary>
	public class MCystType : MContainer, ITMItem<Observation.ComponentComponent>                                                               // BuildMemberBase.cs:179
	{                                                                                                                                          // BuildMemberBase.cs:180
	    #region Observation.component:cystType Item Class                                                                                      // BuildMemberBase.cs:81
	    // Called from BuildMemberComponents.cs, Line 202
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:87
	        ...
	        {                                                                                                                                  // BuildMemberBase.cs:113
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:61
	                ...
	                Code = CystType_ComponentCode()                                                                                            // BuildMemberComponents.cs:63
	    ...
	    /// Constructor
	    /// </summary>
	    public MCystType(Int32 min = 0, Int32 max = 1) : base("Observation.component:cystType", min, max)                                      // BuildMemberBase.cs:191
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:74
	        IEnumerable<Observation.ComponentComponent> memberComponents = base.IsMember(doc,                                                  // BuildMemberComponents.cs:75
	            ...
	            CystType_ComponentCode());                                                                                                     // BuildMemberComponents.cs:77
