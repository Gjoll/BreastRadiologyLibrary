...
{
	//+ LocalClassDefs
	#region Observation.component:cystType Container Class                                                                                     // BuildMemberBase.cs:140
	// Called from BuildMemberComponents.cs, Line 179
	// BuildMemberBase.cs:142
	/// <summary>
	/// Container class for Observation.component:cystType.
	/// </summary>
	public class CystTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                       // BuildMemberBase.cs:145
	{                                                                                                                                          // BuildMemberBase.cs:146
	    ...
	    /// Constructor
	    /// </summary>
	    public CystTypeContainer(Int32 min, Int32 max) : base("Observation.component:cystType", min, max)                                      // BuildMemberBase.cs:155
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:71
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:73
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:75
	                ...
	                Code = CystType_ComponentCode()                                                                                            // BuildMemberComponents.cs:77
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:51
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:52
	            ...
	            this.CystType_ComponentCode());                                                                                                // BuildMemberComponents.cs:54
