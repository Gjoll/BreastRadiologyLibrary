...
namespace BreastRadLib.AbnormalityCystLocal
{
	...
	{                                                                                                                                          // CSDefineObservation.cs:43
	    ...
	    {                                                                                                                                      // CSDefineObservation.cs:54
	        this.Create(doc, 1, 1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "abnormalityCystType"));// CSDefineObservation.cs:55
