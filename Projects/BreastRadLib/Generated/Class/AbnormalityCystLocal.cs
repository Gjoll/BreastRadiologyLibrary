...
{
	//+ LocalClassDefs
	#region Observation.component:cystType Container Class                                                                                     // BuildMemberBase.cs:173
	// Called from BuildMemberComponents.cs, Line 202
	// BuildMemberBase.cs:175
	/// <summary>
	/// Container class for Observation.component:cystType.
	/// </summary>
	public class MCystType : MContainer, ITMItem<Observation.ComponentComponent>                                                               // BuildMemberBase.cs:178
	{                                                                                                                                          // BuildMemberBase.cs:179
	    ...
	    /// Constructor
	    /// </summary>
	    public MCystType(Int32 min, Int32 max) : base("Observation.component:cystType", min, max)                                              // BuildMemberBase.cs:190
