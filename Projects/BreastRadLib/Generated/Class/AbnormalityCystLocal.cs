...
namespace BreastRadLib.AbnormalityCystLocal
{
	...
	{                                                                                                                                          // BuildMemberBase.cs:163
	    ...
	    public CodeableConcept CystType_ComponentCode()                                                                                        // FhirConstruct.cs:753
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:98
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:100
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:102
	                ...
	                Code = CystType_ComponentCode()                                                                                            // BuildMemberComponents.cs:104
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:74
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:75
	            ...
	            this.CystType_ComponentCode());                                                                                                // BuildMemberComponents.cs:77
