...
{
	//+ LocalClassDefs
	#region Observation.component:cystType Container Class                                                                                     // BuildMemberBase.cs:157
	// Called from BuildMemberComponents.cs, Line 208
	// BuildMemberBase.cs:159
	/// <summary>
	/// Container class for Observation.component:cystType.
	/// </summary>
	public class CystTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                       // BuildMemberBase.cs:162
	{                                                                                                                                          // BuildMemberBase.cs:163
	    ...
	    /// Constructor
	    /// </summary>
	    public CystTypeContainer(Int32 min, Int32 max) : base("Observation.component:cystType", min, max)                                      // BuildMemberBase.cs:174
