...
namespace BreastRadLib.ConsistentWithLocal
{
	...
	/// </summary>
	public class ValueContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                          // BuildMemberBase.cs:69
	{                                                                                                                                          // BuildMemberBase.cs:70
	    ...
	    /// Constructor
	    /// </summary>
	    public ValueContainer(Int32 min, Int32 max) : base("Observation.component", min, max)                                                  // BuildMemberBase.cs:79
	...
	/// Container class for Observation.component.
	/// </summary>
	public class QualifierContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                      // BuildMemberBase.cs:69
	{                                                                                                                                          // BuildMemberBase.cs:70
	    /// <summary>
	    /// Item class for Observation.component.
	    /// </summary>
	    ...
	    /// Constructor
	    /// </summary>
	    public QualifierContainer(Int32 min, Int32 max) : base("Observation.component", min, max)                                              // BuildMemberBase.cs:79
	    {                                                                                                                                      // BuildMemberBase.cs:80
	    }                                                                                                                                      // BuildMemberBase.cs:82
	                                                                                                                                           // BuildMemberBase.cs:83
	    // Methods                                                                                                                             // BuildMemberBase.cs:84
