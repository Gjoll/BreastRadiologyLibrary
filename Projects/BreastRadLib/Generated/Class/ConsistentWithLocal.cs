...
namespace BreastRadLib.ConsistentWithLocal
{
	...
	{                                                                                                                                          // BuildMemberBase.cs:180
	    ...
	    /// Constructor
	    /// </summary>
	    public MValue(Int32 min = 1, Int32 max = 1) : base("Observation.component:value", min, max)                                            // BuildMemberBase.cs:191
	...
	{                                                                                                                                          // BuildMemberBase.cs:180
	    ...
	    /// Constructor
	    /// </summary>
	    public MQualifier(Int32 min = 0, Int32 max = -1) : base("Observation.component:qualifier", min, max)                                   // BuildMemberBase.cs:191
	    {                                                                                                                                      // BuildMemberBase.cs:192
	    }                                                                                                                                      // BuildMemberBase.cs:194
	                                                                                                                                           // BuildMemberBase.cs:196
	    // Methods                                                                                                                             // BuildMemberBase.cs:197
