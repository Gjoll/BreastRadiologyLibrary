...
namespace BreastRadLib.ShapeComponentsFragmentLocal
{
	...
	/// </summary>
	public class OrientationContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                    // BuildMemberBase.cs:69
	{                                                                                                                                          // BuildMemberBase.cs:70
	    ...
	    /// Constructor
	    /// </summary>
	    public OrientationContainer(Int32 min, Int32 max) : base("Observation.component", min, max)                                            // BuildMemberBase.cs:79
	...
	/// Container class for Observation.component.
	/// </summary>
	public class ShapeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                          // BuildMemberBase.cs:69
	{                                                                                                                                          // BuildMemberBase.cs:70
	    /// <summary>
	    /// Item class for Observation.component.
	    /// </summary>
	    ...
	    /// Constructor
	    /// </summary>
	    public ShapeContainer(Int32 min, Int32 max) : base("Observation.component", min, max)                                                  // BuildMemberBase.cs:79
	    {                                                                                                                                      // BuildMemberBase.cs:80
	    }                                                                                                                                      // BuildMemberBase.cs:82
	                                                                                                                                           // BuildMemberBase.cs:83
	    // Methods                                                                                                                             // BuildMemberBase.cs:84
	...
	/// Container class for Observation.component.
	/// </summary>
	public class MarginContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                         // BuildMemberBase.cs:69
	{                                                                                                                                          // BuildMemberBase.cs:70
	    /// <summary>
	    /// Item class for Observation.component.
	    /// </summary>
	    ...
	    /// Constructor
	    /// </summary>
	    public MarginContainer(Int32 min, Int32 max) : base("Observation.component", min, max)                                                 // BuildMemberBase.cs:79
	    {                                                                                                                                      // BuildMemberBase.cs:80
	    }                                                                                                                                      // BuildMemberBase.cs:82
	                                                                                                                                           // BuildMemberBase.cs:83
	    // Methods                                                                                                                             // BuildMemberBase.cs:84
	...
	/// Container class for Observation.component.
	/// </summary>
	public class MgDensityContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                      // BuildMemberBase.cs:69
	{                                                                                                                                          // BuildMemberBase.cs:70
	    /// <summary>
	    /// Item class for Observation.component.
	    /// </summary>
	    ...
	    /// Constructor
	    /// </summary>
	    public MgDensityContainer(Int32 min, Int32 max) : base("Observation.component", min, max)                                              // BuildMemberBase.cs:79
	    {                                                                                                                                      // BuildMemberBase.cs:80
	    }                                                                                                                                      // BuildMemberBase.cs:82
	                                                                                                                                           // BuildMemberBase.cs:83
	    // Methods                                                                                                                             // BuildMemberBase.cs:84
