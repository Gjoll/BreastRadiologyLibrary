...
namespace BreastRadLib
{
	...
	public class AbnormalityFibroadenoma : ObservationBase, IAbnormalityFibroadenoma
	{
		...
		/// </summary>
		public FibroAdenomaTypeContainer FibroAdenomaType { get ; protected set; }                                                                // BuildMemberBase.cs:380
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			// Called from BuildMemberComponents.cs, Line 204
			this.FibroAdenomaType = new FibroAdenomaTypeContainer(0, 0);                                                                             // BuildMemberBase.cs:359
			//- Constructor
		}
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:138
			    ...
			    this.FibroAdenomaType.Read(this.Doc, items);                                                                                         // BuildMemberComponents.cs:88
			    //- ReadComponents
			...
			{                                                                                                                                        // BuildMemberComponents.cs:148
			    ...
			    items.AddRange(this.FibroAdenomaType.Write(this.Doc));                                                                               // BuildMemberComponents.cs:110
			    //- WriteComponents
