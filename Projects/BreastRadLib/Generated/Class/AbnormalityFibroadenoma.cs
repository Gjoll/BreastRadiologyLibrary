...
namespace BreastRadLib
{
	...
	public class AbnormalityFibroadenoma : ObservationBase, IAbnormalityFibroadenoma
	{
		...
		/// </summary>
		public FibroAdenomaType_Accessor FibroAdenomaType { get ; protected set; }                                                                // BuildMemberListBase.cs:71
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.FibroAdenomaType = new FibroAdenomaType_Accessor(doc);                                                                              // BuildMemberListBase.cs:74
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			if (this.FibroAdenomaType.Validate(sb) == false) retVal = false;                                                                         // BuildMemberListBase.cs:83
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.WriteComponent(this.FibroAdenomaType);                                                                                              // BuildMemberListBase.cs:77
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.ReadComponent(this.FibroAdenomaType);                                                                                               // BuildMemberListBase.cs:80
			//- ReadCode
		}
