...
namespace BreastRadLib
{
	...
	public class AbnormalityFibroadenoma : ObservationBase, IAbnormalityFibroadenoma
	{
		...
		/// </summary>
		public ElementItemComponentSingle<CodeableConcept> FibroAdenomaType { get ; protected set; }                                              // BuildElementItemComponent.cs:74
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.FibroAdenomaType = new ElementItemComponentSingle<CodeableConcept>("FibroAdenomaType", 0, 1, FixedValue_ObservationComponentFibroAdenomaTypeCode());// BuildElementItemComponent.cs:59
			//- Constructor
		}
