...
namespace BreastRadLib
{
	...
	public class AbnormalityFibroadenoma : ObservationBase, IAbnormalityFibroadenoma
	{
		...
		/// </summary>
		public MFibroAdenomaType FibroAdenomaType { get ; protected set; }                                                                        // BuildMemberBase.cs:399
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			// Called from BuildMemberComponents.cs, Line 202
			this.FibroAdenomaType = new MFibroAdenomaType(0, 1);                                                                                     // BuildMemberBase.cs:378
			//- Constructor
		}
