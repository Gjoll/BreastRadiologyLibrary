...
namespace BreastRadLib.AbnormalityDuctLocal
{
	...
	{                                                                                                                                          // BuildMemberBase.cs:163
	    ...
	    public CodeableConcept DuctType_ComponentCode()                                                                                        // FhirConstruct.cs:753
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:96
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:98
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:100
	                ...
	                Code = DuctType_ComponentCode()                                                                                            // BuildMemberComponents.cs:102
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:72
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:73
	            ...
	            this.DuctType_ComponentCode());                                                                                                // BuildMemberComponents.cs:75
