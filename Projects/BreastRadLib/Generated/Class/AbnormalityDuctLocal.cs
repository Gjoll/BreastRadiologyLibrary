...
namespace BreastRadLib.AbnormalityDuctLocal
{
	...
	/// </summary>
	public class DuctTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                       // BuildMemberBase.cs:135
	{                                                                                                                                          // BuildMemberBase.cs:136
	    ...
	    /// Constructor
	    /// </summary>
	    public DuctTypeContainer(Int32 min, Int32 max) : base("Observation.component:ductType", min, max)                                      // BuildMemberBase.cs:145
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:75
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:77
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:79
	                ...
	                Code = DuctType_ComponentCode()                                                                                            // BuildMemberComponents.cs:81
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:55
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:56
	            ...
	            this.DuctType_ComponentCode());                                                                                                // BuildMemberComponents.cs:58
