...
{
	//+ LocalClassDefs
	#region Observation.component:ductType Container Class                                                                                     // BuildMemberBase.cs:157
	// Called from BuildMemberComponents.cs, Line 208
	// BuildMemberBase.cs:159
	/// <summary>
	/// Container class for Observation.component:ductType.
	/// </summary>
	public class DuctTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                       // BuildMemberBase.cs:162
	{                                                                                                                                          // BuildMemberBase.cs:163
	    #region Observation.component:ductType Item Class                                                                                      // BuildMemberBase.cs:75
	    // Called from BuildMemberComponents.cs, Line 208
	    // BuildMemberBase.cs:77
	    /// <summary>
	    /// Item class for Observation.component:ductType.
	    /// </summary>
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:81
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:64
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:66
	                ...
	                Code = DuctType_ComponentCode()                                                                                            // BuildMemberComponents.cs:68
	    ...
	    /// Constructor
	    /// </summary>
	    public DuctTypeContainer(Int32 min, Int32 max) : base("Observation.component:ductType", min, max)                                      // BuildMemberBase.cs:174
	    {                                                                                                                                      // BuildMemberBase.cs:175
	    }                                                                                                                                      // BuildMemberBase.cs:177
	                                                                                                                                           // BuildMemberBase.cs:179
	    // Methods                                                                                                                             // BuildMemberBase.cs:180
	    private static CodeableConcept DuctType_ComponentCode()                                                                                // FhirConstruct.cs:759
	    {                                                                                                                                      // FhirConstruct.cs:760
	        ...
	        {                                                                                                                                  // FhirConstruct.cs:770
	            ...
	            temp4.CodeElement.Value = "abnormalityDuctType";                                                                               // FhirConstruct.cs:792
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:80
	        IEnumerable<Observation.ComponentComponent> memberComponents = base.IsMember(doc,                                                  // BuildMemberComponents.cs:81
	            ...
	            DuctType_ComponentCode());                                                                                                     // BuildMemberComponents.cs:83
