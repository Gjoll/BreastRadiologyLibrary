...
namespace BreastRadLib
{
	...
	public class AbnormalityForeignObject : ObservationBase, IAbnormalityForeignObject
	{
		...
		/// </summary>
		public AbnormalityForeignObjectTypeContainer AbnormalityForeignObjectType { get ; protected set; }                                        // BuildMemberBase.cs:355
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			// Called from BuildMemberComponents.cs, Line 179
			this.AbnormalityForeignObjectType = new AbnormalityForeignObjectTypeContainer(1, 1);                                                     // BuildMemberBase.cs:334
			//- Constructor
		}
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:113
			    ...
			    this.AbnormalityForeignObjectType.Read(this.Doc, items);                                                                             // BuildMemberComponents.cs:63
			    //- ReadComponents
			...
			{                                                                                                                                        // BuildMemberComponents.cs:123
			    ...
			    items.AddRange(this.AbnormalityForeignObjectType.Write(this.Doc));                                                                   // BuildMemberComponents.cs:85
			    //- WriteComponents
