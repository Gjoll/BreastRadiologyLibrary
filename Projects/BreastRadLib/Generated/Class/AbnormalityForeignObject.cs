...
namespace BreastRadLib
{
	...
	public class AbnormalityForeignObject : ObservationBase, IAbnormalityForeignObject
	{
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.AbnormalityForeignObjectType = new TItemComponentSingle<CodeableConcept>("AbnormalityForeignObjectType", 1, 1, FixedValue_ObservationComponentAbnormalityForeignObjectTypeCode());// BuildElementItemComponent.cs:59
			//- Constructor
		}
