...
namespace BreastRadLib
{
	...
	public class AbnormalityForeignObject : ObservationBase, IAbnormalityForeignObject
	{
		...
		/// </summary>
		public AbnormalityForeignObjectTypeContainer AbnormalityForeignObjectType { get ; protected set; }                                        // BuildMemberBase.cs:336
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.AbnormalityForeignObjectType = new AbnormalityForeignObjectTypeContainer(1, 1);                                                     // BuildMemberBase.cs:320
			//- Constructor
		}
