...
namespace BreastRadLib
{
	...
	public class AbnormalityLymphNode : ObservationBase, IAbnormalityLymphNode
	{
		...
		/// </summary>
		public MTumorSatellite TumorSatellite { get ; protected set; }                                                                            // BuildMemberBase.cs:396
		                                                                                                                                          // BuildMemberBase.cs:390
		...
		/// </summary>
		public MOrientation Orientation { get ; protected set; }                                                                                  // BuildMemberBase.cs:396
		                                                                                                                                          // BuildMemberBase.cs:390
		// Called from BuildMemberComponents.cs, Line 202
		// BuildMemberBase.cs:392
		/// <summary>
		...
		/// </summary>
		public MShape Shape { get ; protected set; }                                                                                              // BuildMemberBase.cs:396
		                                                                                                                                          // BuildMemberBase.cs:390
		// Called from BuildMemberComponents.cs, Line 202
		// BuildMemberBase.cs:392
		/// <summary>
		...
		/// </summary>
		public MMargin Margin { get ; protected set; }                                                                                            // BuildMemberBase.cs:396
		                                                                                                                                          // BuildMemberBase.cs:390
		// Called from BuildMemberComponents.cs, Line 202
		// BuildMemberBase.cs:392
		/// <summary>
		...
		/// </summary>
		public MMgDensity MgDensity { get ; protected set; }                                                                                      // BuildMemberBase.cs:396
		                                                                                                                                          // BuildMemberBase.cs:390
		// Called from BuildMemberComponents.cs, Line 202
		// BuildMemberBase.cs:392
		/// <summary>
		...
		/// </summary>
		public MLymphNodeType LymphNodeType { get ; protected set; }                                                                              // BuildMemberBase.cs:396
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			SetProfileUrl("http://hl7.org/fhir/us/breast-radiology/StructureDefinition/AbnormalityLymphNode");                                       // DefineBase.cs:238
			// Called from BuildMemberReferences.cs, Line 191
			this.TumorSatellite = new MTumorSatellite(0, -1);                                                                                        // BuildMemberBase.cs:375
			// Called from BuildMemberElement.cs, Line 123
			...
			// Called from BuildMemberComponents.cs, Line 202
			this.Orientation = new MOrientation(0, 1);                                                                                               // BuildMemberBase.cs:375
			// Called from BuildMemberComponents.cs, Line 202
			this.Shape = new MShape(0, 1);                                                                                                           // BuildMemberBase.cs:375
			// Called from BuildMemberComponents.cs, Line 202
			this.Margin = new MMargin(0, 1);                                                                                                         // BuildMemberBase.cs:375
			// Called from BuildMemberComponents.cs, Line 202
			this.MgDensity = new MMgDensity(0, 1);                                                                                                   // BuildMemberBase.cs:375
			// Called from BuildMemberComponents.cs, Line 202
			...
			// Called from BuildMemberComponents.cs, Line 202
			this.LymphNodeType = new MLymphNodeType(0, 1);                                                                                           // BuildMemberBase.cs:375
			//- Constructor
		}
		...
		{                                                                                                                                         // FhirConstruct.cs:760
		    ...
		    {                                                                                                                                     // FhirConstruct.cs:770
		        ...
		        temp4.CodeElement.Value = "abnormalityLymphNodeObservation";                                                                      // FhirConstruct.cs:792
		        temp4.DisplayElement = new FhirString();                                                                                          // FhirConstruct.cs:798
		        temp4.DisplayElement.Value = "Abnormality Lymph Node observation";                                                                // FhirConstruct.cs:800
		        retVal.Coding.Add(temp4);                                                                                                         // FhirConstruct.cs:819
		    }                                                                                                                                     // FhirConstruct.cs:820
		    retVal.TextElement = new FhirString();                                                                                                // FhirConstruct.cs:825
		    retVal.TextElement.Value = "Abnormality Lymph Node observation";                                                                      // FhirConstruct.cs:827
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:136
			    ...
			    this.LymphNodeType.Read(this.Doc, items);                                                                                            // BuildMemberComponents.cs:90
			    //- ReadComponents
			...
			{                                                                                                                                        // BuildMemberComponents.cs:146
			    ...
			    items.AddRange(this.LymphNodeType.Write(this.Doc));                                                                                  // BuildMemberComponents.cs:108
			    //- WriteComponents
