...
namespace BreastRadLib
{
	...
	public class AbnormalityLymphNode : ObservationBase, IAbnormalityLymphNode
	{
		...
		/// </summary>
		public LymphNodeTypeContainer LymphNodeType { get ; protected set; }                                                                      // BuildMemberBase.cs:355
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			// Called from BuildMemberComponents.cs, Line 179
			this.LymphNodeType = new LymphNodeTypeContainer(0, 0);                                                                                   // BuildMemberBase.cs:334
			//- Constructor
		}
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:113
			    ...
			    this.LymphNodeType.Read(this.Doc, items);                                                                                            // BuildMemberComponents.cs:63
			    //- ReadComponents
			...
			{                                                                                                                                        // BuildMemberComponents.cs:123
			    ...
			    items.AddRange(this.LymphNodeType.Write(this.Doc));                                                                                  // BuildMemberComponents.cs:85
			    //- WriteComponents
