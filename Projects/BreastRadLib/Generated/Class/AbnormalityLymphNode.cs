...
namespace BreastRadLib
{
	...
	public class AbnormalityLymphNode : ObservationBase, IAbnormalityLymphNode
	{
		...
		/// </summary>
		public TumorSatellite_Accessor TumorSatellite { get ; protected set; }                                                                    // BuildMemberListBase.cs:47
		/// <summary>
		...
		/// </summary>
		public LymphNodeType_Accessor LymphNodeType { get ; protected set; }                                                                      // BuildMemberListBase.cs:47
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			SetProfileUrl("http://hl7.org/fhir/us/breast-radiology/StructureDefinition/AbnormalityLymphNode");                                       // DefineBase.cs:194
			/// <summary>
			/// Constructor
			/// </summary>
			this.TumorSatellite = new TumorSatellite_Accessor(doc);                                                                                  // BuildMemberListBase.cs:53
			/// <summary>
			/// Constructor
			/// </summary>
			...
			/// Constructor
			/// </summary>
			this.LymphNodeType = new LymphNodeType_Accessor(doc);                                                                                    // BuildMemberListBase.cs:53
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			//- ValidateCodeStart
			//+ ValidateCode
			if (this.TumorSatellite.Validate(sb) == false) retVal = false;                                                                           // BuildMemberListBase.cs:62
			...
			if (this.LymphNodeType.Validate(sb) == false) retVal = false;                                                                            // BuildMemberListBase.cs:62
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			//- WriteCodeStart
			//+ WriteCode
			this.WriteHasMember(this.TumorSatellite);                                                                                                // BuildMemberListBase.cs:56
			...
			this.WriteComponent(this.LymphNodeType);                                                                                                 // BuildMemberListBase.cs:56
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			//- ReadCodeStart
			//+ ReadCode
			this.ReadHasMember(this.TumorSatellite);                                                                                                 // BuildMemberListBase.cs:59
			...
			this.ReadComponent(this.LymphNodeType);                                                                                                  // BuildMemberListBase.cs:59
			//- ReadCode
		}
