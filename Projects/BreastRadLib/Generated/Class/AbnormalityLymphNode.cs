...
namespace BreastRadLib
{
	...
	public class AbnormalityLymphNode : ObservationBase, IAbnormalityLymphNode
	{
		...
		/// </summary>
		public TItemReferenceMultiple<TumorSatellite> TumorSatellite { get ; protected set; }                                               // BuildItemReference.cs:63
		...
		/// </summary>
		public TItemComponentSingle<CodeableConcept> LymphNodeType { get ; protected set; }                                                 // BuildItemComponent.cs:74
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.TumorSatellite = new TItemReferenceMultiple<TumorSatellite>("TumorSatellite", 0, -1, doc, "http://hl7.org/fhir/us/breast-radiology/StructureDefinition/TumorSatellite");// BuildItemReference.cs:48
			...
			this.LymphNodeType = new TItemComponentSingle<CodeableConcept>("LymphNodeType", 0, 1, FixedValue_ObservationComponentLymphNodeTypeCode());// BuildItemComponent.cs:59
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			//- ValidateCodeStart
			//+ ValidateCode
			if (this.TumorSatellite.Validate(sb) == false) retVal = false;                                                                           // BuildItemReference.cs:72
			...
			if (this.LymphNodeType.Validate(sb) == false) retVal = false;                                                                            // BuildItemComponent.cs:83
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			//- WriteCodeStart
			//+ WriteCode
			this.WriteHasMembers(this.TumorSatellite);                                                                                               // BuildItemReference.cs:66
			...
			this.WriteComponent(this.LymphNodeType);                                                                                                 // BuildItemComponent.cs:77
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			//- ReadCodeStart
			//+ ReadCode
			this.ReadHasMembers(this.TumorSatellite);                                                                                                // BuildItemReference.cs:69
			...
			this.ReadComponent(this.LymphNodeType);                                                                                                  // BuildItemComponent.cs:80
			//- ReadCode
		}
