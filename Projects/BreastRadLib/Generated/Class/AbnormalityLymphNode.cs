...
namespace BreastRadLib
{
	public class AbnormalityLymphNode : ObservationBase, IObservationLeafFragment, ITumorSatelliteFragment, IBreastRadObservationNoDeviceFragment, IBreastRadObservationNoValueFragment, IBreastRadObservationNoComponentFragment, ICommonComponentsFragment, IShapeComponentsFragment, IObservedCountFragment, IObservedDistributionFragment, IObservedSizeFragment, INotPreviouslySeenComponentFragment, ICorrespondsWithFragment, IPreviouslyDemonstratedByFragment, IAssociatedFeaturesHasMemberFragment
	{
		...
		public LymphNodeType_Accessor LymphNodeType { get ; protected set; }                                                                      // CSBuildMemberListBase.cs:33
		//- Fields
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			SetProfileUrl("http://hl7.org/fhir/us/breast-radiology/StructureDefinition/AbnormalityLymphNode");                                       // CSDefineBase.cs:191
			...
			this.LymphNodeType = new LymphNodeType_Accessor(doc);                                                                                    // CSBuildMemberListBase.cs:36
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			if (this.LymphNodeType.Validate(sb) == false) retVal = false;                                                                            // CSBuildMemberListBase.cs:45
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.WriteComponent(this.LymphNodeType);                                                                                                 // CSBuildMemberListBase.cs:39
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.ReadComponent(this.LymphNodeType);                                                                                                  // CSBuildMemberListBase.cs:42
			//- ReadCode
		}
