...
namespace BreastRadLib
{
	public class AbnormalityLymphNode : ObservationBase, IAbnormalityLymphNode
	{
		...
		public LymphNodeType_Accessor LymphNodeType { get ; protected set; }                                                                      // BuildMemberListBase.cs:33
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.LymphNodeType = new LymphNodeType_Accessor(doc);                                                                                    // BuildMemberListBase.cs:36
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			if (this.LymphNodeType.Validate(sb) == false) retVal = false;                                                                            // BuildMemberListBase.cs:45
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.WriteComponent(this.LymphNodeType);                                                                                                 // BuildMemberListBase.cs:39
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.ReadComponent(this.LymphNodeType);                                                                                                  // BuildMemberListBase.cs:42
			//- ReadCode
		}
