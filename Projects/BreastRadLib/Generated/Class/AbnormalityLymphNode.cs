	...
	public class AbnormalityLymphNode : ObservationBase, IAbnormalityLymphNode
	{
		...
		//+ !HasMembers
			...
			{                                                                                                                                        // BuildMemberReferences.cs:143
			    ...
			    //+ WriteHasMembers
			    items.AddRange(this.TumorSatellite.Write(this.Doc));                                                                                 // BuildMemberReferences.cs:105
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:138
			    ...
			    this.LymphNodeType.Read(this.Doc, items);                                                                                            // BuildMemberComponents.cs:88
			    //- ReadComponents
			...
			{                                                                                                                                        // BuildMemberComponents.cs:148
			    ...
			    items.AddRange(this.LymphNodeType.Write(this.Doc));                                                                                  // BuildMemberComponents.cs:110
			    //- WriteComponents
