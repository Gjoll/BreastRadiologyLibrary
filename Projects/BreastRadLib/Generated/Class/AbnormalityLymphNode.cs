...
namespace BreastRadLib
{
	...
	public class AbnormalityLymphNode : ObservationBase, IAbnormalityLymphNode
	{
		...
		/// </summary>
		public TItemComponentSingle<CodeableConcept> LymphNodeType { get ; protected set; }                                                       // BuildElementItemComponent.cs:74
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.LymphNodeType = new TItemComponentSingle<CodeableConcept>("Observation.component:lymphNodeType", 0, 1, FixedValue_ObservationComponentLymphNodeTypeCode());// BuildElementItemComponent.cs:59
			//- Constructor
		}
