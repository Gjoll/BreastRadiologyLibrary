...
namespace BreastRadLib
{
	...
	{
		//+ Fields
		public TumorSatellite_Accessor TumorSatellite { get ; protected set; }                                                                    // CSDefineObservation.cs:320
		...
		public LymphNodeType_Accessor LymphNodeType { get ; protected set; }                                                                      // CSDefineObservation.cs:209
		//- Fields
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			SetProfileUrl("http://hl7.org/fhir/us/breast-radiology/StructureDefinition/AbnormalityLymphNode");                                       // CSDefineBase.cs:218
			this.TumorSatellite = new TumorSatellite_Accessor(doc);                                                                                  // CSDefineObservation.cs:323
			...
			this.LymphNodeType = new LymphNodeType_Accessor(doc);                                                                                    // CSDefineObservation.cs:212
			//- Constructor
		}
		...
		public override void Write()
		{
			...
			//- WriteCodeStart
			//+ WriteCode
			this.WriteHasMember(this.TumorSatellite);                                                                                                // CSDefineObservation.cs:326
			...
			this.WriteComponent(this.LymphNodeType);                                                                                                 // CSDefineObservation.cs:215
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			//- ReadCodeStart
			//+ ReadCode
			this.ReadHasMember(this.TumorSatellite);                                                                                                 // CSDefineObservation.cs:329
			...
			this.ReadComponent(this.LymphNodeType);                                                                                                  // CSDefineObservation.cs:218
			//- ReadCode
		}
