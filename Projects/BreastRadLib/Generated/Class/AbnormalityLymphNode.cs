...
namespace BreastRadLib
{
	...
	public class AbnormalityLymphNode : ObservationBase, IAbnormalityLymphNode
	{
		...
		/// </summary>
		public TumorSatelliteContainer TumorSatellite { get ; protected set; }                                                                    // BuildMemberBase.cs:381
		                                                                                                                                          // BuildMemberBase.cs:375
		...
		/// </summary>
		public LymphNodeTypeContainer LymphNodeType { get ; protected set; }                                                                      // BuildMemberBase.cs:381
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			// Called from BuildMemberReferences.cs, Line 199
			this.TumorSatellite = new TumorSatelliteContainer(0, 0);                                                                                 // BuildMemberBase.cs:360
			// Called from BuildMemberComponents.cs, Line 208
			...
			// Called from BuildMemberComponents.cs, Line 208
			this.LymphNodeType = new LymphNodeTypeContainer(0, 0);                                                                                   // BuildMemberBase.cs:360
			//- Constructor
		}
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:142
			    ...
			    this.LymphNodeType.Read(this.Doc, items);                                                                                            // BuildMemberComponents.cs:96
			    //- ReadComponents
			...
			{                                                                                                                                        // BuildMemberComponents.cs:152
			    ...
			    items.AddRange(this.LymphNodeType.Write(this.Doc));                                                                                  // BuildMemberComponents.cs:114
			    //- WriteComponents
