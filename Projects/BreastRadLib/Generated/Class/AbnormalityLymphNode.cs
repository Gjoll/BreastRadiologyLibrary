...
namespace BreastRadLib
{
	...
	public class AbnormalityLymphNode : ObservationBase, IAbnormalityLymphNode
	{
		...
		/// </summary>
		public LymphNodeTypeContainer LymphNodeType { get ; protected set; }                                                                      // BuildMemberBase.cs:336
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.LymphNodeType = new LymphNodeTypeContainer(0, 0);                                                                                   // BuildMemberBase.cs:320
			//- Constructor
		}
