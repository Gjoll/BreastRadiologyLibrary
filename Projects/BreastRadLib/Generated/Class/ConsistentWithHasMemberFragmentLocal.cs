...
{
	//+ LocalClassDefs
	#region Observation.hasMember:consistentWith Container Class                                                                               // BuildMemberBase.cs:173
	...
	/// </summary>
	public class MConsistentWith : MContainer, ITMItem<ResourceReference>                                                                      // BuildMemberBase.cs:178
	{                                                                                                                                          // BuildMemberBase.cs:179
	    ...
	    /// Return all items
	    /// </summary>
	    public IEnumerable<ConsistentWith> All()                                                                                               // BuildMemberBase.cs:301
	    ...
	    /// </summary>
	    public ConsistentWith GetAt(Int32 i) => this.items[i].Value;                                                                           // BuildMemberBase.cs:311
	    ...
	    /// Constructor
	    /// </summary>
	    public MConsistentWith(Int32 min, Int32 max) : base("Observation.hasMember:consistentWith", min, max)                                  // BuildMemberBase.cs:190
	    ...
	    /// </summary>
	    public ConsistentWith Append(ConsistentWith value)                                                                                     // BuildMemberBase.cs:333
