...
namespace BreastRadLib.ConsistentWithHasMemberFragmentLocal
{
	...
	/// </summary>
	public class ConsistentWithContainer : MContainer, ITMItem<ResourceReference>                                                              // BuildMemberBase.cs:137
	{                                                                                                                                          // BuildMemberBase.cs:138
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:116
	        "http://hl7.org/fhir/us/breast-radiology/StructureDefinition/ConsistentWith"                                                       // BuildMemberBase.cs:123
	    ...
	    /// Return all items
	    /// </summary>
	    public IEnumerable<ConsistentWith> All()                                                                                               // BuildMemberBase.cs:251
	    ...
	    /// </summary>
	    public ConsistentWith GetAt(Int32 i) => this.items[i].Value;                                                                           // BuildMemberBase.cs:261
	    ...
	    /// Constructor
	    /// </summary>
	    public ConsistentWithContainer(Int32 min, Int32 max) : base("Observation.hasMember:consistentWith", min, max)                          // BuildMemberBase.cs:147
	    ...
	    /// </summary>
	    public ConsistentWith Append(ConsistentWith value)                                                                                     // BuildMemberBase.cs:283
