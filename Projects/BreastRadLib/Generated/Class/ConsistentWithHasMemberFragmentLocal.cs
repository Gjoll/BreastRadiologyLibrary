...
{
	//+ LocalClassDefs
	#region Observation.hasMember:consistentWith Container Class                                                                               // BuildMemberBase.cs:140
	...
	/// </summary>
	public class ConsistentWithContainer : MContainer, ITMItem<ResourceReference>                                                              // BuildMemberBase.cs:145
	{                                                                                                                                          // BuildMemberBase.cs:146
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:81
	        ...
	        /// Constructor
	        /// </summary>
	        public Item(ConsistentWith value)                                                                                                  // BuildMemberBase.cs:92
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:122
	        "http://hl7.org/fhir/us/breast-radiology/StructureDefinition/ConsistentWith"                                                       // BuildMemberBase.cs:129
	    ...
	    /// Return all items
	    /// </summary>
	    public IEnumerable<ConsistentWith> All()                                                                                               // BuildMemberBase.cs:262
	    ...
	    /// </summary>
	    public ConsistentWith GetAt(Int32 i) => this.items[i].Value;                                                                           // BuildMemberBase.cs:272
	    ...
	    /// Constructor
	    /// </summary>
	    public ConsistentWithContainer(Int32 min, Int32 max) : base("Observation.hasMember:consistentWith", min, max)                          // BuildMemberBase.cs:155
	    ...
	    /// </summary>
	    public ConsistentWith Append(ConsistentWith value)                                                                                     // BuildMemberBase.cs:294
