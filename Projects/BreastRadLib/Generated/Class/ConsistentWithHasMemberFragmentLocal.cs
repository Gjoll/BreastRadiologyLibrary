...
{
	//+ LocalClassDefs
	#region Observation.hasMember:consistentWith Container Class                                                                               // BuildMemberBase.cs:158
	...
	{                                                                                                                                          // BuildMemberBase.cs:164
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:81
	        ...
	        /// Value
	        /// </summary>
	        public ConsistentWith Value { get; set; }                                                                                          // BuildMemberBase.cs:87
	    ...
	    /// Return all items
	    /// </summary>
	    public IEnumerable<ConsistentWith> All()                                                                                               // BuildMemberBase.cs:286
	    ...
	    /// </summary>
	    public ConsistentWith GetAt(Int32 i) => this.items[i].Value;                                                                           // BuildMemberBase.cs:296
	    ...
	    /// </summary>
	    public ConsistentWith Append(ConsistentWith value)                                                                                     // BuildMemberBase.cs:318
