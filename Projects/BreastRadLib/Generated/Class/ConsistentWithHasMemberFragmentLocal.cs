...
namespace BreastRadLib.ConsistentWithHasMemberFragmentLocal
{
	...
	/// </summary>
	public class ConsistentWithContainer : MContainer, ITMItem<ResourceReference>                                                              // BuildMemberBase.cs:110
	{                                                                                                                                          // BuildMemberBase.cs:111
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:63
	        ...
	        /// Value
	        /// </summary>
	        public ConsistentWith Value { get; set; }                                                                                          // BuildMemberBase.cs:68
	                                                                                                                                           // BuildMemberBase.cs:70
	        /// <summary>
	        /// Constructor
	        /// </summary>
	        public Item(ConsistentWith value)                                                                                                  // BuildMemberBase.cs:74
	    ...
	    {                                                                                                                                      // BuildMemberReferences.cs:47
	        "http://hl7.org/fhir/us/breast-radiology/StructureDefinition/ConsistentWith"                                                       // BuildMemberReferences.cs:54
	    ...
	    /// Return all items
	    /// </summary>
	    public IEnumerable<ConsistentWith> All()                                                                                               // BuildMemberBase.cs:226
	    ...
	    /// </summary>
	    public ConsistentWith GetAt(Int32 i) => this.items[i].Value;                                                                           // BuildMemberBase.cs:236
	    ...
	    /// Constructor
	    /// </summary>
	    public ConsistentWithContainer(Int32 min, Int32 max) : base("Observation.hasMember:consistentWith", min, max)                          // BuildMemberBase.cs:120
	    ...
	    /// </summary>
	    public ConsistentWith Append(ConsistentWith value)                                                                                     // BuildMemberBase.cs:258
	    ...
	    {                                                                                                                                      // BuildMemberReferences.cs:65
	        ...
	        {                                                                                                                                  // BuildMemberReferences.cs:71
	            Item item = new Item((ConsistentWith) resource);                                                                               // BuildMemberReferences.cs:72
