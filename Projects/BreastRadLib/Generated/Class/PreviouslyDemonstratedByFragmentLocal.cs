...
{
	//+ LocalClassDefs
	#region Observation.component:PreviouslyDemonstratedBy Container Class                                                                     // BuildMemberBase.cs:157
	...
	/// </summary>
	public class PreviouslyDemonstratedByContainer : MContainer, ITMItem<Observation.ComponentComponent>                                       // BuildMemberBase.cs:162
	{                                                                                                                                          // BuildMemberBase.cs:163
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:81
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:64
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:66
	                ...
	                Code = PreviouslyDemonstratedBy_ComponentCode()                                                                            // BuildMemberComponents.cs:68
	    ...
	    /// Constructor
	    /// </summary>
	    public PreviouslyDemonstratedByContainer(Int32 min, Int32 max) : base("Observation.component:PreviouslyDemonstratedBy", min, max)      // BuildMemberBase.cs:174
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:80
	        IEnumerable<Observation.ComponentComponent> memberComponents = base.IsMember(doc,                                                  // BuildMemberComponents.cs:81
	            ...
	            PreviouslyDemonstratedBy_ComponentCode());                                                                                     // BuildMemberComponents.cs:83
