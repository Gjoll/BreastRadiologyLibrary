...
namespace BreastRadLib.PreviouslyDemonstratedByFragmentLocal
{
	...
	/// </summary>
	public class PreviouslyDemonstratedBy_Accessor : MemberListCodedValue<CodeableConcept>                                                     // BuildMemberListCodedValue.cs:51
	{                                                                                                                                          // BuildMemberListCodedValue.cs:52
	    ...
	    /// </summary>
	    public void Append(CodeableConcept value) => this.RawItems.Add(value);                                                                 // BuildMemberListCodedValue.cs:109
	                                                                                                                                           // BuildMemberListCodedValue.cs:105
	    /// <summary>
	    /// Append item to end of list
	    /// </summary>
	    public void Append(PreviouslyDemonstratedByVS.TCoding value) => this.RawItems.Add(value);                                              // BuildMemberListCodedValue.cs:109
	                                                                                                                                           // BuildMemberListCodedValue.cs:58
	    /// <summary>
	    /// Accessor class constructor
	    /// </summary>
	    public PreviouslyDemonstratedBy_Accessor(BreastRadiologyDocument doc) : base("PreviouslyDemonstratedBy_Accessor")                      // BuildMemberListCodedValue.cs:62
	    {                                                                                                                                      // BuildMemberListCodedValue.cs:63
	        this.Init(doc, 0, -1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "prevDemBy"));// BuildMemberListCodedValue.cs:64
