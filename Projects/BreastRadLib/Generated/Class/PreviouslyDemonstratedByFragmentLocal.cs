...
namespace BreastRadLib.PreviouslyDemonstratedByFragmentLocal
{
	...
	/// </summary>
	public class PreviouslyDemonstratedBy_Accessor : MemberListCodedValueBase<CodeableConcept>                                                 // BuildMemberListCodedValue.cs:64
	{                                                                                                                                          // BuildMemberListCodedValue.cs:65
	    ...
	    /// </summary>
	    public void Append(CodeableConcept value)                                                                                              // BuildMemberListCodedValue.cs:122
	    ...
	    /// Append item to end of list
	    /// </summary>
	    public void Append(PreviouslyDemonstratedByVS.TCoding value)                                                                           // BuildMemberListCodedValue.cs:122
	    {                                                                                                                                      // BuildMemberListCodedValue.cs:123
	        this.RawItems.Add(value);                                                                                                          // BuildMemberListCodedValue.cs:124
	    }                                                                                                                                      // BuildMemberListCodedValue.cs:125
	    ...
	    /// </summary>
	    public PreviouslyDemonstratedBy_Accessor(BreastRadiologyDocument doc) : base("PreviouslyDemonstratedBy_Accessor")                      // BuildMemberListCodedValue.cs:75
	    {                                                                                                                                      // BuildMemberListCodedValue.cs:76
	        this.Init(doc, 0, -1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "prevDemBy"));// BuildMemberListCodedValue.cs:77
