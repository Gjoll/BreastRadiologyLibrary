...
namespace BreastRadLib.PreviouslyDemonstratedByFragmentLocal
{
	...
	/// </summary>
	public class PreviouslyDemonstratedBy_Accessor : MemberListCodedValueBase<CodeableConcept>                                                 // CSBuildMemberListCodedValue.cs:69
	{                                                                                                                                          // CSBuildMemberListCodedValue.cs:70
	    ...
	    /// Append item to end of list
	    /// </summary>
	    public void Append(PreviouslyDemonstratedByVS.TCoding value)                                                                           // CSBuildMemberListCodedValue.cs:127
	    {                                                                                                                                      // CSBuildMemberListCodedValue.cs:128
	        this.RawItems.Add(value);                                                                                                          // CSBuildMemberListCodedValue.cs:129
	    }                                                                                                                                      // CSBuildMemberListCodedValue.cs:130
	    ...
	    /// </summary>
	    public PreviouslyDemonstratedBy_Accessor(BreastRadiologyDocument doc) : base("PreviouslyDemonstratedBy_Accessor")                      // CSBuildMemberListCodedValue.cs:80
	    {                                                                                                                                      // CSBuildMemberListCodedValue.cs:81
	        this.Init(doc, 0, -1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "prevDemBy"));// CSBuildMemberListCodedValue.cs:82
