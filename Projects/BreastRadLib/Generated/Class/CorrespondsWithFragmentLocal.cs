...
namespace BreastRadLib.CorrespondsWithFragmentLocal
{
	...
	/// </summary>
	public class CorrespondsWithContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                // BuildMemberBase.cs:110
	{                                                                                                                                          // BuildMemberBase.cs:111
	    ...
	    /// Constructor
	    /// </summary>
	    public CorrespondsWithContainer(Int32 min, Int32 max) : base("Observation.component:correspondsWith", min, max)                        // BuildMemberBase.cs:120
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:76
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:78
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:80
	                ...
	                Code = CorrespondsWith_ComponentCode()                                                                                     // BuildMemberComponents.cs:82
