...
namespace BreastRadLib.CorrespondsWithFragmentLocal
{
	...
	/// </summary>
	public class MCorrespondsWith : MContainer, ITMItem<Observation.ComponentComponent>                                                        // BuildMemberBase.cs:163
	{                                                                                                                                          // BuildMemberBase.cs:164
	    ...
	    /// Constructor
	    /// </summary>
	    public MCorrespondsWith(Int32 min, Int32 max) : base("Observation.component:correspondsWith", min, max)                                // BuildMemberBase.cs:175
