...
namespace BreastRadLib.CorrespondsWithFragmentLocal
{
	...
	{                                                                                                                                          // CSDefineObservation.cs:67
	    ...
	    /// Append item to end of list
	    /// </summary>
	    public void Append(CorrespondsWithVS.TCoding value)                                                                                    // CSDefineObservation.cs:124
	    {                                                                                                                                      // CSDefineObservation.cs:125
	        this.RawItems.Add(value);                                                                                                          // CSDefineObservation.cs:126
	    }                                                                                                                                      // CSDefineObservation.cs:127
	    ...
	    /// </summary>
	    public CorrespondsWith_Accessor(BreastRadiologyDocument doc) : base("CorrespondsWith_Accessor")                                        // CSDefineObservation.cs:77
	    {                                                                                                                                      // CSDefineObservation.cs:78
	        this.Init(doc, 0, -1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "correspondsWith"));// CSDefineObservation.cs:79
