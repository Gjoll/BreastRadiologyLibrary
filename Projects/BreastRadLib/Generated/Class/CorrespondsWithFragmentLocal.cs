...
namespace BreastRadLib.CorrespondsWithFragmentLocal
{
	...
	/// </summary>
	public class CorrespondsWith_Accessor : ObservationBase.ComponentBase<CodeableConcept>                                                     // CSDefineObservation.cs:215
	{                                                                                                                                          // CSDefineObservation.cs:216
	    ...
	    /// </summary>
	    public CorrespondsWith_Accessor(BreastRadiologyDocument doc) : base()                                                                  // CSDefineObservation.cs:231
	    {                                                                                                                                      // CSDefineObservation.cs:232
	        this.Create(doc, 1, 1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "correspondsWith"));// CSDefineObservation.cs:233
