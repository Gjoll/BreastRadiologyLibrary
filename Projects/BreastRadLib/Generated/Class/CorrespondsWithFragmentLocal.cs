...
{
	//+ LocalClassDefs
	#region Observation.component:correspondsWith Container Class                                                                              // BuildMemberBase.cs:173
	...
	/// </summary>
	public class MCorrespondsWith : MContainer, ITMItem<Observation.ComponentComponent>                                                        // BuildMemberBase.cs:178
	{                                                                                                                                          // BuildMemberBase.cs:179
	    ...
	    /// Constructor
	    /// </summary>
	    public MCorrespondsWith(Int32 min, Int32 max) : base("Observation.component:correspondsWith", min, max)                                // BuildMemberBase.cs:190
