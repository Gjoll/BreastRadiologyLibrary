...
{
	//+ LocalClassDefs
	#region Observation.component:correspondsWith Container Class                                                                              // BuildMemberBase.cs:158
	...
	/// </summary>
	public class CorrespondsWithContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                // BuildMemberBase.cs:163
	{                                                                                                                                          // BuildMemberBase.cs:164
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:81
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:64
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:66
	                ...
	                Code = CorrespondsWith_ComponentCode()                                                                                     // BuildMemberComponents.cs:68
	    ...
	    /// Constructor
	    /// </summary>
	    public CorrespondsWithContainer(Int32 min, Int32 max) : base("Observation.component:correspondsWith", min, max)                        // BuildMemberBase.cs:175
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:80
	        IEnumerable<Observation.ComponentComponent> memberComponents = base.IsMember(doc,                                                  // BuildMemberComponents.cs:81
	            ...
	            CorrespondsWith_ComponentCode());                                                                                              // BuildMemberComponents.cs:83
