...
{
	//+ LocalClassDefs
	#region Observation.component:obsSize Container Class                                                                                      // BuildMemberBase.cs:173
	// Called from BuildMemberComponents.cs, Line 202
	// BuildMemberBase.cs:175
	/// <summary>
	/// Container class for Observation.component:obsSize.
	/// </summary>
	public class MObsSize : MContainer, ITMItem<Observation.ComponentComponent>                                                                // BuildMemberBase.cs:178
	{                                                                                                                                          // BuildMemberBase.cs:179
	    #region Observation.component:obsSize Item Class                                                                                       // BuildMemberBase.cs:81
	    // Called from BuildMemberComponents.cs, Line 202
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:87
	        ...
	        {                                                                                                                                  // BuildMemberBase.cs:113
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:61
	                ...
	                Code = ObsSize_ComponentCode()                                                                                             // BuildMemberComponents.cs:63
	    ...
	    /// Constructor
	    /// </summary>
	    public MObsSize(Int32 min, Int32 max) : base("Observation.component:obsSize", min, max)                                                // BuildMemberBase.cs:190
	    ...
	    /// </summary>
	    public Quantity Append(Quantity value)                                                                                                 // BuildMemberBase.cs:333
	    ...
	    /// Append value to collection
	    /// </summary>
	    public Range Append(Range value)                                                                                                       // BuildMemberBase.cs:333
	    {                                                                                                                                      // BuildMemberBase.cs:334
	        Item item = new Item();                                                                                                            // BuildMemberBase.cs:335
	        item.Value = value;                                                                                                                // BuildMemberBase.cs:336
	        this.items.Add(item);                                                                                                              // BuildMemberBase.cs:337
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:74
	        IEnumerable<Observation.ComponentComponent> memberComponents = base.IsMember(doc,                                                  // BuildMemberComponents.cs:75
	            ...
	            ObsSize_ComponentCode());                                                                                                      // BuildMemberComponents.cs:77
