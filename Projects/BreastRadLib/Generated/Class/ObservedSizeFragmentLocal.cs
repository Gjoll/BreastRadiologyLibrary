...
{
	//+ LocalClassDefs
	#region Observation.component:obsSize Container Class                                                                                      // BuildMemberBase.cs:157
	// Called from BuildMemberComponents.cs, Line 204
	// BuildMemberBase.cs:159
	/// <summary>
	/// Container class for Observation.component:obsSize.
	/// </summary>
	public class ObsSizeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                        // BuildMemberBase.cs:162
	{                                                                                                                                          // BuildMemberBase.cs:163
	    ...
	    /// Constructor
	    /// </summary>
	    public ObsSizeContainer(Int32 min, Int32 max) : base("Observation.component:obsSize", min, max)                                        // BuildMemberBase.cs:174
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:96
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:98
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:100
	                ...
	                Code = ObsSize_ComponentCode()                                                                                             // BuildMemberComponents.cs:102
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:72
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:73
	            ...
	            this.ObsSize_ComponentCode());                                                                                                 // BuildMemberComponents.cs:75
