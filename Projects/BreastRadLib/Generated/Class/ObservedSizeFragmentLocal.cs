...
namespace BreastRadLib.ObservedSizeFragmentLocal
{
	...
	/// </summary>
	public class ObsSizeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                        // BuildMemberBase.cs:131
	{                                                                                                                                          // BuildMemberBase.cs:132
	    ...
	    /// Constructor
	    /// </summary>
	    public ObsSizeContainer(Int32 min, Int32 max) : base("Observation.component:obsSize", min, max)                                        // BuildMemberBase.cs:141
