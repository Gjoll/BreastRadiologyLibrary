...
{
	//+ LocalClassDefs
	#region Observation.component:obsSize Container Class                                                                                      // BuildMemberBase.cs:174
	// Called from BuildMemberComponents.cs, Line 202
	// BuildMemberBase.cs:176
	/// <summary>
	/// Container class for Observation.component:obsSize.
	/// </summary>
	public class MObsSize : MContainer, ITMItem<Observation.ComponentComponent>                                                                // BuildMemberBase.cs:179
	{                                                                                                                                          // BuildMemberBase.cs:180
	    ...
	    /// Constructor
	    /// </summary>
	    public MObsSize(Int32 min = 0, Int32 max = 3) : base("Observation.component:obsSize", min, max)                                        // BuildMemberBase.cs:191
