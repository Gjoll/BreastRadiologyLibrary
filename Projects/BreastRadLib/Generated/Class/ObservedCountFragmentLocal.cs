...
namespace BreastRadLib.ObservedCountFragmentLocal
{
	...
	/// </summary>
	public class ObsCountContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                       // BuildMemberBase.cs:111
	{                                                                                                                                          // BuildMemberBase.cs:112
	    ...
	    /// Get Item's Value
	    /// </summary>
	    public Element Get()                                                                                                                   // BuildMemberBase.cs:160
	    ...
	    /// Set Item's Value
	    /// </summary>
	    public void Set(Quantity value)                                                                                                        // BuildMemberBase.cs:175
	    ...
	    /// Set Item's Value
	    /// </summary>
	    public void Set(Range value)                                                                                                           // BuildMemberBase.cs:175
	    {                                                                                                                                      // BuildMemberBase.cs:176
	        this.item = new Item(value);                                                                                                       // BuildMemberBase.cs:177
	    }                                                                                                                                      // BuildMemberBase.cs:178
	    ...
	    /// Constructor
	    /// </summary>
	    public ObsCountContainer(Int32 min, Int32 max) : base("Observation.component", min, max)                                               // BuildMemberBase.cs:121
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:246
	        ...
	        {                                                                                                                                  // BuildMemberBase.cs:248
	            ...
	            Code = ObsCount_ComponentCode()                                                                                                // BuildMemberComponents.cs:62
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:268
	        ...
	        if (element.Code.IsCode(this.ObsCount_ComponentCode()))                                                                            // BuildMemberComponents.cs:52
