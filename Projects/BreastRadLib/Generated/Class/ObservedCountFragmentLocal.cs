...
namespace BreastRadLib.ObservedCountFragmentLocal
{
	...
	/// </summary>
	public class ObsCountContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                       // BuildMemberBase.cs:135
	{                                                                                                                                          // BuildMemberBase.cs:136
	    ...
	    /// Get Item's Value
	    /// </summary>
	    public Element Get()                                                                                                                   // BuildMemberBase.cs:201
	    ...
	    /// Set Item's Value
	    /// </summary>
	    public Quantity Set(Quantity value)                                                                                                    // BuildMemberBase.cs:216
	    ...
	    /// Set Item's Value
	    /// </summary>
	    public Range Set(Range value)                                                                                                          // BuildMemberBase.cs:216
	    {                                                                                                                                      // BuildMemberBase.cs:217
	        this.item = new Item(value);                                                                                                       // BuildMemberBase.cs:218
	        return value;                                                                                                                      // BuildMemberBase.cs:219
	    }                                                                                                                                      // BuildMemberBase.cs:220
	    ...
	    /// Constructor
	    /// </summary>
	    public ObsCountContainer(Int32 min, Int32 max) : base("Observation.component:obsCount", min, max)                                      // BuildMemberBase.cs:145
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:75
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:77
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:79
	                ...
	                Code = ObsCount_ComponentCode()                                                                                            // BuildMemberComponents.cs:81
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:55
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:56
	            ...
	            this.ObsCount_ComponentCode());                                                                                                // BuildMemberComponents.cs:58
