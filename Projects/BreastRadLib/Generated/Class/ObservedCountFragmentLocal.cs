...
{
	//+ LocalClassDefs
	#region Observation.component:obsCount Container Class                                                                                     // BuildMemberBase.cs:173
	// Called from BuildMemberComponents.cs, Line 202
	// BuildMemberBase.cs:175
	/// <summary>
	/// Container class for Observation.component:obsCount.
	/// </summary>
	public class MObsCount : MContainer, ITMItem<Observation.ComponentComponent>                                                               // BuildMemberBase.cs:178
	{                                                                                                                                          // BuildMemberBase.cs:179
	    ...
	    /// Get Item's Value
	    /// </summary>
	    public Element Get()                                                                                                                   // BuildMemberBase.cs:248
	    ...
	    /// Set Item's Value
	    /// </summary>
	    public Range Set(Range value)                                                                                                          // BuildMemberBase.cs:263
	    {                                                                                                                                      // BuildMemberBase.cs:264
	        Item item = new Item();                                                                                                            // BuildMemberBase.cs:265
	        item.Value = value;                                                                                                                // BuildMemberBase.cs:266
	        this.item = item;                                                                                                                  // BuildMemberBase.cs:267
	    ...
	    /// Constructor
	    /// </summary>
	    public MObsCount(Int32 min, Int32 max) : base("Observation.component:obsCount", min, max)                                              // BuildMemberBase.cs:190
