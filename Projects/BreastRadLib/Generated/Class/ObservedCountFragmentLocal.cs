...
{
	//+ LocalClassDefs
	#region Observation.component:obsCount Container Class                                                                                     // BuildMemberBase.cs:140
	// Called from BuildMemberComponents.cs, Line 179
	// BuildMemberBase.cs:142
	/// <summary>
	/// Container class for Observation.component:obsCount.
	/// </summary>
	public class ObsCountContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                       // BuildMemberBase.cs:145
	{                                                                                                                                          // BuildMemberBase.cs:146
	    ...
	    /// Get Item's Value
	    /// </summary>
	    public Element Get()                                                                                                                   // BuildMemberBase.cs:211
	    ...
	    /// Set Item's Value
	    /// </summary>
	    public Range Set(Range value)                                                                                                          // BuildMemberBase.cs:226
	    {                                                                                                                                      // BuildMemberBase.cs:227
	        this.item = new Item(value);                                                                                                       // BuildMemberBase.cs:228
	        return value;                                                                                                                      // BuildMemberBase.cs:229
	    }                                                                                                                                      // BuildMemberBase.cs:230
	    ...
	    /// Constructor
	    /// </summary>
	    public ObsCountContainer(Int32 min, Int32 max) : base("Observation.component:obsCount", min, max)                                      // BuildMemberBase.cs:155
