...
namespace BreastRadLib.ObservedCountFragmentLocal
{
	...
	/// </summary>
	public class ObsCountContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                       // BuildMemberBase.cs:110
	{                                                                                                                                          // BuildMemberBase.cs:111
	    ...
	    /// Get Item's Value
	    /// </summary>
	    public Element Get()                                                                                                                   // BuildMemberBase.cs:173
	    ...
	    /// Set Item's Value
	    /// </summary>
	    public void Set(Quantity value)                                                                                                        // BuildMemberBase.cs:188
	    ...
	    /// Set Item's Value
	    /// </summary>
	    public void Set(Range value)                                                                                                           // BuildMemberBase.cs:188
	    {                                                                                                                                      // BuildMemberBase.cs:189
	        this.item = new Item(value);                                                                                                       // BuildMemberBase.cs:190
	    }                                                                                                                                      // BuildMemberBase.cs:191
	    ...
	    /// Constructor
	    /// </summary>
	    public ObsCountContainer(Int32 min, Int32 max) : base("Observation.component:obsCount", min, max)                                      // BuildMemberBase.cs:120
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:76
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:78
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:80
	                ...
	                Code = ObsCount_ComponentCode()                                                                                            // BuildMemberComponents.cs:82
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:56
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:59
	            if (component.Code.IsCode(this.ObsCount_ComponentCode()))                                                                      // BuildMemberComponents.cs:60
