...
namespace BreastRadLib.ObservedCountFragmentLocal
{
	...
	/// </summary>
	public class ObsCountContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                       // BuildMemberBase.cs:131
	{                                                                                                                                          // BuildMemberBase.cs:132
	    ...
	    /// Get Item's Value
	    /// </summary>
	    public Element Get()                                                                                                                   // BuildMemberBase.cs:197
	    ...
	    /// Set Item's Value
	    /// </summary>
	    public Quantity Set(Quantity value)                                                                                                    // BuildMemberBase.cs:212
	    ...
	    /// Set Item's Value
	    /// </summary>
	    public Range Set(Range value)                                                                                                          // BuildMemberBase.cs:212
	    {                                                                                                                                      // BuildMemberBase.cs:213
	        this.item = new Item(value);                                                                                                       // BuildMemberBase.cs:214
	        return value;                                                                                                                      // BuildMemberBase.cs:215
	    }                                                                                                                                      // BuildMemberBase.cs:216
	    ...
	    /// Constructor
	    /// </summary>
	    public ObsCountContainer(Int32 min, Int32 max) : base("Observation.component:obsCount", min, max)                                      // BuildMemberBase.cs:141
