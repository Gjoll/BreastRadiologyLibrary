...
{
	//+ LocalClassDefs
	#region Observation.component:fibroAdenomaType Container Class                                                                             // BuildMemberBase.cs:140
	...
	/// </summary>
	public class FibroAdenomaTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                               // BuildMemberBase.cs:145
	{                                                                                                                                          // BuildMemberBase.cs:146
	    ...
	    /// Constructor
	    /// </summary>
	    public FibroAdenomaTypeContainer(Int32 min, Int32 max) : base("Observation.component:fibroAdenomaType", min, max)                      // BuildMemberBase.cs:155
