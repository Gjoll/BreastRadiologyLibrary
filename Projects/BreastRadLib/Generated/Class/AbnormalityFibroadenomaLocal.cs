...
{
	//+ LocalClassDefs
	#region Observation.component:fibroAdenomaType Container Class                                                                             // BuildMemberBase.cs:173
	...
	/// </summary>
	public class MFibroAdenomaType : MContainer, ITMItem<Observation.ComponentComponent>                                                       // BuildMemberBase.cs:178
	{                                                                                                                                          // BuildMemberBase.cs:179
	    ...
	    /// Constructor
	    /// </summary>
	    public MFibroAdenomaType(Int32 min, Int32 max) : base("Observation.component:fibroAdenomaType", min, max)                              // BuildMemberBase.cs:190
