...
namespace BreastRadLib.AbnormalityFibroadenomaLocal
{
	...
	/// </summary>
	public class FibroAdenomaTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                               // BuildMemberBase.cs:137
	{                                                                                                                                          // BuildMemberBase.cs:138
	    ...
	    /// Constructor
	    /// </summary>
	    public FibroAdenomaTypeContainer(Int32 min, Int32 max) : base("Observation.component:fibroAdenomaType", min, max)                      // BuildMemberBase.cs:147
