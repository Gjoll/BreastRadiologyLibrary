...
namespace BreastRadLib.AbnormalityFibroadenomaLocal
{
	...
	{                                                                                                                                          // CSDefineObservation.cs:43
	    ...
	    /// </summary>
	    public FibroAdenomaType_Accessor(BreastRadiologyDocument doc) : base()                                                                 // CSDefineObservation.cs:53
	    {                                                                                                                                      // CSDefineObservation.cs:54
	        this.Create(doc, 1, 1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "mgAbnormalityFibroAdenomaType"));// CSDefineObservation.cs:55
