...
{
	//+ LocalClassDefs
	#region Observation.component:fibroAdenomaType Container Class                                                                             // BuildMemberBase.cs:174
	...
	/// </summary>
	public class MFibroAdenomaType : MContainer, ITMItem<Observation.ComponentComponent>                                                       // BuildMemberBase.cs:179
	{                                                                                                                                          // BuildMemberBase.cs:180
	    #region Observation.component:fibroAdenomaType Item Class                                                                              // BuildMemberBase.cs:81
	    // Called from BuildMemberComponents.cs, Line 202
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:87
	        ...
	        {                                                                                                                                  // BuildMemberBase.cs:113
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:61
	                ...
	                Code = FibroAdenomaType_ComponentCode()                                                                                    // BuildMemberComponents.cs:63
	    ...
	    /// Constructor
	    /// </summary>
	    public MFibroAdenomaType(Int32 min = 0, Int32 max = 1) : base("Observation.component:fibroAdenomaType", min, max)                      // BuildMemberBase.cs:191
	    {                                                                                                                                      // BuildMemberBase.cs:192
	    }                                                                                                                                      // BuildMemberBase.cs:194
	                                                                                                                                           // BuildMemberBase.cs:196
	    // Methods                                                                                                                             // BuildMemberBase.cs:197
	    private static CodeableConcept FibroAdenomaType_ComponentCode()                                                                        // FhirConstruct.cs:759
	    {                                                                                                                                      // FhirConstruct.cs:760
	        ...
	        {                                                                                                                                  // FhirConstruct.cs:770
	            ...
	            temp4.CodeElement.Value = "mgAbnormalityFibroAdenomaType";                                                                     // FhirConstruct.cs:792
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:74
	        IEnumerable<Observation.ComponentComponent> memberComponents = base.IsMember(doc,                                                  // BuildMemberComponents.cs:75
	            ...
	            FibroAdenomaType_ComponentCode());                                                                                             // BuildMemberComponents.cs:77
