...
namespace BreastRadLib
{
	public class MRIFinding : ObservationBase, IObservationSectionFragment
	{
		...
		public void Create(BreastRadiologyDocument doc, Observation resource)
		{
			...
			SetProfileUrl("http://hl7.org/fhir/us/breast-radiology/StructureDefinition/MRIFinding");                                                 // CSDefineBase.cs:206
			...
			SetProfileUrl("http://hl7.org/fhir/us/breast-radiology/StructureDefinition/ObservationSectionFragment");                                 // CSDefineBase.cs:206
			//- Constructor
		}
		...
		{                                                                                                                                         // FhirConstruct.cs:754
		    ...
		    {                                                                                                                                     // FhirConstruct.cs:764
		        ...
		        temp4.CodeElement.Value = "mriFindingObservation";                                                                                // FhirConstruct.cs:786
		        temp4.DisplayElement = new FhirString();                                                                                          // FhirConstruct.cs:792
		        temp4.DisplayElement.Value = "MRI Finding observation";                                                                           // FhirConstruct.cs:794
		        retVal.Coding.Add(temp4);                                                                                                         // FhirConstruct.cs:813
		    }                                                                                                                                     // FhirConstruct.cs:814
		    retVal.TextElement = new FhirString();                                                                                                // FhirConstruct.cs:819
		    retVal.TextElement.Value = "MRI Finding observation";                                                                                 // FhirConstruct.cs:821
