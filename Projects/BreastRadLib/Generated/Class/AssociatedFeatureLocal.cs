...
{
	//+ LocalClassDefs
	#region Observation.component:featureType Container Class                                                                                  // BuildMemberBase.cs:174
	// Called from BuildMemberComponents.cs, Line 202
	// BuildMemberBase.cs:176
	/// <summary>
	/// Container class for Observation.component:featureType.
	/// </summary>
	public class MFeatureType : MContainer, ITMItem<Observation.ComponentComponent>                                                            // BuildMemberBase.cs:179
	{                                                                                                                                          // BuildMemberBase.cs:180
	    #region Observation.component:featureType Item Class                                                                                   // BuildMemberBase.cs:81
	    // Called from BuildMemberComponents.cs, Line 202
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:87
	        ...
	        {                                                                                                                                  // BuildMemberBase.cs:113
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:61
	                ...
	                Code = FeatureType_ComponentCode()                                                                                         // BuildMemberComponents.cs:63
	    ...
	    /// Constructor
	    /// </summary>
	    public MFeatureType(Int32 min = 1, Int32 max = 1) : base("Observation.component:featureType", min, max)                                // BuildMemberBase.cs:191
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:74
	        IEnumerable<Observation.ComponentComponent> memberComponents = base.IsMember(doc,                                                  // BuildMemberComponents.cs:75
	            ...
	            FeatureType_ComponentCode());                                                                                                  // BuildMemberComponents.cs:77
