...
{
	//+ LocalClassDefs
	#region Observation.component:featureType Container Class                                                                                  // BuildMemberBase.cs:140
	// Called from BuildMemberComponents.cs, Line 179
	// BuildMemberBase.cs:142
	/// <summary>
	/// Container class for Observation.component:featureType.
	/// </summary>
	public class FeatureTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                    // BuildMemberBase.cs:145
	{                                                                                                                                          // BuildMemberBase.cs:146
	    ...
	    /// Constructor
	    /// </summary>
	    public FeatureTypeContainer(Int32 min, Int32 max) : base("Observation.component:featureType", min, max)                                // BuildMemberBase.cs:155
