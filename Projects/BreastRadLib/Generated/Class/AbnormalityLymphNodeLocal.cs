...
namespace BreastRadLib.AbnormalityLymphNodeLocal
{
	...
	/// </summary>
	public class LymphNodeTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                  // BuildMemberBase.cs:111
	{                                                                                                                                          // BuildMemberBase.cs:112
	    ...
	    /// Constructor
	    /// </summary>
	    public LymphNodeTypeContainer(Int32 min, Int32 max) : base("Observation.component", min, max)                                          // BuildMemberBase.cs:121
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:246
	        ...
	        {                                                                                                                                  // BuildMemberBase.cs:248
	            ...
	            Code = LymphNodeType_ComponentCode()                                                                                           // BuildMemberComponents.cs:62
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:268
	        ...
	        if (element.Code.IsCode(this.LymphNodeType_ComponentCode()))                                                                       // BuildMemberComponents.cs:52
