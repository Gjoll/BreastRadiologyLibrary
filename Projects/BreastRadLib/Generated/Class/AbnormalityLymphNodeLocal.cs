...
namespace BreastRadLib.AbnormalityLymphNodeLocal
{
	...
	/// </summary>
	public class LymphNodeTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                  // BuildMemberBase.cs:110
	{                                                                                                                                          // BuildMemberBase.cs:111
	    ...
	    /// Constructor
	    /// </summary>
	    public LymphNodeTypeContainer(Int32 min, Int32 max) : base("Observation.component:lymphNodeType", min, max)                            // BuildMemberBase.cs:120
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:76
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:78
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:80
	                ...
	                Code = LymphNodeType_ComponentCode()                                                                                       // BuildMemberComponents.cs:82
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:56
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:59
	            if (component.Code.IsCode(this.LymphNodeType_ComponentCode()))                                                                 // BuildMemberComponents.cs:60
