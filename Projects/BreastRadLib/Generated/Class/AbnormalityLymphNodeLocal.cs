...
namespace BreastRadLib.AbnormalityLymphNodeLocal
{
	...
	/// </summary>
	public class LymphNodeTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                  // BuildMemberBase.cs:131
	{                                                                                                                                          // BuildMemberBase.cs:132
	    ...
	    /// Constructor
	    /// </summary>
	    public LymphNodeTypeContainer(Int32 min, Int32 max) : base("Observation.component:lymphNodeType", min, max)                            // BuildMemberBase.cs:141
