...
{
	//+ LocalClassDefs
	#region Observation.component:lymphNodeType Container Class                                                                                // BuildMemberBase.cs:140
	...
	/// </summary>
	public class LymphNodeTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                  // BuildMemberBase.cs:145
	{                                                                                                                                          // BuildMemberBase.cs:146
	    ...
	    /// Constructor
	    /// </summary>
	    public LymphNodeTypeContainer(Int32 min, Int32 max) : base("Observation.component:lymphNodeType", min, max)                            // BuildMemberBase.cs:155
