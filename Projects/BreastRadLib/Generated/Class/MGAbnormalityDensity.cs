...
namespace BreastRadLib
{
	...
	public class MGAbnormalityDensity : ObservationBase, IMGAbnormalityDensity
	{
		...
		/// </summary>
		public DensityTypeContainer DensityType { get ; protected set; }                                                                          // BuildMemberBase.cs:355
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			// Called from BuildMemberComponents.cs, Line 179
			this.DensityType = new DensityTypeContainer(1, 1);                                                                                       // BuildMemberBase.cs:334
			//- Constructor
		}
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:113
			    ...
			    this.DensityType.Read(this.Doc, items);                                                                                              // BuildMemberComponents.cs:63
			    //- ReadComponents
			...
			{                                                                                                                                        // BuildMemberComponents.cs:123
			    ...
			    items.AddRange(this.DensityType.Write(this.Doc));                                                                                    // BuildMemberComponents.cs:85
			    //- WriteComponents
