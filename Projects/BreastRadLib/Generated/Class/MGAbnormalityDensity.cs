...
namespace BreastRadLib
{
	...
	public class MGAbnormalityDensity : ObservationBase, IMGAbnormalityDensity
	{
		...
		public override void Write()
		{
			...
			this.DensityType.WriteItemComponent(this.Doc, this.Resource);                                                                            // BuildElementItemComponent.cs:77
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.DensityType.ReadItemComponent(this.Doc, this.Resource);                                                                             // BuildElementItemComponent.cs:80
			//- ReadCode
		}
