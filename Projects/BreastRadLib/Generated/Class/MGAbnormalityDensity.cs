...
namespace BreastRadLib
{
	public class MGAbnormalityDensity : ObservationBase, IObservationLeafFragment, IBreastRadObservationNoDeviceFragment, IBreastRadObservationNoComponentFragment, IBreastRadObservationNoValueFragment, ICommonComponentsFragment, IShapeComponentsFragment, INotPreviouslySeenComponentFragment, IObservedCountFragment, IObservedSizeFragment, IObservedDistributionFragment, ICorrespondsWithFragment, IPreviouslyDemonstratedByFragment, IAssociatedFeaturesHasMemberFragment, IConsistentWithHasMemberFragment
	{
		...
		public DensityType_Accessor DensityType { get ; protected set; }                                                                          // CSBuildMemberListBase.cs:33
		//- Fields
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			SetProfileUrl("http://hl7.org/fhir/us/breast-radiology/StructureDefinition/MGAbnormalityDensity");                                       // CSDefineBase.cs:191
			...
			this.DensityType = new DensityType_Accessor(doc);                                                                                        // CSBuildMemberListBase.cs:36
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			if (this.DensityType.Validate(sb) == false) retVal = false;                                                                              // CSBuildMemberListBase.cs:45
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.WriteComponent(this.DensityType);                                                                                                   // CSBuildMemberListBase.cs:39
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.ReadComponent(this.DensityType);                                                                                                    // CSBuildMemberListBase.cs:42
			//- ReadCode
		}
