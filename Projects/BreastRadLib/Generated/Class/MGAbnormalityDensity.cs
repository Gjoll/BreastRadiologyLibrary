...
namespace BreastRadLib
{
	...
	public class MGAbnormalityDensity : ObservationBase, IMGAbnormalityDensity
	{
		...
		/// </summary>
		public MDensityType DensityType { get ; protected set; }                                                                                  // BuildMemberBase.cs:396
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			// Called from BuildMemberComponents.cs, Line 202
			this.DensityType = new MDensityType(1, 1);                                                                                               // BuildMemberBase.cs:375
			//- Constructor
		}
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:136
			    ...
			    this.DensityType.Read(this.Doc, items);                                                                                              // BuildMemberComponents.cs:90
			    //- ReadComponents
			...
			{                                                                                                                                        // BuildMemberComponents.cs:146
			    ...
			    items.AddRange(this.DensityType.Write(this.Doc));                                                                                    // BuildMemberComponents.cs:108
			    //- WriteComponents
