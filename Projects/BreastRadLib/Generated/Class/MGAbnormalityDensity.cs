...
namespace BreastRadLib
{
	...
	public class MGAbnormalityDensity : ObservationBase, IMGAbnormalityDensity
	{
		...
		/// </summary>
		public DensityType_Accessor DensityType { get ; protected set; }                                                                          // BuildMemberListBase.cs:70
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			SetProfileUrl("http://hl7.org/fhir/us/breast-radiology/StructureDefinition/MGAbnormalityDensity");                                       // DefineBase.cs:215
			...
			this.DensityType = new DensityType_Accessor(doc);                                                                                        // BuildMemberListBase.cs:73
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			if (this.DensityType.Validate(sb) == false) retVal = false;                                                                              // BuildMemberListBase.cs:82
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.WriteComponent(this.DensityType);                                                                                                   // BuildMemberListBase.cs:76
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.ReadComponent(this.DensityType);                                                                                                    // BuildMemberListBase.cs:79
			//- ReadCode
		}
