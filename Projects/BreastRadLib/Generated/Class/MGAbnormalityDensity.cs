...
namespace BreastRadLib
{
	...
	public class MGAbnormalityDensity : ObservationBase, IMGAbnormalityDensity
	{
		...
		/// </summary>
		public DensityTypeContainer DensityType { get ; protected set; }                                                                          // BuildMemberBase.cs:303
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.DensityType = new DensityTypeContainer(1, 1);                                                                                       // BuildMemberBase.cs:287
			//- Constructor
		}
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:118
			    ...
			    this.DensityType.Read(this.Doc, items);                                                                                              // BuildMemberComponents.cs:68
			    //- ReadComponents
			...
			{                                                                                                                                        // BuildMemberComponents.cs:128
			    ...
			    items.AddRange(this.DensityType.Write(this.Doc));                                                                                    // BuildMemberComponents.cs:90
			    //- WriteComponents
