...
namespace BreastRadLib
{
	...
	public class MGAbnormalityDensity : ObservationBase, IMGAbnormalityDensity
	{
		...
		/// </summary>
		public DensityType_Accessor DensityType { get ; protected set; }                                                                          // BuildMemberListBase.cs:71
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.DensityType = new DensityType_Accessor(doc);                                                                                        // BuildMemberListBase.cs:74
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			if (this.DensityType.Validate(sb) == false) retVal = false;                                                                              // BuildMemberListBase.cs:83
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.WriteComponent(this.DensityType);                                                                                                   // BuildMemberListBase.cs:77
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.ReadComponent(this.DensityType);                                                                                                    // BuildMemberListBase.cs:80
			//- ReadCode
		}
