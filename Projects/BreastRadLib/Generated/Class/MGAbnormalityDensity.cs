...
namespace BreastRadLib
{
	...
	public class MGAbnormalityDensity : ObservationBase, IMGAbnormalityDensity
	{
		...
		/// Access DensityType
		/// </summary>
		public TItemComponentSingle<CodeableConcept> DensityType { get ; protected set; }                                                         // BuildElementItemComponent.cs:72
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.DensityType = new TItemComponentSingle<CodeableConcept>("Observation.component:densityType", 1, 1, FixedValue_ObservationComponentDensityTypeCode());// BuildElementItemComponent.cs:57
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			if (this.DensityType.Validate(sb) == false) retVal = false;                                                                              // BuildElementItemComponent.cs:81
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.DensityType.Write(this.Doc, this.Resource);                                                                                         // BuildElementItemComponent.cs:75
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.DensityType.Read(this.Doc, this.Resource);                                                                                          // BuildElementItemComponent.cs:78
			//- ReadCode
		}
