...
namespace BreastRadLib
{
	...
	public class MGAbnormalityDensity : ObservationBase, IMGAbnormalityDensity
	{
		...
		/// </summary>
		public DensityType_Accessor DensityType { get ; protected set; }                                                                          // BuildMemberListBase.cs:69
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			SetProfileUrl("http://hl7.org/fhir/us/breast-radiology/StructureDefinition/MGAbnormalityDensity");                                       // DefineBase.cs:225
			/// <summary>
			/// Constructor
			/// </summary>
			...
			/// Constructor
			/// </summary>
			this.DensityType = new DensityType_Accessor(doc);                                                                                        // BuildMemberListBase.cs:75
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			if (this.DensityType.Validate(sb) == false) retVal = false;                                                                              // BuildMemberListBase.cs:84
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.WriteComponent(this.DensityType);                                                                                                   // BuildMemberListBase.cs:78
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.ReadComponent(this.DensityType);                                                                                                    // BuildMemberListBase.cs:81
			//- ReadCode
		}
