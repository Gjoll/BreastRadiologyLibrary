...
namespace BreastRadLib
{
	...
	public class MGAbnormalityDensity : ObservationBase, IMGAbnormalityDensity
	{
		...
		/// </summary>
		public DensityTypeContainer DensityType { get ; protected set; }                                                                          // BuildMemberBase.cs:336
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.DensityType = new DensityTypeContainer(1, 1);                                                                                       // BuildMemberBase.cs:320
			//- Constructor
		}
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:117
			    ...
			    this.DensityType.Read(this.Doc, items);                                                                                              // BuildMemberComponents.cs:67
			    //- ReadComponents
			...
			{                                                                                                                                        // BuildMemberComponents.cs:127
			    ...
			    items.AddRange(this.DensityType.Write(this.Doc));                                                                                    // BuildMemberComponents.cs:89
			    //- WriteComponents
