...
namespace BreastRadLib
{
	...
	public class MGAbnormalityDensity : ObservationBase, IMGAbnormalityDensity
	{
		...
		/// Access DensityType
		/// </summary>
		public TItemComponentSingle<CodeableConcept> DensityType { get ; protected set; }                                                   // BuildItemComponent.cs:74
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.DensityType = new TItemComponentSingle<CodeableConcept>("DensityType", 1, 1, FixedValue_ObservationComponentDensityTypeCode());// BuildItemComponent.cs:59
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			if (this.DensityType.Validate(sb) == false) retVal = false;                                                                              // BuildItemComponent.cs:83
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.WriteComponent(this.DensityType);                                                                                                   // BuildItemComponent.cs:77
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.ReadComponent(this.DensityType);                                                                                                    // BuildItemComponent.cs:80
			//- ReadCode
		}
