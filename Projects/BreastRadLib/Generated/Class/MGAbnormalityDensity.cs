...
namespace BreastRadLib
{
	...
	public class MGAbnormalityDensity : ObservationBase, IMGAbnormalityDensity
	{
		...
		/// Access DensityType
		/// </summary>
		public TElementItemComponentSingle<CodeableConcept> DensityType { get ; protected set; }                                                   // BuildElementItemComponent.cs:74
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.DensityType = new TElementItemComponentSingle<CodeableConcept>("DensityType", 1, 1, FixedValue_ObservationComponentDensityTypeCode());// BuildElementItemComponent.cs:59
			//- Constructor
		}
