...
namespace BreastRadLib.ObservedChangesFragmentLocal
{
	...
	/// </summary>
	public class ObsChanges_Accessor : ObservationLocal.ComponentBase<CodeableConcept>                                                         // CSDefineObservation.cs:66
	{                                                                                                                                          // CSDefineObservation.cs:67
	    ...
	    /// </summary>
	    public void Append(ObservedChangesVS.TCoding value)                                                                                    // CSDefineObservation.cs:124
	    ...
	    /// </summary>
	    public ObsChanges_Accessor(BreastRadiologyDocument doc) : base("ObsChanges_Accessor")                                                  // CSDefineObservation.cs:77
	    {                                                                                                                                      // CSDefineObservation.cs:78
	        this.Init(doc, 0, -1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "obsChanges"));// CSDefineObservation.cs:79
