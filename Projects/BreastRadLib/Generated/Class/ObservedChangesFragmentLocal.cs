...
namespace BreastRadLib.ObservedChangesFragmentLocal
{
	...
	/// </summary>
	public class ObsChangesContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                     // BuildMemberBase.cs:137
	{                                                                                                                                          // BuildMemberBase.cs:138
	    ...
	    /// Constructor
	    /// </summary>
	    public ObsChangesContainer(Int32 min, Int32 max) : base("Observation.component:obsChanges", min, max)                                  // BuildMemberBase.cs:147
