...
namespace BreastRadLib.ObservedChangesFragmentLocal
{
	...
	/// </summary>
	public class ObsChangesContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                     // BuildMemberBase.cs:131
	{                                                                                                                                          // BuildMemberBase.cs:132
	    ...
	    /// Constructor
	    /// </summary>
	    public ObsChangesContainer(Int32 min, Int32 max) : base("Observation.component:obsChanges", min, max)                                  // BuildMemberBase.cs:141
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:75
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:77
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:79
	                ...
	                Code = ObsChanges_ComponentCode()                                                                                          // BuildMemberComponents.cs:81
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:55
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:56
	            ...
	            this.ObsChanges_ComponentCode());                                                                                              // BuildMemberComponents.cs:58
