...
namespace BreastRadLib.ObservedChangesFragmentLocal
{
	...
	/// </summary>
	public class ObsChanges_Accessor : MemberListCodedValueBase<CodeableConcept>                                                               // CSBuildMemberListCodedValue.cs:65
	{                                                                                                                                          // CSBuildMemberListCodedValue.cs:66
	    ...
	    /// </summary>
	    public void Append(ObservedChangesVS.TCoding value)                                                                                    // CSBuildMemberListCodedValue.cs:123
	    ...
	    /// </summary>
	    public ObsChanges_Accessor(BreastRadiologyDocument doc) : base("ObsChanges_Accessor")                                                  // CSBuildMemberListCodedValue.cs:76
	    {                                                                                                                                      // CSBuildMemberListCodedValue.cs:77
	        this.Init(doc, 0, -1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "obsChanges"));// CSBuildMemberListCodedValue.cs:78
