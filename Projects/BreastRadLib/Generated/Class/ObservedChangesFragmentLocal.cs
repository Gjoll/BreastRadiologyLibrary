...
namespace BreastRadLib.ObservedChangesFragmentLocal
{
	...
	{                                                                                                                                          // BuildMemberListCodedValue.cs:73
	    ...
	    /// </summary>
	    public void Append(ObservedChangesVS.TCoding value)                                                                                    // BuildMemberListCodedValue.cs:130
	    ...
	    /// </summary>
	    public ObsChanges_Accessor(BreastRadiologyDocument doc) : base("ObsChanges_Accessor")                                                  // BuildMemberListCodedValue.cs:83
	    {                                                                                                                                      // BuildMemberListCodedValue.cs:84
	        this.Init(doc, 0, -1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "obsChanges"));// BuildMemberListCodedValue.cs:85
