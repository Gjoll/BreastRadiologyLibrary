...
namespace BreastRadLib.MGAbnormalityDensityLocal
{
	...
	/// </summary>
	public class DensityType_Accessor : ObservationLocal.ComponentBase<CodeableConcept>                                                        // CSDefineObservation.cs:64
	{                                                                                                                                          // CSDefineObservation.cs:65
	    ...
	    /// </summary>
	    public DensityType_Accessor(BreastRadiologyDocument doc) : base()                                                                      // CSDefineObservation.cs:75
	    {                                                                                                                                      // CSDefineObservation.cs:76
	        this.Init(doc, 1, 1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "mgAbnormalityDensityType"));// CSDefineObservation.cs:77
