...
namespace BreastRadLib.MGAbnormalityDensityLocal
{
	...
	/// </summary>
	public class DensityType_Accessor : MemberListCodedValueBase<CodeableConcept>                                                              // CSBuildMemberListCodedValue.cs:69
	{                                                                                                                                          // CSBuildMemberListCodedValue.cs:70
	    ...
	    /// </summary>
	    public void Set(MGAbnormalityDensityTypeVS.TCoding value) => this.SetFirst(value);                                                     // CSBuildMemberListCodedValue.cs:99
	                                                                                                                                           // CSBuildMemberListCodedValue.cs:76
	    /// <summary>
	    /// Accessor class constructor
	    /// </summary>
	    public DensityType_Accessor(BreastRadiologyDocument doc) : base("DensityType_Accessor")                                                // CSBuildMemberListCodedValue.cs:80
	    {                                                                                                                                      // CSBuildMemberListCodedValue.cs:81
	        this.Init(doc, 1, 1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "mgAbnormalityDensityType"));// CSBuildMemberListCodedValue.cs:82
