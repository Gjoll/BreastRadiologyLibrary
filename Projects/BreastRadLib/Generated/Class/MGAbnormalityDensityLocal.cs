...
namespace BreastRadLib.MGAbnormalityDensityLocal
{
	...
	/// </summary>
	public class DensityTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                    // BuildMemberBase.cs:131
	{                                                                                                                                          // BuildMemberBase.cs:132
	    ...
	    /// Constructor
	    /// </summary>
	    public DensityTypeContainer(Int32 min, Int32 max) : base("Observation.component:densityType", min, max)                                // BuildMemberBase.cs:141
