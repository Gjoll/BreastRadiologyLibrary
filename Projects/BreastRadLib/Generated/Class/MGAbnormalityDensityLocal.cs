...
{
	//+ LocalClassDefs
	#region Observation.component:densityType Container Class                                                                                  // BuildMemberBase.cs:137
	/// <summary>
	/// Container class for Observation.component:densityType.
	/// </summary>
	public class DensityTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                    // BuildMemberBase.cs:141
	{                                                                                                                                          // BuildMemberBase.cs:142
	    #region Observation.component:densityType Item Class                                                                                   // BuildMemberBase.cs:73
	    /// <summary>
	    ...
	    /// Constructor
	    /// </summary>
	    public DensityTypeContainer(Int32 min, Int32 max) : base("Observation.component:densityType", min, max)                                // BuildMemberBase.cs:151
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:71
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:73
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:75
	                ...
	                Code = DensityType_ComponentCode()                                                                                         // BuildMemberComponents.cs:77
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:51
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:52
	            ...
	            this.DensityType_ComponentCode());                                                                                             // BuildMemberComponents.cs:54
