...
{
	//+ LocalClassDefs
	#region Observation.component:densityType Container Class                                                                                  // BuildMemberBase.cs:174
	// Called from BuildMemberComponents.cs, Line 202
	// BuildMemberBase.cs:176
	/// <summary>
	/// Container class for Observation.component:densityType.
	/// </summary>
	public class MDensityType : MContainer, ITMItem<Observation.ComponentComponent>                                                            // BuildMemberBase.cs:179
	{                                                                                                                                          // BuildMemberBase.cs:180
	    #region Observation.component:densityType Item Class                                                                                   // BuildMemberBase.cs:81
	    // Called from BuildMemberComponents.cs, Line 202
	    ...
	    /// Constructor
	    /// </summary>
	    public MDensityType(Int32 min = 1, Int32 max = 1) : base("Observation.component:densityType", min, max)                                // BuildMemberBase.cs:191
