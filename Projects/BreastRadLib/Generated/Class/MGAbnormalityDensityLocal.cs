...
namespace BreastRadLib.MGAbnormalityDensityLocal
{
	...
	/// </summary>
	public class DensityType_Accessor : MemberListCodedValue<CodeableConcept>                                                                  // BuildMemberListCodedValue.cs:51
	{                                                                                                                                          // BuildMemberListCodedValue.cs:52
	    ...
	    /// </summary>
	    public void Set(MGAbnormalityDensityTypeVS.TCoding value) => this.SetFirst(value);                                                     // BuildMemberListCodedValue.cs:81
	                                                                                                                                           // BuildMemberListCodedValue.cs:58
	    /// <summary>
	    /// Accessor class constructor
	    /// </summary>
	    public DensityType_Accessor(BreastRadiologyDocument doc) : base("DensityType_Accessor")                                                // BuildMemberListCodedValue.cs:62
	    {                                                                                                                                      // BuildMemberListCodedValue.cs:63
	        this.Init(doc, 1, 1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "mgAbnormalityDensityType"));// BuildMemberListCodedValue.cs:64
