...
namespace BreastRadLib.AbnormalityMassLocal
{
	...
	{                                                                                                                                          // BuildMemberBase.cs:163
	    ...
	    public CodeableConcept MassType_ComponentCode()                                                                                        // FhirConstruct.cs:753
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:98
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:100
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:102
	                ...
	                Code = MassType_ComponentCode()                                                                                            // BuildMemberComponents.cs:104
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:74
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:75
	            ...
	            this.MassType_ComponentCode());                                                                                                // BuildMemberComponents.cs:77
