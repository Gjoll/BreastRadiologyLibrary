...
namespace BreastRadLib.AbnormalityMassLocal
{
	...
	/// </summary>
	public class MassTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                       // BuildMemberBase.cs:135
	{                                                                                                                                          // BuildMemberBase.cs:136
	    ...
	    /// Constructor
	    /// </summary>
	    public MassTypeContainer(Int32 min, Int32 max) : base("Observation.component:massType", min, max)                                      // BuildMemberBase.cs:145
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:75
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:77
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:79
	                ...
	                Code = MassType_ComponentCode()                                                                                            // BuildMemberComponents.cs:81
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:55
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:56
	            ...
	            this.MassType_ComponentCode());                                                                                                // BuildMemberComponents.cs:58
