...
namespace BreastRadLib.AbnormalityMassLocal
{
	...
	/// </summary>
	public class MassTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                       // BuildMemberBase.cs:131
	{                                                                                                                                          // BuildMemberBase.cs:132
	    ...
	    /// Constructor
	    /// </summary>
	    public MassTypeContainer(Int32 min, Int32 max) : base("Observation.component:massType", min, max)                                      // BuildMemberBase.cs:141
