...
{
	//+ LocalClassDefs
	#region Observation.component:massType Container Class                                                                                     // BuildMemberBase.cs:137
	/// <summary>
	/// Container class for Observation.component:massType.
	/// </summary>
	public class MassTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                       // BuildMemberBase.cs:141
	{                                                                                                                                          // BuildMemberBase.cs:142
	    #region Observation.component:massType Item Class                                                                                      // BuildMemberBase.cs:73
	    /// <summary>
	    ...
	    /// Constructor
	    /// </summary>
	    public MassTypeContainer(Int32 min, Int32 max) : base("Observation.component:massType", min, max)                                      // BuildMemberBase.cs:151
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:71
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:73
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:75
	                ...
	                Code = MassType_ComponentCode()                                                                                            // BuildMemberComponents.cs:77
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:51
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:52
	            ...
	            this.MassType_ComponentCode());                                                                                                // BuildMemberComponents.cs:54
