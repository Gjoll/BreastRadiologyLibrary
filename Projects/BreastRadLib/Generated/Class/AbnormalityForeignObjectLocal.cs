...
namespace BreastRadLib.AbnormalityForeignObjectLocal
{
	...
	/// </summary>
	public class AbnormalityForeignObjectTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                   // BuildMemberBase.cs:69
	{                                                                                                                                          // BuildMemberBase.cs:70
	    ...
	    /// Constructor
	    /// </summary>
	    public AbnormalityForeignObjectTypeContainer(Int32 min, Int32 max) : base("Observation.component", min, max)                           // BuildMemberBase.cs:79
