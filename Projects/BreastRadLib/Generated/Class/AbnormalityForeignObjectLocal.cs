...
{
	//+ LocalClassDefs
	#region Observation.component:abnormalityForeignObjectType Container Class                                                                 // BuildMemberBase.cs:137
	/// <summary>
	/// Container class for Observation.component:abnormalityForeignObjectType.
	/// </summary>
	public class AbnormalityForeignObjectTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                   // BuildMemberBase.cs:141
	{                                                                                                                                          // BuildMemberBase.cs:142
	    #region Observation.component:abnormalityForeignObjectType Item Class                                                                  // BuildMemberBase.cs:73
	    /// <summary>
	    ...
	    /// Constructor
	    /// </summary>
	    public AbnormalityForeignObjectTypeContainer(Int32 min, Int32 max) : base("Observation.component:abnormalityForeignObjectType", min, max)// BuildMemberBase.cs:151
	    {                                                                                                                                      // BuildMemberBase.cs:152
	    }                                                                                                                                      // BuildMemberBase.cs:154
	                                                                                                                                           // BuildMemberBase.cs:155
	    // Methods                                                                                                                             // BuildMemberBase.cs:156
	    public CodeableConcept AbnormalityForeignObjectType_ComponentCode()                                                                    // FhirConstruct.cs:753
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:71
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:73
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:75
	                ...
	                Code = AbnormalityForeignObjectType_ComponentCode()                                                                        // BuildMemberComponents.cs:77
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:51
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:52
	            ...
	            this.AbnormalityForeignObjectType_ComponentCode());                                                                            // BuildMemberComponents.cs:54
