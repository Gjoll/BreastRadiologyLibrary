...
namespace BreastRadLib.AbnormalityForeignObjectLocal
{
	...
	/// </summary>
	public class AbnormalityForeignObjectTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                   // BuildMemberBase.cs:135
	{                                                                                                                                          // BuildMemberBase.cs:136
	    ...
	    /// Constructor
	    /// </summary>
	    public AbnormalityForeignObjectTypeContainer(Int32 min, Int32 max) : base("Observation.component:abnormalityForeignObjectType", min, max)// BuildMemberBase.cs:145
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:75
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:77
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:79
	                ...
	                Code = AbnormalityForeignObjectType_ComponentCode()                                                                        // BuildMemberComponents.cs:81
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:55
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:56
	            ...
	            this.AbnormalityForeignObjectType_ComponentCode());                                                                            // BuildMemberComponents.cs:58
