...
namespace BreastRadLib.AbnormalityForeignObjectLocal
{
	...
	/// </summary>
	public class AbnormalityForeignObjectTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                   // BuildMemberBase.cs:131
	{                                                                                                                                          // BuildMemberBase.cs:132
	    ...
	    /// Constructor
	    /// </summary>
	    public AbnormalityForeignObjectTypeContainer(Int32 min, Int32 max) : base("Observation.component:abnormalityForeignObjectType", min, max)// BuildMemberBase.cs:141
