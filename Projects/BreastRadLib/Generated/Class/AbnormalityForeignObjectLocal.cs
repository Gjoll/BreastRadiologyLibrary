...
{
	//+ LocalClassDefs
	#region Observation.component:abnormalityForeignObjectType Container Class                                                                 // BuildMemberBase.cs:157
	...
	/// </summary>
	public class AbnormalityForeignObjectTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                   // BuildMemberBase.cs:162
	{                                                                                                                                          // BuildMemberBase.cs:163
	    ...
	    /// Constructor
	    /// </summary>
	    public AbnormalityForeignObjectTypeContainer(Int32 min, Int32 max) : base("Observation.component:abnormalityForeignObjectType", min, max)// BuildMemberBase.cs:174
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:96
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:98
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:100
	                ...
	                Code = AbnormalityForeignObjectType_ComponentCode()                                                                        // BuildMemberComponents.cs:102
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:72
	        IEnumerable<Element> elements = base.IsMember(doc,                                                                                 // BuildMemberComponents.cs:73
	            ...
	            this.AbnormalityForeignObjectType_ComponentCode());                                                                            // BuildMemberComponents.cs:75
