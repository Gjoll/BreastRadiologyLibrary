...
namespace BreastRadLib.AbnormalityForeignObjectLocal
{
	...
	/// </summary>
	public class AbnormalityForeignObjectType_Accessor : ObservationLocal.ComponentBase<CodeableConcept>                                       // CSDefineObservation.cs:42
	{                                                                                                                                          // CSDefineObservation.cs:43
	    ...
	    {                                                                                                                                      // CSDefineObservation.cs:54
	        this.Init(doc, 1, 1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "abnormalityForeignObjectType"));// CSDefineObservation.cs:55
