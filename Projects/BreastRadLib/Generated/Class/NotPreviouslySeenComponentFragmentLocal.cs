...
{
	//+ LocalClassDefs
	#region Observation.component:notPreviouslySeen Container Class                                                                            // BuildMemberBase.cs:140
	...
	/// </summary>
	public class NotPreviouslySeenContainer : MContainer, ITMItem<Observation.ComponentComponent>                                              // BuildMemberBase.cs:145
	{                                                                                                                                          // BuildMemberBase.cs:146
	    ...
	    /// Constructor
	    /// </summary>
	    public NotPreviouslySeenContainer(Int32 min, Int32 max) : base("Observation.component:notPreviouslySeen", min, max)                    // BuildMemberBase.cs:155
