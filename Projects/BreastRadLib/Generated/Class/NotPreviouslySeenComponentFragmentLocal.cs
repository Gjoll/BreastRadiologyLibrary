...
namespace BreastRadLib.NotPreviouslySeenComponentFragmentLocal
{
	...
	/// </summary>
	public class NotPreviouslySeen_Accessor : MemberListCodedValueBase<CodeableConcept>                                                        // CSBuildMemberListCodedValue.cs:64
	{                                                                                                                                          // CSBuildMemberListCodedValue.cs:65
	    ...
	    /// </summary>
	    public void Append(NotPreviouslySeenVS.TCoding value)                                                                                  // CSBuildMemberListCodedValue.cs:122
	    ...
	    /// </summary>
	    public NotPreviouslySeen_Accessor(BreastRadiologyDocument doc) : base("NotPreviouslySeen_Accessor")                                    // CSBuildMemberListCodedValue.cs:75
	    {                                                                                                                                      // CSBuildMemberListCodedValue.cs:76
	        this.Init(doc, 0, -1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "notPreviouslySeen"));// CSBuildMemberListCodedValue.cs:77
