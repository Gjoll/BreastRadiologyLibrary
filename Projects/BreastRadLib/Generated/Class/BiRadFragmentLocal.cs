...
{
	//+ LocalClassDefs
	#region Observation.component:biRadsAssessmentCategory Container Class                                                                     // BuildMemberBase.cs:157
	...
	/// </summary>
	public class BiRadsAssessmentCategoryContainer : MContainer, ITMItem<Observation.ComponentComponent>                                       // BuildMemberBase.cs:162
	{                                                                                                                                          // BuildMemberBase.cs:163
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:81
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:64
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:66
	                ...
	                Code = BiRadsAssessmentCategory_ComponentCode()                                                                            // BuildMemberComponents.cs:68
	    ...
	    /// Constructor
	    /// </summary>
	    public BiRadsAssessmentCategoryContainer(Int32 min, Int32 max) : base("Observation.component:biRadsAssessmentCategory", min, max)      // BuildMemberBase.cs:174
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:80
	        IEnumerable<Observation.ComponentComponent> memberComponents = base.IsMember(doc,                                                  // BuildMemberComponents.cs:81
	            ...
	            BiRadsAssessmentCategory_ComponentCode());                                                                                     // BuildMemberComponents.cs:83
