...
{
	//+ LocalClassDefs
	#region Observation.component:biRadsAssessmentCategory Container Class                                                                     // BuildMemberBase.cs:173
	...
	/// </summary>
	public class MBiRadsAssessmentCategory : MContainer, ITMItem<Observation.ComponentComponent>                                               // BuildMemberBase.cs:178
	{                                                                                                                                          // BuildMemberBase.cs:179
	    ...
	    /// Constructor
	    /// </summary>
	    public MBiRadsAssessmentCategory(Int32 min, Int32 max) : base("Observation.component:biRadsAssessmentCategory", min, max)              // BuildMemberBase.cs:190
