...
namespace BreastRadLib.BiRadFragmentLocal
{
	...
	/// </summary>
	public class BiRadsAssessmentCategoryContainer : MContainer, ITMItem<Observation.ComponentComponent>                                       // BuildMemberBase.cs:135
	{                                                                                                                                          // BuildMemberBase.cs:136
	    ...
	    /// Constructor
	    /// </summary>
	    public BiRadsAssessmentCategoryContainer(Int32 min, Int32 max) : base("Observation.component:biRadsAssessmentCategory", min, max)      // BuildMemberBase.cs:145
