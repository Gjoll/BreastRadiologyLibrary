...
namespace BreastRadLib
{
	...
	/// </summary>
	public class USFinding : ObservationBase, IUSFinding
	{
		//+ Properties
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			SetProfileUrl("http://hl7.org/fhir/us/breast-radiology/StructureDefinition/USFinding");                                                  // DefineBase.cs:220
			//- Constructor
		}
		...
		{                                                                                                                                         // FhirConstruct.cs:760
		    ...
		    {                                                                                                                                     // FhirConstruct.cs:770
		        ...
		        temp4.CodeElement.Value = "usFindingObservation";                                                                                 // FhirConstruct.cs:792
