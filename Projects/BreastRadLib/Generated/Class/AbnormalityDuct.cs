...
namespace BreastRadLib
{
	...
	public class AbnormalityDuct : ObservationBase, IAbnormalityDuct
	{
		...
		/// </summary>
		public DuctTypeContainer DuctType { get ; protected set; }                                                                                // BuildMemberBase.cs:381
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			// Called from BuildMemberComponents.cs, Line 208
			this.DuctType = new DuctTypeContainer(0, 0);                                                                                             // BuildMemberBase.cs:360
			//- Constructor
		}
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:142
			    ...
			    this.DuctType.Read(this.Doc, items);                                                                                                 // BuildMemberComponents.cs:96
			    //- ReadComponents
			...
			{                                                                                                                                        // BuildMemberComponents.cs:152
			    ...
			    items.AddRange(this.DuctType.Write(this.Doc));                                                                                       // BuildMemberComponents.cs:114
			    //- WriteComponents
