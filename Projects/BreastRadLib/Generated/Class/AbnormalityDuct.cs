...
namespace BreastRadLib
{
	...
	public class AbnormalityDuct : ObservationBase, IAbnormalityDuct
	{
		...
		/// </summary>
		public DuctType_Accessor DuctType { get ; protected set; }                                                                                // BuildMemberListBase.cs:70
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			SetProfileUrl("http://hl7.org/fhir/us/breast-radiology/StructureDefinition/AbnormalityDuct");                                            // DefineBase.cs:215
			...
			this.DuctType = new DuctType_Accessor(doc);                                                                                              // BuildMemberListBase.cs:73
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			if (this.DuctType.Validate(sb) == false) retVal = false;                                                                                 // BuildMemberListBase.cs:82
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.WriteComponent(this.DuctType);                                                                                                      // BuildMemberListBase.cs:76
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.ReadComponent(this.DuctType);                                                                                                       // BuildMemberListBase.cs:79
			//- ReadCode
		}
