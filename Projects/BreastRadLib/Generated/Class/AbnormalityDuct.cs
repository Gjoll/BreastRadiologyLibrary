...
namespace BreastRadLib
{
	...
	public class AbnormalityDuct : ObservationBase, IAbnormalityDuct
	{
		...
		/// Access DuctType
		/// </summary>
		public ElementItemComponentSingle<CodeableConcept> DuctType { get ; protected set; }                                                      // BuildElementItemComponent.cs:74
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.DuctType = new ElementItemComponentSingle<CodeableConcept>("DuctType", 0, 1, FixedValue_ObservationComponentDuctTypeCode());        // BuildElementItemComponent.cs:59
			//- Constructor
		}
