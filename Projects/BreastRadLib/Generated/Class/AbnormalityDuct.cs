...
namespace BreastRadLib
{
	...
	public class AbnormalityDuct : ObservationBase, IAbnormalityDuct
	{
		...
		/// </summary>
		public DuctType_Accessor DuctType { get ; protected set; }                                                                                // BuildMemberListBase.cs:69
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			SetProfileUrl("http://hl7.org/fhir/us/breast-radiology/StructureDefinition/AbnormalityDuct");                                            // DefineBase.cs:189
			/// <summary>
			/// Constructor
			/// </summary>
			...
			/// Constructor
			/// </summary>
			this.DuctType = new DuctType_Accessor(doc);                                                                                              // BuildMemberListBase.cs:75
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			if (this.DuctType.Validate(sb) == false) retVal = false;                                                                                 // BuildMemberListBase.cs:84
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.WriteComponent(this.DuctType);                                                                                                      // BuildMemberListBase.cs:78
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.ReadComponent(this.DuctType);                                                                                                       // BuildMemberListBase.cs:81
			//- ReadCode
		}
