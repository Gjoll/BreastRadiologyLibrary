...
{
	//+ LocalClassDefs
	#region Observation.component:asymmetryType Container Class                                                                                // BuildMemberBase.cs:140
	...
	/// </summary>
	public class AsymmetryTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                  // BuildMemberBase.cs:145
	{                                                                                                                                          // BuildMemberBase.cs:146
	    ...
	    /// Constructor
	    /// </summary>
	    public AsymmetryTypeContainer(Int32 min, Int32 max) : base("Observation.component:asymmetryType", min, max)                            // BuildMemberBase.cs:155
