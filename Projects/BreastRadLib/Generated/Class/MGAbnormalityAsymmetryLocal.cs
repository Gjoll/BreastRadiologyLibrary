...
namespace BreastRadLib.MGAbnormalityAsymmetryLocal
{
	...
	/// </summary>
	public class AsymmetryTypeContainer : MContainer, ITMItem<Observation.ComponentComponent>                                                  // BuildMemberBase.cs:135
	{                                                                                                                                          // BuildMemberBase.cs:136
	    ...
	    /// Constructor
	    /// </summary>
	    public AsymmetryTypeContainer(Int32 min, Int32 max) : base("Observation.component:asymmetryType", min, max)                            // BuildMemberBase.cs:145
