...
namespace BreastRadLib.MGAbnormalityAsymmetryLocal
{
	...
	{                                                                                                                                          // BuildMemberBase.cs:163
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:81
	        ...
	        {                                                                                                                                  // BuildMemberComponents.cs:64
	            ...
	            {                                                                                                                              // BuildMemberComponents.cs:66
	                ...
	                Code = AsymmetryType_ComponentCode()                                                                                       // BuildMemberComponents.cs:68
	    ...
	    /// Constructor
	    /// </summary>
	    public AsymmetryTypeContainer(Int32 min, Int32 max) : base("Observation.component:asymmetryType", min, max)                            // BuildMemberBase.cs:174
	    ...
	    {                                                                                                                                      // BuildMemberComponents.cs:80
	        IEnumerable<Observation.ComponentComponent> memberComponents = base.IsMember(doc,                                                  // BuildMemberComponents.cs:81
	            ...
	            AsymmetryType_ComponentCode());                                                                                                // BuildMemberComponents.cs:83
