...
{
	//+ LocalClassDefs
	#region Observation.component:asymmetryType Container Class                                                                                // BuildMemberBase.cs:173
	...
	/// </summary>
	public class MAsymmetryType : MContainer, ITMItem<Observation.ComponentComponent>                                                          // BuildMemberBase.cs:178
	{                                                                                                                                          // BuildMemberBase.cs:179
	    ...
	    /// Constructor
	    /// </summary>
	    public MAsymmetryType(Int32 min, Int32 max) : base("Observation.component:asymmetryType", min, max)                                    // BuildMemberBase.cs:190
