...
namespace BreastRadLib.MGAbnormalityAsymmetryLocal
{
	...
	/// </summary>
	public class AsymmetryType_Accessor : MemberListCodedValue<CodeableConcept>                                                                // BuildMemberListCodedValue.cs:51
	{                                                                                                                                          // BuildMemberListCodedValue.cs:52
	    ...
	    /// </summary>
	    public void Set(MGAbnormalityAsymmetriesTypeVS.TCoding value) => this.SetFirst(value);                                                 // BuildMemberListCodedValue.cs:81
	                                                                                                                                           // BuildMemberListCodedValue.cs:58
	    /// <summary>
	    /// Accessor class constructor
	    /// </summary>
	    public AsymmetryType_Accessor(BreastRadiologyDocument doc) : base("AsymmetryType_Accessor")                                            // BuildMemberListCodedValue.cs:62
	    {                                                                                                                                      // BuildMemberListCodedValue.cs:63
	        this.Init(doc, 0, 1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "mgAbnormalityAsymmetryType"));// BuildMemberListCodedValue.cs:64
