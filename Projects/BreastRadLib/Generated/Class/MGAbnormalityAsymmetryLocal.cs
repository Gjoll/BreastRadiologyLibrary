...
namespace BreastRadLib.MGAbnormalityAsymmetryLocal
{
	...
	/// </summary>
	public class AsymmetryType_Accessor : ObservationBase.ComponentBase<CodeableConcept>                                                       // CSDefineObservation.cs:42
	{                                                                                                                                          // CSDefineObservation.cs:43
	    ...
	    /// </summary>
	    public AsymmetryType_Accessor(BreastRadiologyDocument doc) : base()                                                                    // CSDefineObservation.cs:53
	    {                                                                                                                                      // CSDefineObservation.cs:54
	        this.Create(doc, 1, 1, new Coding("http://hl7.org/fhir/us/breast-radiology/CodeSystem/ObservationComponentSliceCodes", "mgAbnormalityAsymmetryType"));// CSDefineObservation.cs:55
