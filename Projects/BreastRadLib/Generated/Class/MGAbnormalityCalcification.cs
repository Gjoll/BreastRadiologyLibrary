...
namespace BreastRadLib
{
	...
	public class MGAbnormalityCalcification : ObservationBase, IMGAbnormalityCalcification
	{
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.CalcificationType = new TItemComponentSingle<CodeableConcept>("CalcificationType", 0, 1, FixedValue_ObservationComponentCalcificationTypeCode());// BuildElementItemComponent.cs:59
			this.CalcificationDistribution = new TItemComponentSingle<CodeableConcept>("CalcificationDistribution", 0, 1, FixedValue_ObservationComponentCalcificationDistributionCode());// BuildElementItemComponent.cs:59
			//- Constructor
		}
