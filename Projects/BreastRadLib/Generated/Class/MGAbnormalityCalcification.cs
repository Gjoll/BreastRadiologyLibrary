...
namespace BreastRadLib
{
	...
	public class MGAbnormalityCalcification : ObservationBase, IMGAbnormalityCalcification
	{
		...
		/// </summary>
		public MCalcificationType CalcificationType { get ; protected set; }                                                                      // BuildMemberBase.cs:381
		                                                                                                                                          // BuildMemberBase.cs:375
		// Called from BuildMemberComponents.cs, Line 208
		// BuildMemberBase.cs:377
		/// <summary>
		...
		/// </summary>
		public MCalcificationDistribution CalcificationDistribution { get ; protected set; }                                                      // BuildMemberBase.cs:381
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			// Called from BuildMemberComponents.cs, Line 208
			this.CalcificationType = new MCalcificationType(0, 0);                                                                                   // BuildMemberBase.cs:360
			// Called from BuildMemberComponents.cs, Line 208
			this.CalcificationDistribution = new MCalcificationDistribution(0, 0);                                                                   // BuildMemberBase.cs:360
			//- Constructor
		}
