	...
	public class MGAbnormalityCalcification : ObservationBase, IMGAbnormalityCalcification
	{
		...
		//+ !Components
			...
			{                                                                                                                                        // BuildMemberComponents.cs:138
			    ...
			    this.CalcificationType.Read(this.Doc, items);                                                                                        // BuildMemberComponents.cs:88
			    this.CalcificationDistribution.Read(this.Doc, items);                                                                                // BuildMemberComponents.cs:88
			    //- ReadComponents
			...
			{                                                                                                                                        // BuildMemberComponents.cs:148
			    ...
			    items.AddRange(this.CalcificationType.Write(this.Doc));                                                                              // BuildMemberComponents.cs:110
			    items.AddRange(this.CalcificationDistribution.Write(this.Doc));                                                                      // BuildMemberComponents.cs:110
			    //- WriteComponents
