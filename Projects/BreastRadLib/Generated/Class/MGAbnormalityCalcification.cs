...
namespace BreastRadLib
{
	...
	public class MGAbnormalityCalcification : ObservationBase, IMGAbnormalityCalcification
	{
		...
		/// </summary>
		public MCalcificationType CalcificationType { get ; protected set; }                                                                      // BuildMemberBase.cs:399
		                                                                                                                                          // BuildMemberBase.cs:393
		// Called from BuildMemberComponents.cs, Line 202
		// BuildMemberBase.cs:395
		/// <summary>
		...
		/// </summary>
		public MCalcificationDistribution CalcificationDistribution { get ; protected set; }                                                      // BuildMemberBase.cs:399
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			// Called from BuildMemberComponents.cs, Line 202
			this.CalcificationType = new MCalcificationType(0, 1);                                                                                   // BuildMemberBase.cs:378
			// Called from BuildMemberComponents.cs, Line 202
			this.CalcificationDistribution = new MCalcificationDistribution(0, 1);                                                                   // BuildMemberBase.cs:378
			//- Constructor
		}
