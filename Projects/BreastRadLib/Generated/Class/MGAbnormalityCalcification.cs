...
namespace BreastRadLib
{
	...
	public class MGAbnormalityCalcification : ObservationBase, IMGAbnormalityCalcification
	{
		...
		/// </summary>
		public CalcificationTypeContainer CalcificationType { get ; protected set; }                                                              // BuildMemberBase.cs:332
		                                                                                                                                          // BuildMemberBase.cs:327
		/// <summary>
		/// CalcificationDistribution
		/// Access fhir element 'Observation.component:calcificationDistribution'
		/// </summary>
		public CalcificationDistributionContainer CalcificationDistribution { get ; protected set; }                                              // BuildMemberBase.cs:332
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.CalcificationType = new CalcificationTypeContainer(0, 0);                                                                           // BuildMemberBase.cs:316
			this.CalcificationDistribution = new CalcificationDistributionContainer(0, 0);                                                           // BuildMemberBase.cs:316
			//- Constructor
		}
