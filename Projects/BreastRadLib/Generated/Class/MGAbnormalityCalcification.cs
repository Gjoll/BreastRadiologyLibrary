...
namespace BreastRadLib
{
	...
	public class MGAbnormalityCalcification : ObservationBase, IMGAbnormalityCalcification
	{
		...
		/// </summary>
		public CalcificationType_Accessor CalcificationType { get ; protected set; }                                                              // BuildMemberListBase.cs:71
		                                                                                                                                          // BuildMemberListBase.cs:67
		/// <summary>
		/// Access Component value CalcificationDistribution
		/// </summary>
		public CalcificationDistribution_Accessor CalcificationDistribution { get ; protected set; }                                              // BuildMemberListBase.cs:71
		//- Properties
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			this.CalcificationType = new CalcificationType_Accessor(doc);                                                                            // BuildMemberListBase.cs:74
			this.CalcificationDistribution = new CalcificationDistribution_Accessor(doc);                                                            // BuildMemberListBase.cs:74
			//- Constructor
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			if (this.CalcificationType.Validate(sb) == false) retVal = false;                                                                        // BuildMemberListBase.cs:83
			if (this.CalcificationDistribution.Validate(sb) == false) retVal = false;                                                                // BuildMemberListBase.cs:83
			//- ValidateCode
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.WriteComponent(this.CalcificationType);                                                                                             // BuildMemberListBase.cs:77
			this.WriteComponent(this.CalcificationDistribution);                                                                                     // BuildMemberListBase.cs:77
			//- WriteCode
		}
		...
		public override void Read()
		{
			...
			this.ReadComponent(this.CalcificationType);                                                                                              // BuildMemberListBase.cs:80
			this.ReadComponent(this.CalcificationDistribution);                                                                                      // BuildMemberListBase.cs:80
			//- ReadCode
		}
