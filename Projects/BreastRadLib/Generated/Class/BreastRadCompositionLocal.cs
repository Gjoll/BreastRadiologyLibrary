...
namespace BreastRadLib.BreastRadCompositionLocal
{
	...
	{                                                                                                                                          // CSDefineComposition.cs:44
	    ...
	    /// Access propertyName
	    /// </summary>
	    public BreastRadReport Get() => this.FirstOrDefault();                                                                                 // CSDefineComposition.cs:86
	                                                                                                                                           // CSDefineComposition.cs:65
	    /// <summary>
	    /// Create new blank Report if one doesnt already exist, and return it
	    /// </summary>
	    public BreastRadReport Create()                                                                                                        // CSDefineComposition.cs:69
	    {                                                                                                                                      // CSDefineComposition.cs:70
	        if (this.Count == 0)                                                                                                               // CSDefineComposition.cs:71
	        {                                                                                                                                  // CSDefineComposition.cs:72
	            BreastRadReport brItem = new BreastRadReport();                                                                                // CSDefineComposition.cs:73
	            brItem.Init(this.doc);                                                                                                         // CSDefineComposition.cs:74
	            this.AppendItem(brItem);                                                                                                       // CSDefineComposition.cs:75
	        }                                                                                                                                  // CSDefineComposition.cs:76
	        return this.First();                                                                                                               // CSDefineComposition.cs:77
	    }                                                                                                                                      // CSDefineComposition.cs:78
	                                                                                                                                           // CSDefineComposition.cs:46
	                                                                                                                                           // CSDefineComposition.cs:48
	    /// <summary>
	...
	{                                                                                                                                          // CSDefineComposition.cs:44
	    ...
	    /// Access propertyName
	    /// </summary>
	    public IEnumerable<ResourceBase> All() => this.items;                                                                                  // CSDefineComposition.cs:136
	                                                                                                                                           // CSDefineComposition.cs:138
	    /// <summary>
	    /// Access item at indicated location in list
	    /// </summary>
	    public ResourceBase At(Int32 i) => base.items[i];                                                                                      // CSDefineComposition.cs:142
	                                                                                                                                           // CSDefineComposition.cs:144
	    /// <summary>
	    /// Access first item in list
	    /// </summary>
	    public new ResourceBase First() => base.First();                                                                                       // CSDefineComposition.cs:148
	                                                                                                                                           // CSDefineComposition.cs:149
	    /// <summary>
	    /// Access first item in list or default value if empty
	    /// </summary>
	    public new ResourceBase FirstOrDefault() => base.FirstOrDefault();                                                                     // CSDefineComposition.cs:153
	                                                                                                                                           // CSDefineComposition.cs:46
	                                                                                                                                           // CSDefineComposition.cs:111
	    /// <summary>
	    /// Create new blank Impressions of type ClinicalImpression and add to end of list
	    /// </summary>
	    //If: C:\Development\HL7\BreastRadiologyLibrary\Projects\FireFragger\FireFragger\CS\CSDefineComposition.cs 116                         // CodeBlockNested.cs:588
	    public ResourceBase Append(Resource r)                                                                                                 // CSDefineComposition.cs:117
	    {                                                                                                                                      // CSDefineComposition.cs:120
	        ResourceBase brItem = new ResourceBase();                                                                                          // CSDefineComposition.cs:121
	        //If: C:\Development\HL7\BreastRadiologyLibrary\Projects\FireFragger\FireFragger\CS\CSDefineComposition.cs 122                     // CodeBlockNested.cs:588
	        brItem.Init(this.doc, r);                                                                                                          // CSDefineComposition.cs:123
	        this.AppendItem(brItem);                                                                                                           // CSDefineComposition.cs:126
	        return brItem;                                                                                                                     // CSDefineComposition.cs:127
	...
	{                                                                                                                                          // CSDefineComposition.cs:44
	    ...
	    /// Access propertyName
	    /// </summary>
	    public SectionFindingsRightBreast Get() => this.FirstOrDefault();                                                                      // CSDefineComposition.cs:86
	                                                                                                                                           // CSDefineComposition.cs:65
	    /// <summary>
	    /// Create new blank FindingsRightBreast if one doesnt already exist, and return it
	    /// </summary>
	    public SectionFindingsRightBreast Create()                                                                                             // CSDefineComposition.cs:69
	    {                                                                                                                                      // CSDefineComposition.cs:70
	        if (this.Count == 0)                                                                                                               // CSDefineComposition.cs:71
	        {                                                                                                                                  // CSDefineComposition.cs:72
	            SectionFindingsRightBreast brItem = new SectionFindingsRightBreast();                                                          // CSDefineComposition.cs:73
	            brItem.Init(this.doc);                                                                                                         // CSDefineComposition.cs:74
	            this.AppendItem(brItem);                                                                                                       // CSDefineComposition.cs:75
	        }                                                                                                                                  // CSDefineComposition.cs:76
	        return this.First();                                                                                                               // CSDefineComposition.cs:77
	...
	{                                                                                                                                          // CSDefineComposition.cs:44
	    ...
	    /// Access propertyName
	    /// </summary>
	    public SectionFindingsLeftBreast Get() => this.FirstOrDefault();                                                                       // CSDefineComposition.cs:86
	                                                                                                                                           // CSDefineComposition.cs:65
	    /// <summary>
	    /// Create new blank FindingsLeftBreast if one doesnt already exist, and return it
	    /// </summary>
	    public SectionFindingsLeftBreast Create()                                                                                              // CSDefineComposition.cs:69
	    {                                                                                                                                      // CSDefineComposition.cs:70
	        if (this.Count == 0)                                                                                                               // CSDefineComposition.cs:71
	        {                                                                                                                                  // CSDefineComposition.cs:72
	            SectionFindingsLeftBreast brItem = new SectionFindingsLeftBreast();                                                            // CSDefineComposition.cs:73
	            brItem.Init(this.doc);                                                                                                         // CSDefineComposition.cs:74
	            this.AppendItem(brItem);                                                                                                       // CSDefineComposition.cs:75
	        }                                                                                                                                  // CSDefineComposition.cs:76
	        return this.First();                                                                                                               // CSDefineComposition.cs:77
	...
	{                                                                                                                                          // CSDefineComposition.cs:44
	    ...
	    /// </summary>
	    //If: C:\Development\HL7\BreastRadiologyLibrary\Projects\FireFragger\FireFragger\CS\CSDefineComposition.cs 116                         // CodeBlockNested.cs:588
	    public ResourceBase AppendMedicationRequest(Resource r)                                                                                // CSDefineComposition.cs:117
	    {                                                                                                                                      // CSDefineComposition.cs:120
	        ResourceBase brItem = new ResourceBase();                                                                                          // CSDefineComposition.cs:121
	        //If: C:\Development\HL7\BreastRadiologyLibrary\Projects\FireFragger\FireFragger\CS\CSDefineComposition.cs 122                     // CodeBlockNested.cs:588
	        brItem.Init(this.doc, r);                                                                                                          // CSDefineComposition.cs:123
	    ...
	    /// </summary>
	    //If: C:\Development\HL7\BreastRadiologyLibrary\Projects\FireFragger\FireFragger\CS\CSDefineComposition.cs 116                         // CodeBlockNested.cs:588
	    public ResourceBase AppendServiceRequest(Resource r)                                                                                   // CSDefineComposition.cs:117
	    {                                                                                                                                      // CSDefineComposition.cs:120
	        ResourceBase brItem = new ResourceBase();                                                                                          // CSDefineComposition.cs:121
	        //If: C:\Development\HL7\BreastRadiologyLibrary\Projects\FireFragger\FireFragger\CS\CSDefineComposition.cs 122                     // CodeBlockNested.cs:588
	        brItem.Init(this.doc, r);                                                                                                          // CSDefineComposition.cs:123
	    ...
	    /// Create new blank Recommendations of type ServiceRequest and add to end of list
	    /// </summary>
	    //Else: C:\Development\HL7\BreastRadiologyLibrary\Projects\FireFragger\FireFragger\CS\CSDefineComposition.cs 116                       // CodeBlockNested.cs:594
	    public ServiceRecommendation AppendServiceRecommendation()                                                                             // CSDefineComposition.cs:118
	    {                                                                                                                                      // CSDefineComposition.cs:120
	        ServiceRecommendation brItem = new ServiceRecommendation();                                                                        // CSDefineComposition.cs:121
	        //Else: C:\Development\HL7\BreastRadiologyLibrary\Projects\FireFragger\FireFragger\CS\CSDefineComposition.cs 122                   // CodeBlockNested.cs:594
	        brItem.Init(this.doc);                                                                                                             // CSDefineComposition.cs:124
	        this.AppendItem(brItem);                                                                                                           // CSDefineComposition.cs:126
	        return brItem;                                                                                                                     // CSDefineComposition.cs:127
	    }                                                                                                                                      // CSDefineComposition.cs:128
	                                                                                                                                           // CSDefineComposition.cs:48
