...
namespace BreastRadLib.BreastBodyLocationRequiredFragmentLocal
{
	//+ LocalClassDefs
	...
	{                                                                                                                                          // BuildMemberBase.cs:180
	    ...
	    {                                                                                                                                      // BuildMemberBase.cs:87
	        ...
	        MBreastBodyLocationExtension BreastBodyLocation;                                                                                   // BuildMemberExtension.cs:82
	        ...
	        {                                                                                                                                  // BuildMemberBase.cs:101
	            this.BreastBodyLocation = new MBreastBodyLocationExtension(1, 1);                                                              // BuildMemberExtension.cs:88
	    ...
	    /// Constructor
	    /// </summary>
	    public MBodySite(Int32 min, Int32 max) : base("Observation.bodySite", min, max)                                                        // BuildMemberBase.cs:191
