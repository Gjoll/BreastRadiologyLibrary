...
{
	//+ Header
	public class FibroadenomaVS                                                                                                                // CSBuilder.cs:333
	//- Header
	{
		//+ Fields
		/// <summary>
		...
		public TCoding Code_Fibroadenoma = new TCoding(FibroadenomaCodeSystemCS.Code_Fibroadenoma);                                               // CSBuilder.cs:384
		public TCoding Code_FibroadenomaDegeneration = new TCoding(FibroadenomaCodeSystemCS.Code_FibroadenomaDegeneration);                       // CSBuilder.cs:384
		                                                                                                                                          // CSBuilder.cs:339
		...
		{                                                                                                                                         // CSBuilder.cs:343
		    ...
		    this.Members.Add(this.Code_FibroadenomaDegeneration);                                                                                 // CSBuilder.cs:387
		}                                                                                                                                         // CSBuilder.cs:346
		//- Fields
	}
}
