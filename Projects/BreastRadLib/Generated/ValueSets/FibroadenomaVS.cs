...
{
	//+ Header
	public class FibroadenomaVS                                                                                                                // CSBuilder.cs:344
	//- Header
	{
		//+ Fields
		/// <summary>
		...
		public TCoding Code_Fibroadenoma = new TCoding(FibroadenomaCodeSystemCS.Code_Fibroadenoma);                                               // CSBuilder.cs:395
		public TCoding Code_FibroadenomaDegeneration = new TCoding(FibroadenomaCodeSystemCS.Code_FibroadenomaDegeneration);                       // CSBuilder.cs:395
		                                                                                                                                          // CSBuilder.cs:350
		public List<Coding> Members;                                                                                                              // CSBuilder.cs:351
		                                                                                                                                          // CSBuilder.cs:352
		public FibroadenomaVS()                                                                                                                   // CSBuilder.cs:353
		{                                                                                                                                         // CSBuilder.cs:354
		    this.Members = new List<Coding>();                                                                                                    // CSBuilder.cs:355
		    this.Members.Add(this.Code_Fibroadenoma);                                                                                             // CSBuilder.cs:398
		    this.Members.Add(this.Code_FibroadenomaDegeneration);                                                                                 // CSBuilder.cs:398
		}                                                                                                                                         // CSBuilder.cs:357
		//- Fields
	}
}
