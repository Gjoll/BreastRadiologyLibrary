...
{
	//+ Header
	public class AbnormalityCystTypeCS                                                                                                         // CSBuilder.cs:416
	//- Header
	{
		//+ Fields
		const string System = "http://hl7.org/fhir/us/breast-radiology/CodeSystem/AbnormalityCystTypeCS";                                         // CSBuilder.cs:420
		                                                                                                                                          // CSBuilder.cs:432
		/// <summary>
		...
		/// </summary>
		public static Coding Code_CystMicro = new Coding(System, "CystMicro", "Cyst micro");                                                      // CSBuilder.cs:446
		                                                                                                                                          // CSBuilder.cs:432
		/// <summary>
		...
		/// Valid for the following modalities: MG US.
		/// </summary>
		public static Coding Code_CystWithDebris = new Coding(System, "CystWithDebris", "Cyst with debris");                                      // CSBuilder.cs:446
		//- Fields
	}
}
