...
namespace BreastRadLib
{
	public class MammoCalcificationTypeCS
	{
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_Generic = new Coding(System, "Generic", "Generic");                                                             // Builder.cs:408
		                                                                                                                                          // Builder.cs:389
		/// <summary>
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_CoarseHeterogeneous = new Coding(System, "CoarseHeterogeneous", "Coarse Heterogeneous");                        // Builder.cs:408
		                                                                                                                                          // Builder.cs:389
		/// <summary>
