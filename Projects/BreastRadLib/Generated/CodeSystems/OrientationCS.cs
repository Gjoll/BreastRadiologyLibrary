...
namespace BreastRadLib
{
	...
	{
		//+ Fields
		const string System = "http://hl7.org/fhir/us/breast-radiology/CodeSystem/OrientationCS";                                                 // Builder.cs:377
		                                                                                                                                          // Builder.cs:389
		/// <summary>
		...
		/// Valid for the following modalities: MG US MRI NM.
		/// </summary>
		public static Coding Code_PerpendicularToSkin = new Coding(System, "PerpendicularToSkin", "Perpendicular to skin (not parallel)");        // Builder.cs:408
		                                                                                                                                          // Builder.cs:389
		/// <summary>
		...
		/// Valid for the following modalities: US MRI.
		/// </summary>
		public static Coding Code_WiderThanTall = new Coding(System, "WiderThanTall", "Wider than tall");                                         // Builder.cs:408
		//- Fields
	}
}
