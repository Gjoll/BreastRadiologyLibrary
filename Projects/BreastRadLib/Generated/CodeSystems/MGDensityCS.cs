...
namespace BreastRadLib
{
	...
	{
		//+ Fields
		const string System = "http://hl7.org/fhir/us/breast-radiology/CodeSystem/MGDensityCS";                                                   // CSBuilder.cs:344
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// </summary>
		public static Coding Code_CentralLucent = new Coding(System, "CentralLucent", "Central lucent");                                          // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_EqualDensity = new Coding(System, "EqualDensity", "Equal density");                                             // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_FatContaining = new Coding(System, "FatContaining", "Fat containing");                                          // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_HighDensity = new Coding(System, "HighDensity", "High density");                                                // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_LowDensity = new Coding(System, "LowDensity", "Low density");                                                   // CSBuilder.cs:370
		//- Fields
	}
}
