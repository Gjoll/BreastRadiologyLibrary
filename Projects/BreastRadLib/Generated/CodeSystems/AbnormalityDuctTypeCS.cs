...
namespace BreastRadLib
{
	...
	{
		//+ Fields
		const string System = "http://hl7.org/fhir/us/breast-radiology/CodeSystem/AbnormalityDuctTypeCS";                                         // CSBuilder.cs:347
		                                                                                                                                          // CSBuilder.cs:359
		/// <summary>
		...
		/// </summary>
		public static Coding Code_DuctNormal = new Coding(System, "DuctNormal", "Duct normal");                                                   // CSBuilder.cs:373
		                                                                                                                                          // CSBuilder.cs:359
		/// <summary>
		...
		/// </summary>
		public static Coding Code_DuctDilatedATLASSolitaryDilatedDuct = new Coding(System, "DuctDilatedATLASSolitaryDilatedDuct", "Duct dilated ATLAS solitary dilated duct");// CSBuilder.cs:373
		                                                                                                                                          // CSBuilder.cs:359
		/// <summary>
