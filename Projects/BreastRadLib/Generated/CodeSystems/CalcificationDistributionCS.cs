...
namespace BreastRadLib
{
	...
	{
		//+ Fields
		const string System = "http://hl7.org/fhir/us/breast-radiology/CodeSystem/CalcificationDistributionCS";                                   // Builder.cs:371
		                                                                                                                                          // Builder.cs:383
		/// <summary>
		...
		/// </summary>
		public static Coding Code_ClusteredDistribution = new Coding(System, "ClusteredDistribution", "Clustered distribution");                  // Builder.cs:402
		                                                                                                                                          // Builder.cs:383
		/// <summary>
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_DiffuseDistribution = new Coding(System, "DiffuseDistribution", "Diffuse distribution");                        // Builder.cs:402
		                                                                                                                                          // Builder.cs:383
		/// <summary>
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_GroupedDistribution = new Coding(System, "GroupedDistribution", "Grouped distribution");                        // Builder.cs:402
		                                                                                                                                          // Builder.cs:383
		/// <summary>
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_LinearDistribution = new Coding(System, "LinearDistribution", "Linear distribution");                           // Builder.cs:402
		                                                                                                                                          // Builder.cs:383
		/// <summary>
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_RegionalDistribution = new Coding(System, "RegionalDistribution", "Regional distribution");                     // Builder.cs:402
		                                                                                                                                          // Builder.cs:383
		/// <summary>
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_ScatteredDistribution = new Coding(System, "ScatteredDistribution", "Scattered distribution");                  // Builder.cs:402
		                                                                                                                                          // Builder.cs:383
		/// <summary>
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_SegmentalDistribution = new Coding(System, "SegmentalDistribution", "Segmental distribution");                  // Builder.cs:402
		//- Fields
	}
}
