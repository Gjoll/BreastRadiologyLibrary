...
namespace BreastRadLib
{
	public class CorrespondsWithCodeSystemCS
	{
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_Scinti = new Coding(System, "Scinti", "Scinti");                                                                // Builder.cs:408
		                                                                                                                                          // Builder.cs:389
		/// <summary>
		/// size &lt; mammo
		/// 
		...
		/// Valid for the following modalities: US MRI NM.
		/// </summary>
		public static Coding Code_SizeLessThanMammo = new Coding(System, "Size<Mammo", "Size < mammo");                                           // Builder.cs:408
		                                                                                                                                          // Builder.cs:389
		/// <summary>
		/// size &lt; MRI
		/// 
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_SizeLessThanMRI = new Coding(System, "Size<MRI", "Size < MRI");                                                 // Builder.cs:408
		                                                                                                                                          // Builder.cs:389
		/// <summary>
		/// size &lt; palp
		/// 
		...
		/// </summary>
		public static Coding Code_SizeLessThanPalp = new Coding(System, "Size<Palp", "Size < palp");                                              // Builder.cs:408
		                                                                                                                                          // Builder.cs:389
		/// <summary>
		/// size &lt; US
		/// 
		...
		/// Valid for the following modalities: MG US MRI NM.
		/// </summary>
		public static Coding Code_SizeLessThanUS = new Coding(System, "Size<US", "Size < US");                                                    // Builder.cs:408
		                                                                                                                                          // Builder.cs:389
		/// <summary>
		/// size &gt; mammo
		/// 
		...
		/// Valid for the following modalities: US MRI NM.
		/// </summary>
		public static Coding Code_SizeGreaterThanMammo = new Coding(System, "Size>Mammo", "Size > mammo");                                        // Builder.cs:408
		                                                                                                                                          // Builder.cs:389
		/// <summary>
		/// size &gt; MRI
		/// 
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_SizeGreaterThanMRI = new Coding(System, "Size>MRI", "Size > MRI");                                              // Builder.cs:408
		                                                                                                                                          // Builder.cs:389
		/// <summary>
		/// size &gt; palp
		/// 
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_SkinMarker = new Coding(System, "SkinMarker", "Skin marker");                                                   // Builder.cs:408
		                                                                                                                                          // Builder.cs:389
		/// <summary>
		/// Surgery
		/// 
		...
		/// Valid for the following modalities: MG US MRI NM.
		/// </summary>
		public static Coding Code_US = new Coding(System, "US", "US");                                                                            // Builder.cs:408
		//- Fields
	}
}
