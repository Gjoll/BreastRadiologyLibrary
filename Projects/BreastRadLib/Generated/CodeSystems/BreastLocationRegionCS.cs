...
{
	//+ Header
	public class BreastLocationRegionCS                                                                                                        // CSBuilder.cs:416
	//- Header
	{
		//+ Fields
		const string System = "http://hl7.org/fhir/us/breast-radiology/CodeSystem/BreastLocationRegionCS";                                        // CSBuilder.cs:420
		                                                                                                                                          // CSBuilder.cs:432
		/// <summary>
		...
		/// </summary>
		public static Coding Code_InframammaryFold = new Coding(System, "InframammaryFold", "Inframammary fold");                                 // CSBuilder.cs:446
		                                                                                                                                          // CSBuilder.cs:432
		/// <summary>
		...
		/// Valid for the following modalities: MG US MRI NM.
		/// </summary>
		public static Coding Code_InSkin = new Coding(System, "InSkin", "In skin");                                                               // CSBuilder.cs:446
		                                                                                                                                          // CSBuilder.cs:432
		/// <summary>
		...
		/// Valid for the following modalities: MG US.
		/// </summary>
		public static Coding Code_CentralToNipple = new Coding(System, "CentralToNipple", "Central to nipple");                                   // CSBuilder.cs:446
		//- Fields
	}
}
