...
namespace BreastRadLib
{
	...
	{
		//+ Fields
		const string System = "http://hl7.org/fhir/us/breast-radiology/CodeSystem/ConsistentWithCodeSystemCS";                                    // CSBuilder.cs:344
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// </summary>
		public static Coding Code_Abscess = new Coding(System, "Abscess", "Abscess");                                                             // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// </summary>
		public static Coding Code_Angiolipoma = new Coding(System, "Angiolipoma", "Angiolipoma");                                                 // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// The epithelial cells are undergoing an unexpected change.
		/// These breast changes may show on a mammogram and biopsy as a mass or benign lesion,
		/// or possibly even develop into a palpable mass.
		/// [https://breast-cancer.ca/apo-meta/]
		/// Valid for the following modalities: US.
		/// </summary>
		public static Coding Code_ApocrineMetaplasia = new Coding(System, "ApocrineMetaplasia", "Apocrine metaplasia");                           // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// from hardware failure, operator error and software (post-processing) artifacts.
		/// There are common and distinct artifacts for film, computed (CR) and digital radiography
		/// (DR).
		...
		/// </summary>
		public static Coding Code_Artifact = new Coding(System, "Artifact", "Artifact");                                                          // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Atypical hyperplasia isn't cancer, but it can be a forerunner to the development
		/// of breast cancer.
		/// Over the course of your lifetime, if the atypical hyperplasia cells keep dividing
		/// and become more abnormal, this can transition into noninvasive breast cancer (carcinoma
		...
		/// </summary>
		public static Coding Code_AtypicalHyperplasia = new Coding(System, "AtypicalHyperplasia", "Atypical hyperplasia");                        // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// breast cancers.
		/// Lymph nodes are small structures located all over the body around blood vessels that
		/// act as filters and can accumulate germs or cancer cells.
		/// They are a part of the lymph system of the body.
		/// [https://www.verywellhealth.com/axillary-lymph-nodes-2252131]
		/// Valid for the following modalities: NM.
		/// </summary>
		public static Coding Code_AxillaryLymphNode = new Coding(System, "AxillaryLymphNode", "Axillary lymph node");                             // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// </summary>
		public static Coding Code_Carcinoma = new Coding(System, "Carcinoma", "Carcinoma");                                                       // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Most breast cancers are carcinomas, which are tumors that start in the epithelial
		/// cells that line organs and tissues throughout the body.
		/// When carcinomas form in the breast, they are usually a more specific type called
		/// adenocarcinoma, which starts in cells in the ducts (the milk ducts) or the lobules
		/// (milk-producing glands).
		/// www.mayoclinic.org > cancer > diagnosis-treatment > drc-20370594
		/// 
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_CarcinomaKnown = new Coding(System, "CarcinomaKnown", "Carcinoma known");                                       // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_ClusterOfCysts = new Coding(System, "ClusterOfCysts", "Cluster of cysts");                                      // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		/// A breast cyst is a non-cancerous (benign) fluid-filled sac in the breast.
		/// Some cysts are too small to feel and others may be large and uncomfortable.
		...
		/// </summary>
		public static Coding Code_Cyst = new Coding(System, "Cyst", "Cyst");                                                                      // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: US MRI.
		/// </summary>
		public static Coding Code_CystComplex = new Coding(System, "CystComplex", "Cyst complex");                                                // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: US MRI.
		/// </summary>
		public static Coding Code_CystComplicated = new Coding(System, "CystComplicated", "Cyst complicated");                                    // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// </summary>
		public static Coding Code_CystOil = new Coding(System, "CystOil", "Cyst oil");                                                            // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// They grow slowly and aren't life-threatening, but they may become uncomfortable if
		/// they go unchecked.
		/// www.healthline.com > health > sebaceous-cyst
		/// 
		/// Valid for the following modalities: US.
		/// </summary>
		public static Coding Code_CystSebaceous = new Coding(System, "CystSebaceous", "Cyst sebaceous");                                          // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		/// Simple cysts have smooth, thin, regularly shaped walls and are completely filled
		/// with fluid.
		/// The sound waves sent out by the ultrasound test pass right through them, indicating
		/// there are no solid areas.
		/// Simple cysts are always benign.
		/// [https://www.breastcancer.org/symptoms/benign/cysts]
		/// Valid for the following modalities: US MRI.
		/// </summary>
		public static Coding Code_CystSimple = new Coding(System, "CystSimple", "Cyst simple");                                                   // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		/// Complex cysts have irregular or scalloped borders, thick walls, and some evidence
		/// of solid areas and/or debris in the fluid.
		...
		/// Valid for the following modalities: US MRI.
		/// </summary>
		public static Coding Code_CystsComplex = new Coding(System, "CystsComplex", "Cysts complex");                                             // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		/// Complicated cysts are "in between" simple and complex.
		/// Although they share most of the features of simple cysts, they tend to have some
		...
		/// Valid for the following modalities: US MRI.
		/// </summary>
		public static Coding Code_CystsComplicated = new Coding(System, "CystsComplicated", "Cysts complicated");                                 // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: US.
		/// </summary>
		public static Coding Code_CystsMicroClustered = new Coding(System, "CystsMicroClustered", "Cysts micro clustered");                       // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// DCIS is noninvasive, meaning it hasn't spread out of the milk duct and has a low
		/// risk of becoming invasive.
		/// [https://www.mayoclinic.org/diseases-conditions/dcis/symptoms-causes/syc-20371889]
		/// Valid for the following modalities: MG US MRI NM.
		/// </summary>
		public static Coding Code_DCIS = new Coding(System, "DCIS", "DCIS");                                                                      // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG US.
		/// </summary>
		public static Coding Code_Debris = new Coding(System, "Debris", "Debris");                                                                // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// In addition, it has been suggested that aluminum may have direct activity in breast
		/// tissue.
		/// [https://www.cancer.gov/about-cancer/causes-prevention/risk/myths/antiperspirants-fact-sheet]
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_Deodorant = new Coding(System, "Deodorant", "Deodorant");                                                       // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Often, these calcifications are in groups as they extend into small glands in the
		/// skin.
		/// [https://radiopaedia.org/articles/skin-calcification-in-breast?lang=us]
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_DermalCalcification = new Coding(System, "DermalCalcification", "Dermal calcification");                        // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// may be accompanied by inflammation and infiltration by plasma cells.
		/// [https://www.hoafredericksburg.com/duct-ectasia/]
		/// Valid for the following modalities: US MRI.
		/// </summary>
		public static Coding Code_DuctEctasia = new Coding(System, "DuctEctasia", "Duct ectasia");                                                // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// It can be caused by benign or malignant diseases, as a result of a tumor in the dermal
		/// lymphatics of the breast, lymphatic congestion caused by breast, lymphatic drainage
		...
		/// Valid for the following modalities: US MRI.
		/// </summary>
		public static Coding Code_Edema = new Coding(System, "Edema", "Edema");                                                                   // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		/// Fat Lobule.
		...
		/// Yes.
		/// Breast tissue is composed of functional elements (glands and ducts) as well as structural
		/// elements (connective tissue and vessels).
		/// The connective tissue (or stroma) in the breast is composed of various proportions
		/// of fat and fibrous tissue.
		/// 
		/// Valid for the following modalities: US.
		/// </summary>
		public static Coding Code_FatLobule = new Coding(System, "FatLobule", "Fat lobule");                                                      // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// This is called fat necrosis (necrosis is a medical term used to describe damaged
		/// or dead tissue).
		/// [https://breastcancernow.org/information-support/have-i-got-breast-cancer/breast-pain-other-benign-conditions/fat-necrosis]
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_FatNecrosis = new Coding(System, "FatNecrosis", "Fat necrosis");                                                // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// All components are found in normal breast tissue, which is why the lesions are considered
		/// hamartomatous.
		/// [https://radiopaedia.org/articles/breast-hamartoma?lang=us]
		/// Valid for the following modalities: MG US.
		/// </summary>
		public static Coding Code_Fibroadenolipoma = new Coding(System, "Fibroadenolipoma", "Fibroadenolipoma");                                  // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Fibroadenomas are most common in women in their 20s and 30s, but they can be found
		/// in women of any age.
		...
		/// Valid for the following modalities: MG US MRI NM.
		/// </summary>
		public static Coding Code_Fibroadenoma = new Coding(System, "Fibroadenoma", "Fibroadenoma");                                              // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_FibroadenomaDegenerating = new Coding(System, "FibroadenomaDegenerating", "Fibroadenoma degenerating");         // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_FibrocysticChange = new Coding(System, "FibrocysticChange", "Fibrocystic change");                              // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		/// Fibrocystic breast changes lead to the development of fluid-filled round or oval
		/// sacs (cysts) and more prominent scar-like (fibrous) tissue, which can make breasts
		...
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_FibroglandularTissue = new Coding(System, "FibroglandularTissue", "Fibroglandular tissue");                     // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_Fibrosis = new Coding(System, "Fibrosis", "Fibrosis");                                                          // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Strands of supportive tissue surround the breast and form a prominent ridge called
		/// the inframammary ridge.
		/// [https://www.stjoeshealth.org/find-a-service-or-specialty/womens-health/]
		/// Valid for the following modalities: US.
		/// </summary>
		public static Coding Code_FibrousRidge = new Coding(System, "FibrousRidge", "Fibrous ridge");                                             // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		/// Folliculitis is the inflammation of hair follicles due to an infection, injury, or
		/// irritation.
		/// It is characterized by tender, swollen areas that form around hair follicles, often
		/// on the neck, breasts, buttocks, and face.
		/// Boils (also referred to as furuncles) are pus-filled lesions that are painful and
		/// usually firm.
		/// [https://www.hopkinsmedicine.org/health/conditions-and-diseases/folliculitis-boils-and-carbuncles]
		/// Valid for the following modalities: US.
		/// </summary>
		public static Coding Code_Folliculitis = new Coding(System, "Folliculitis", "Folliculitis");                                              // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: US.
		/// </summary>
		public static Coding Code_Gynecomastia = new Coding(System, "Gynecomastia", "Gynecomastia");                                              // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_Hamartoma = new Coding(System, "Hamartoma", "Hamartoma");                                                       // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// The mass it forms is not cancerous, but it can sometimes lead to inflammation, fever,
		/// skin discoloration, and may leave behind scar tissue that mimics the shape of a breast
		/// tumor.
		/// [https://www.verywellhealth.com/breast-hematomas-430281]
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_Hematoma = new Coding(System, "Hematoma", "Hematoma");                                                          // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		/// Hormonal effects of certain medications including antihypertensives, antidepressants,
		/// H2 blockers,
		/// illicit drugs, and endocrine active tumors stimulate development of rudimentary breast
		/// tissue.
		/// [Breast Imaging Reporting and Data System—Mammography, Fifth Edition]
		/// Valid for the following modalities: US.
		/// </summary>
		public static Coding Code_HormonalStimulation = new Coding(System, "HormonalStimulation", "Hormonal stimulation");                        // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// </summary>
		public static Coding Code_IntracysticLesion = new Coding(System, "IntracysticLesion", "Intracystic lesion");                              // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		/// These are lymph  nodes within the breast tissue.
		/// They are generally 1 cm or smaller
		/// in size.
		/// They frequently occur in the lateral and usually upper portions of the breast closer
		/// to the
		/// axilla (armpit area), although they may occur anywhere in the breast.
		/// They usually are seen adjacent to a vein, because the lymphatic drainage of the breast
		/// parallels the venous drainage.
		/// [Breast Imaging Reporting and Data System—Mammography, Fifth Edition]
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_IntramammaryNode = new Coding(System, "IntramammaryNode", "Intramammary node");                                 // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		/// A lipoma is a slow-growing, fatty lump that's most often situated between your skin
		/// and the underlying muscle layer.
		/// A lipoma, which feels doughy and usually isn't tender, moves readily with slight
		/// finger pressure.
		...
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_Lipoma = new Coding(System, "Lipoma", "Lipoma");                                                                // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		/// With a lumpectomy, the surgeon removes only the tumor and a small amount of normal
		/// surrounding tissue.
		/// The cavity is the hollow area or hole left behind after the tumor and surrounding
		/// tissue is removed.
		/// 
		/// Valid for the following modalities: US MRI.
		/// </summary>
		public static Coding Code_LumpectomyCavity = new Coding(System, "LumpectomyCavity", "Lumpectomy cavity");                                 // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MRI.
		/// </summary>
		public static Coding Code_LumpectomySite = new Coding(System, "LumpectomySite", "Lumpectomy site");                                       // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Clusters of lymph nodes are found in the neck, axilla (underarm), chest, abdomen,
		/// and groin.
		...
		/// Valid for the following modalities: MG US MRI NM.
		/// </summary>
		public static Coding Code_LymphNode = new Coding(System, "LymphNode", "Lymph node");                                                      // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// cancer.
		/// Lymph nodes are small, round structures that play a vital role in the body's immune
		/// system.
		/// Swollen lymph nodes are also known as swollen glands.
		/// 
		/// Valid for the following modalities: US MRI.
		/// </summary>
		public static Coding Code_LymphNodeEnlarged = new Coding(System, "LymphNodeEnlarged", "Lymph node enlarged");                             // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		/// Lymph nodes filter substances that travel through the lymphatic fluid, and they contain
		/// lymphocytes (white blood cells) that help the body fight infection and disease.
		...
		/// Clusters of lymph nodes are found in the neck, axilla (underarm), chest, abdomen,
		/// and groin.
		/// A normal sized lymph node is about pea-sized or bean-sized (or smaller than 1/2 inch
		/// or 12mm).
		/// 
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_LymphNodeNormal = new Coding(System, "LymphNodeNormal", "Lymph node normal");                                   // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// abnormal number of nodes, or derangement of internal architecture (e.g.
		/// cystic or necrotic nodes).
		/// [https://radiopaedia.org/articles/lymph-node-enlargement?lang=us]
		/// Valid for the following modalities: MRI.
		/// </summary>
		public static Coding Code_LymphNodePathological = new Coding(System, "LymphNodePathological", "Lymph node pathological");                 // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_MassSolid = new Coding(System, "MassSolid", "Mass solid");                                                      // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		/// An abnormal mass of tissue that usually does not contain cysts or liquid areas.
		/// Solid masses or tumors may be benign (not cancer), or malignant (cancer).
		...
		/// Examples of solid tumors are sarcomas, carcinomas, and lymphomas.
		/// Leukemias (cancer of the blood) generally do not form solid mass/tumors.
		/// A vascular tumor is a type of tumor that forms from cells that make blood vessels
		/// or lymph vessels.
		/// Vascular tumors may be benign (not cancer) or malignant (cancer) and can occur anywhere
		/// in the body.
		...
		/// Valid for the following modalities: MRI.
		/// </summary>
		public static Coding Code_MassSolidWTumorVasc = new Coding(System, "MassSolidW/tumorVasc", "Mass solid w/tumor vasc");                    // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_Mastitis = new Coding(System, "Mastitis", "Mastitis");                                                          // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_MilkOfCalcium = new Coding(System, "MilkOfCalcium", "Milk of calcium");                                         // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: NM.
		/// </summary>
		public static Coding Code_MultiFocalCancer = new Coding(System, "Multi-focalCancer", "Multi-focal cancer");                               // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		/// Breast papillary lesions are characterised by growth inside the milk ducts, and they
		/// represent a heterogeneous pathology.
		/// They are rare and constitute less than 10% of benign breast lesions and less than
		/// 1% of malignant breast neoplasms.
		/// Breast papillary lesions are usually detected by imaging or clinically by the presence
		/// of a palpable breast mass or unilateral spontaneous nipple discharge.
		/// [https://ecancer.org/es/journal/article/461-breast-papillary-lesions-an-analysis-of-70-cases]
		/// Valid for the following modalities: MG US.
		/// </summary>
		public static Coding Code_PapillaryLesion = new Coding(System, "PapillaryLesion", "Papillary lesion");                                    // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		/// Intraductal papillomas are benign (non-cancerous), wart-like tumors that grow within
		/// the milk ducts of the breast.
		/// They are made up of gland tissue along with fibrous tissue and blood vessels (called
		/// fibrovascular tissue).
		/// [https://www.cancer.org/cancer/breast-cancer/non-cancerous-breast-conditions/intraductal-papillomas.html]
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_Papilloma = new Coding(System, "Papilloma", "Papilloma");                                                       // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		/// Phyllodes tumors of the breast are rare, accounting for less than 1% of all breast
		/// tumors.
		/// The name "phyllodes," which is taken from the Greek language and means "leaflike," refers
		/// to that fact that the tumor cells grow in a leaflike pattern.
		...
		/// Although most phyllodes tumors are benign (not cancerous), some are malignant (cancerous)
		/// and some are borderline (in between noncancerous and cancerous).
		/// All three kinds of phyllodes tumors tend to grow quickly, and they require surgery
		/// to reduce the risk of a phyllodes tumor coming back in the breast (local recurrence).
		/// [https://www.breastcancer.org/symptoms/types/phyllodes]
		/// Valid for the following modalities: US MRI.
		/// </summary>
		public static Coding Code_PhyllodesTumor = new Coding(System, "PhyllodesTumor", "Phyllodes tumor");                                       // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// If scar tissue forms around a stitch from surgery it's called a suture granuloma
		/// and also feels like a lump.
		/// Changes in breast appearance.
		/// Scar tissue and fluid retention can make breast tissue appear a little firmer or
		/// rounder than before surgery and/or radiation.
		/// [https://www.breastcancer.org/treatment/side_effects/scar_tissue]
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_PostLumpectomyScar = new Coding(System, "PostLumpectomyScar", "Post lumpectomy scar");                          // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// </summary>
		public static Coding Code_PostSurgicalScar = new Coding(System, "PostSurgicalScar", "Post surgical scar");                                // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_PreviousBiopsy = new Coding(System, "PreviousBiopsy", "Previous biopsy");                                       // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_PreviousSurgery = new Coding(System, "PreviousSurgery", "Previous surgery");                                    // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_PreviousTrauma = new Coding(System, "PreviousTrauma", "Previous trauma");                                       // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Growing out of this core are ducts and lobules that show evidence of unusual changes
		/// such as cysts and epithelial hyperplasia (overgrowth of their inner lining).
		...
		/// Valid for the following modalities: MG US.
		/// </summary>
		public static Coding Code_RadialScar = new Coding(System, "RadialScar", "Radial scar");                                                   // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MRI.
		/// </summary>
		public static Coding Code_RadiationChanges = new Coding(System, "RadiationChanges", "Radiation changes");                                 // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Systemic radiation therapy uses a radioactive substance, such as a radiolabeled monoclonal
		/// antibody, that travels in the blood to tissues throughout the body.
		/// Also called irradiation and radiotherapy.
		/// [https://www.cancer.gov/publications/dictionaries/cancer-terms/def/44971]
		/// Valid for the following modalities: MRI.
		/// </summary>
		public static Coding Code_RadiationTherapy = new Coding(System, "RadiationTherapy", "Radiation therapy");                                 // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: US MRI.
		/// </summary>
		public static Coding Code_Scar = new Coding(System, "Scar", "Scar");                                                                      // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// This lack of a central mass helps differentiate a scar from a carcinoma, which has
		/// shadowing arising from a central mass.
		/// onlinelibrary.wiley.com > doi > full > jum.2004.23.1.73
		/// 
		/// Valid for the following modalities: US MRI.
		/// </summary>
		public static Coding Code_ScarWithShadowing = new Coding(System, "ScarWithShadowing", "Scar with shadowing");                             // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// The normal lobular architecture of the breast is maintained, but becomes exaggerated
		/// and distorted.
		/// 
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_SclerosingAdenosis = new Coding(System, "SclerosingAdenosis", "Sclerosing adenosis");                           // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_SecretoryCalcification = new Coding(System, "SecretoryCalcification", "Secretory calcification");               // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: NM.
		/// </summary>
		public static Coding Code_SentinelNode = new Coding(System, "SentinelNode", "Sentinel node");                                             // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_Seroma = new Coding(System, "Seroma", "Seroma");                                                                // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		/// A skin lesion is a part of the skin that has an abnormal growth or appearance compared
		/// to the skin around it.
		/// Primary skin lesions are abnormal skin conditions present at birth or acquired over
		/// a person's lifetime.
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_SkinLesion = new Coding(System, "SkinLesion", "Skin lesion");                                                   // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MRI.
		/// </summary>
		public static Coding Code_Surgery = new Coding(System, "Surgery", "Surgery");                                                             // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MRI.
		/// </summary>
		public static Coding Code_Trauma = new Coding(System, "Trauma", "Trauma");                                                                // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		/// Parallel tracks, or linear tubular calcifications that are clearly associated with
		/// blood vessels.
		/// While most vascular calcification is not difficult to identify, if only a few discontinuous
		/// calcific
		/// particles are visible in a single location and if association with a tubular structure
		/// is questionable,
		/// then additional spot-compression magnification views may be needed to further characterize
		/// their nature.
		/// [Breast Imaging Reporting and Data System—Ultrasound, Second Edition page 38]
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_VascularCalcifications = new Coding(System, "VascularCalcifications", "Vascular calcifications");               // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		/// Venous stasis dermatitis happens when there's a problem with your veins, that keeps
		/// blood from moving through very well.
		/// As more fluid and pressure build, some of the blood leaks out of your veins and into
		/// your skin.
		/// [https://www.webmd.com/skin-problems-and-treatments/eczema/venous-stasis-dermatitis#1]
		/// Valid for the following modalities: NM.
		/// </summary>
		public static Coding Code_VenousStasis = new Coding(System, "VenousStasis", "Venous stasis");                                             // CSBuilder.cs:370
		//- Fields
	}
}
