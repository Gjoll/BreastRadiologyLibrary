...
namespace BreastRadLib
{
	...
	{
		//+ Fields
		const string System = "http://hl7.org/fhir/us/breast-radiology/CodeSystem/MarginCS";                                                      // CSBuilder.cs:345
		                                                                                                                                          // CSBuilder.cs:357
		/// <summary>
		...
		/// </summary>
		public static Coding Code_AngularMargin = new Coding(System, "AngularMargin", "Angular margin");                                          // CSBuilder.cs:371
		                                                                                                                                          // CSBuilder.cs:357
		/// <summary>
		...
		/// </summary>
		public static Coding Code_CircumscribedMargin = new Coding(System, "CircumscribedMargin", "Circumscribed margin");                        // CSBuilder.cs:371
		                                                                                                                                          // CSBuilder.cs:357
		/// <summary>
		/// There is no clear demarcation of the entire margin, or of any portion of the margin,
		/// from the surrounding
		/// tissue.
		/// For mammography, this descriptor should not be used when the interpreting
		...
		/// </summary>
		public static Coding Code_IndistinctMargin = new Coding(System, "IndistinctMargin", "Indistinct margin");                                 // CSBuilder.cs:371
		                                                                                                                                          // CSBuilder.cs:357
		/// <summary>
		...
		/// Valid for the following modalities: US.
		/// </summary>
		public static Coding Code_IntraductalExtension = new Coding(System, "IntraductalExtension", "Intraductal extension");                     // CSBuilder.cs:371
		                                                                                                                                          // CSBuilder.cs:357
		/// <summary>
		...
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_IrregularMargin = new Coding(System, "IrregularMargin", "Irregular margin");                                    // CSBuilder.cs:371
		                                                                                                                                          // CSBuilder.cs:357
		/// <summary>
		...
		/// Valid for the following modalities: US.
		/// </summary>
		public static Coding Code_LobulatedMargin = new Coding(System, "LobulatedMargin", "Lobulated margin");                                    // CSBuilder.cs:371
		                                                                                                                                          // CSBuilder.cs:357
		/// <summary>
		...
		/// </summary>
		public static Coding Code_MacrolobulatedMargin = new Coding(System, "MacrolobulatedMargin", "Macrolobulated margin");                     // CSBuilder.cs:371
		                                                                                                                                          // CSBuilder.cs:357
		/// <summary>
		...
		/// Valid for the following modalities: MG US.
		/// </summary>
		public static Coding Code_MicrolobulatedMargin = new Coding(System, "MicrolobulatedMargin", "Microlobulated margin");                     // CSBuilder.cs:371
		                                                                                                                                          // CSBuilder.cs:357
		/// <summary>
		...
		/// </summary>
		public static Coding Code_NonCircumscribedMargin = new Coding(System, "NonCircumscribedMargin", "Non circumscribed margin");              // CSBuilder.cs:371
		                                                                                                                                          // CSBuilder.cs:357
		/// <summary>
		...
		/// Valid for the following modalities: MG.
		/// </summary>
		public static Coding Code_ObscuredMagin = new Coding(System, "ObscuredMagin", "Obscured magin");                                          // CSBuilder.cs:371
		                                                                                                                                          // CSBuilder.cs:357
		/// <summary>
		...
		/// Valid for the following modalities: US MRI.
		/// </summary>
		public static Coding Code_SmoothMargin = new Coding(System, "SmoothMargin", "Smooth margin");                                             // CSBuilder.cs:371
		                                                                                                                                          // CSBuilder.cs:357
		/// <summary>
		...
		/// Valid for the following modalities: MG US MRI.
		/// </summary>
		public static Coding Code_SpiculatedMargin = new Coding(System, "SpiculatedMargin", "Spiculated margin");                                 // CSBuilder.cs:371
		//- Fields
	}
}
