...
namespace BreastRadLib
{
	...
	{
		//+ Fields
		const string System = "http://hl7.org/fhir/us/breast-radiology/CodeSystem/BreastLocationDepthCS";                                         // CSBuilder.cs:344
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// </summary>
		public static Coding Code_AnteriorDepth = new Coding(System, "AnteriorDepth", "Anterior depth");                                          // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG US.
		/// </summary>
		public static Coding Code_MiddleDepth = new Coding(System, "MiddleDepth", "Middle depth");                                                // CSBuilder.cs:370
		                                                                                                                                          // CSBuilder.cs:356
		/// <summary>
		...
		/// Valid for the following modalities: MG US.
		/// </summary>
		public static Coding Code_PosteriorDepth = new Coding(System, "PosteriorDepth", "Posterior depth");                                       // CSBuilder.cs:370
		//- Fields
	}
}
