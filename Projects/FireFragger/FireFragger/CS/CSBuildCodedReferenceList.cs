...
namespace FireFragger
{
    ...
    /// </summary>
    internal class CSBuildCodedReferenceList : CSCodeBlockDefinitions
    {
        ElementTreeNode memberNode;
        String MemberName => memberNode.Path.LastPathPart().ToMachineName();

        public CSBuildCodedReferenceList(CSBuilder csBuilder,
            SDInfo fragBase,
            ...
            String profileUrl)
        {
            ...
            {
                this.LocalClassDefs
                    .AppendCode($"public class {className} : CodedReferenceSingle<{propertyType}>")
                    .OpenBrace()
            ...
            {
                this.LocalClassDefs
                    .AppendCode($"public class {className} : CodedReferenceMultiple<{propertyType}>")
                    .OpenBrace()
                    .DefineBlock(out CodeBlockNested accessors)
                    .SummaryOpen()
                    .Summary($"{className} class constructor")
